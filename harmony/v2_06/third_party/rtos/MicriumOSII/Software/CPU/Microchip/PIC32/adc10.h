 ...
 *
 ********************************************************************/
//#define OpenADC10(config1, config2, config3, configport, configscan) (AD1CON1 = 0x0000, mPORTBSetPinsAnalogIn(configport), AD1CSSL = ~(configscan), AD1CON3 = (config3), AD1CON2 = (config2), AD1CON1 = (config1) & 0x7FFF, AD1CON1bits.SAMP = (config1 >> _AD1CON1_SAMP_POSITION) & _AD1CON1_SAMP_MASK, AD1CON1SET = config1 & ADC_MODULE_ON )
 ...
 * Output:          None
 *
 * Example:         ConfigIntTimer2(ADC10_INT_ON | ADC10_INT_PRIOR_3 | ADC10_INT_SUB_PRIOR1)
 *
 ********************************************************************/
