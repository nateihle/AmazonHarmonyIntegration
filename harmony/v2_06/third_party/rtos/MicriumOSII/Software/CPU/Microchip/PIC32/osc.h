 ...
 * Output:      None
 *
 * Example:	  	mOSCSetPBDIV(  OSC_PB_DIV_8 )
 *
 ********************************************************************/
#define mOSCSetPBDIV(config)	mSysUnlockOpLock( (OSCCONSET = _OSCCON_PBDIV_MASK, OSCCONCLR = ((config)^(_OSCCON_PBDIV_MASK))))
 ...
 *
 ********************************************************************/
#define mOSCEnableSOSC() mSysUnlockOpLock(OSCCONSET = _OSCCON_SOCEN_MASK)
 ...
 *
 ********************************************************************/
#define mOSCDisableSOSC() mSysUnlockOpLock(OSCCONCLR = _OSCCON_SOCEN_MASK)
