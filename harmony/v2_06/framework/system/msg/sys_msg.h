...
/* SYS_MODULE_OBJ Rename
  ...
  Summary:
    SYS_MODULE_OBJ was poorly named.  It should be SYS_MODULE_OBJ_HANDLE or
...
/* System Messaging: Number of 16-Bit Bit Maps for Mailboxes
  ...
  Description:
    This macro specifies the number of 16-bit bit maps needed for mailboxes.
...
/* System Messaging Queue Status Enumeration
  ...
  Description:
    This enumeration provides the messaging queue status.  Positive values indicate 
...
/* Pointer to the System Message Received Callback Function
  ...
  Description:
    This data type is a pointer to the function provided for each system messaging 
	mailbox that is called when a system message is received for each mailbox.
 */
...
/* System Messaging Service Initialization Data
  ...
  Description:
    This data type contains all of the data necessary to initialize an instance 
	of the System Messaging Service.
  ...
  Remarks:
    ...
    If nMaxMsgsDelivered == 0. ALL messages in priority queues are delivered
...
/* Function:
  ...
  Description:
    This function configures and initializes the messaging subsystem
...
/* Function:
  ...
  Description:
    This function deinitializes the System Messaging Instance and frees up allocated 
	memory for it.
...
/* Function:
  ...
  Description:
    This function creates a new message type, defining an integer message type 
	and priority.
...
/* Function:
  ...
  Description:
    This function translates the message type identifier into the handle of 
	the corresponding message type object.
...
/* Function:
  ...
  Description:
    This function receives the next message in the message queues, returning NULL 
  ...
  Returns:
    Pointer to next message, as found in a message queue element, NULL if there 
	are no messages.
...
/* Function:
  ...
  Description:
    This function delivers messages to mailboxes, and removes the message from the 
	queue when done.
...
/* Function:
  ...
  Description:
    This function opens a system messaging mailbox, providing a message callback 
...
/* Function:
  ...
  Description:
    This function reinitializes a previously opened mailbox by providing a new 
	callback function and clearing all message type assignments.
...
/* Function:
  ...
  Description:
    This function gets the queued messages for a mailbox.  Messages returned 
	by this function will not be received via the mailbox's callback function.
