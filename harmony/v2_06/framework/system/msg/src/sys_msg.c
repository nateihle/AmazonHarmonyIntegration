...
{
    /*LDRA_INSPECTED 496 S */ /*Deviation Reference: MH-4498*/
...
void  SYS_MSG_Deinitialize ( SYS_OBJ_HANDLE hSysMsgForDeinit )
{
    ...
    /*LDRA_INSPECTED 125 D */ /*Deviation Reference: MH-4494*/
    free( hSysMsg );
}
...
void SYS_MSG_TypeRemove( SYS_OBJ_HANDLE handleMsgType )
{
    ...
    /*LDRA_INSPECTED 125 D */ /*Deviation Reference: MH-4495*/
    free(hMsgType);
}
...
void SYS_MSG_MailboxClose( SYS_OBJ_HANDLE handleMailbox )
{
    ...
    /*LDRA_INSPECTED 125 D */ /*Deviation Reference: MH-4496*/
    free(hMailbox);
}
