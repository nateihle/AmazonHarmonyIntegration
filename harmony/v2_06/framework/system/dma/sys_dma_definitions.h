...
/* Function:
  ...
  Parameters:
    object      - Object handle for the DMA module (returned from
                  SYS_DMA_Initialize)
    activeChannel - DMA channel number to be serviced.
  ...
  Example:
	...
	{
		SYS_DMA_Tasks(object, DMA_CHANNEL_3);
	}
...
#define SYS_DMA_TasksISR(object, activeChannel)  SYS_DMA_Tasks(object, activeChannel) 
