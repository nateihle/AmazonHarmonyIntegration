...
#define SYS_FS_CLIENT_NUMBER		${CONFIG_SYS_FS_CLIENTS_NUMBER}
<#else>
...
#define SYS_FS_FILE_NAME_LEN ${CONFIG_SYS_FS_FILE_NAME_LEN}
#define SYS_FS_CWD_STRING_LEN ${CONFIG_SYS_FS_CWD_STRING_LEN}
</#if>
