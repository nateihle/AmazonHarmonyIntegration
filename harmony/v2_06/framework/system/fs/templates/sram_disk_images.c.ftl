/*******************************************************************************
    SRAM Disk Images FAT Type Disk image
...
struct fatfsImage sramDiskImage =
{
...
#if(FS_INTERNAL_FLASH_DRIVE_CAPACITY >= 379)
    #if(FS_INTERNAL_FLASH_DRIVE_CAPACITY >= 442)
        #error "Your MSD Volume is larger than this example has provisions for."
