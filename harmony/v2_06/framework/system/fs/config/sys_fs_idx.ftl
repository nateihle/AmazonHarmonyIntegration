...
config SYS_FS_USE_SRAM_MBR${INSTANCE}
    bool "Create FAT12 in SRAM"
    depends on USE_SYS_FS
    depends on SYS_FS_MEDIA_TYPE_DEFINE_IDX${INSTANCE} = "SYS_FS_MEDIA_TYPE_RAM" && SYS_FS_TYPE_DEFINE_IDX${INSTANCE} = "FAT"
    set SYS_FS_USE_MBR to y if SYS_FS_USE_SRAM_MBR${INSTANCE} = y
    default n
...
config SYS_FS_MEDIA_DEVICE_1_NAME_IDX${INSTANCE}
    ...
    default "/dev/rama1" if SYS_FS_MEDIA_TYPE_DEFINE_IDX${INSTANCE} = "SYS_FS_MEDIA_TYPE_RAM"
    ---help---
    IDH_HTML_SYSTEM_FS_Configuring_the_Library
    ---endhelp---
...
config SYS_FS_MEDIA_DEVICE_2_NAME_IDX${INSTANCE}
    ...
    default "/dev/rama2" if SYS_FS_MEDIA_TYPE_DEFINE_IDX${INSTANCE} = "SYS_FS_MEDIA_TYPE_RAM"
    ---help---
    IDH_HTML_SYSTEM_FS_Configuring_the_Library
    ---endhelp---
...
config SYS_FS_MEDIA_DEVICE_3_NAME_IDX${INSTANCE}
    ...
    default "/dev/rama3" if SYS_FS_MEDIA_TYPE_DEFINE_IDX${INSTANCE} = "SYS_FS_MEDIA_TYPE_RAM"
    ---help---
    IDH_HTML_SYSTEM_FS_Configuring_the_Library
    ---endhelp---
...
config SYS_FS_MEDIA_DEVICE_4_NAME_IDX${INSTANCE}
    ...
    default "/dev/rama4" if SYS_FS_MEDIA_TYPE_DEFINE_IDX${INSTANCE} = "SYS_FS_MEDIA_TYPE_RAM"
    ---help---
    IDH_HTML_SYSTEM_FS_Configuring_the_Library
    ---endhelp---
