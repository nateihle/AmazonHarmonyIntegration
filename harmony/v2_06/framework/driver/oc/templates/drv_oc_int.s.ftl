...
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX0>
</#if>
<#if DRV_OC_INSTANCE == "1">
<#assign OC_ISR_NAME = "DrvOCInstance1">
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX1>
</#if>
<#if DRV_OC_INSTANCE == "2">
<#assign OC_ISR_NAME = "DrvOCInstance2">
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX2>
</#if>
<#if DRV_OC_INSTANCE == "3">
<#assign OC_ISR_NAME = "DrvOCInstance3">
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX3>
</#if>
<#if DRV_OC_INSTANCE == "4">
<#assign OC_ISR_NAME = "DrvOCInstance4">
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX4>
</#if>
<#if DRV_OC_INSTANCE == "5">
<#assign OC_ISR_NAME = "DrvOCInstance5">
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX5>
</#if>
<#if DRV_OC_INSTANCE == "6">
<#assign OC_ISR_NAME = "DrvOCInstance6">
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX6>
</#if>
<#if DRV_OC_INSTANCE == "7">
<#assign OC_ISR_NAME = "DrvOCInstance7">
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX7>
</#if>
<#if DRV_OC_INSTANCE == "8">
<#assign OC_ISR_NAME = "DrvOCInstance8">
<#assign OC_ISR_INTPRIO = CONFIG_DRV_OC_INT_PRIORITY_IDX8>
</#if>
/* OC Instance ${DRV_OC_INSTANCE} Interrupt */
<@RTOS_ISR VECTOR = OC_ISR_VECTOR NAME = OC_ISR_NAME PRIORITY = OC_ISR_INTPRIO/>
</#macro>
