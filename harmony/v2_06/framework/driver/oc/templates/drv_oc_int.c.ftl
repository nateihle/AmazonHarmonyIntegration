...
void __ISR(${OC_INT_ISR}, ipl${OC_INT_PRINUM}SOFT) _IntHandlerDrvOCInstance${DRV_INSTANCE}(void)
<#else>
<#if CONFIG_3RDPARTY_RTOS_USED == "embOS">
void __attribute__( (interrupt(ipl${OC_INT_PRINUM}AUTO), vector(${OC_INT_ISR}))) IntHandlerDrvOCInstance${DRV_INSTANCE}_ISR( void );
</#if>
void IntHandlerDrvOCInstance${DRV_INSTANCE}(void)
</#if>
<#else>
void __ISR(${OC_INT_ISR}, ipl${OC_INT_PRINUM}AUTO) _IntHandlerDrvOCInstance${DRV_INSTANCE}(void)
</#if>
{
<#if CONFIG_USE_3RDPARTY_RTOS>
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
...
<@DRV_OC_STATIC_FUNCTIONS DRV_INSTANCE="9" OC_INT_SRC=CONFIG_DRV_OC_INTERRUPT_SOURCE_IDX9 
OC_INT_ISR=CONFIG_DRV_OC_ISR_VECTOR_IDX9 OC_INT_PRINUM=CONFIG_DRV_OC_INT_PRIO_NUM_IDX9/>
</#if>
<#if CONFIG_DRV_OC_INST_IDX10 == true>
<@DRV_OC_STATIC_FUNCTIONS DRV_INSTANCE="10" OC_INT_SRC=CONFIG_DRV_OC_INTERRUPT_SOURCE_IDX10 
OC_INT_ISR=CONFIG_DRV_OC_ISR_VECTOR_IDX10 OC_INT_PRINUM=CONFIG_DRV_OC_INT_PRIO_NUM_IDX10/>
</#if>
<#if CONFIG_DRV_OC_INST_IDX11 == true>
<@DRV_OC_STATIC_FUNCTIONS DRV_INSTANCE="11" OC_INT_SRC=CONFIG_DRV_OC_INTERRUPT_SOURCE_IDX11 
OC_INT_ISR=CONFIG_DRV_OC_ISR_VECTOR_IDX11 OC_INT_PRINUM=CONFIG_DRV_OC_INT_PRIO_NUM_IDX11/>
</#if>
<#if CONFIG_DRV_OC_INST_IDX12 == true>
<@DRV_OC_STATIC_FUNCTIONS DRV_INSTANCE="12" OC_INT_SRC=CONFIG_DRV_OC_INTERRUPT_SOURCE_IDX12 
OC_INT_ISR=CONFIG_DRV_OC_ISR_VECTOR_IDX12 OC_INT_PRINUM=CONFIG_DRV_OC_INT_PRIO_NUM_IDX12/>
</#if>
<#if CONFIG_DRV_OC_INST_IDX13 == true>
<@DRV_OC_STATIC_FUNCTIONS DRV_INSTANCE="13" OC_INT_SRC=CONFIG_DRV_OC_INTERRUPT_SOURCE_IDX13 
OC_INT_ISR=CONFIG_DRV_OC_ISR_VECTOR_IDX13 OC_INT_PRINUM=CONFIG_DRV_OC_INT_PRIO_NUM_IDX13/>
</#if>
<#if CONFIG_DRV_OC_INST_IDX14 == true>
<@DRV_OC_STATIC_FUNCTIONS DRV_INSTANCE="14" OC_INT_SRC=CONFIG_DRV_OC_INTERRUPT_SOURCE_IDX14 
OC_INT_ISR=CONFIG_DRV_OC_ISR_VECTOR_IDX14 OC_INT_PRINUM=CONFIG_DRV_OC_INT_PRIO_NUM_IDX14/>
</#if>
<#if CONFIG_DRV_OC_INST_IDX15 == true>
<@DRV_OC_STATIC_FUNCTIONS DRV_INSTANCE="15" OC_INT_SRC=CONFIG_DRV_OC_INTERRUPT_SOURCE_IDX15 
OC_INT_ISR=CONFIG_DRV_OC_ISR_VECTOR_IDX15 OC_INT_PRINUM=CONFIG_DRV_OC_INT_PRIO_NUM_IDX15/>
</#if>
<#--
/*******************************************************************************
 End of File
