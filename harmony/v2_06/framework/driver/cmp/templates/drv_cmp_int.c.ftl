...
void __ISR(${CMP_INT_ISR}, ipl${CMP_INT_PRINUM}SOFT) _IntHandlerDrvCMPInstance${DRV_INSTANCE}(void)
<#else>
<#if CONFIG_3RDPARTY_RTOS_USED == "embOS">
void __attribute__( (interrupt(ipl${CMP_INT_PRINUM}AUTO), vector(${CMP_INT_ISR}))) IntHandlerDrvCMPInstance${DRV_INSTANCE}_ISR( void );
</#if>
...
<@DRV_CMP_STATIC_FUNCTIONS DRV_INSTANCE="3" CMP_INT_SRC=CONFIG_DRV_CMP_INTERRUPT_SOURCE_IDX3
 CMP_INT_ISR=CONFIG_DRV_CMP_ISR_VECTOR_IDX3
CMP_INT_PRINUM=CONFIG_DRV_CMP_INT_PRIO_NUM_IDX3/>
</#if>
<#if CONFIG_DRV_CMP_INST_IDX4 == true>
<@DRV_CMP_STATIC_FUNCTIONS DRV_INSTANCE="4" CMP_INT_SRC=CONFIG_DRV_CMP_INTERRUPT_SOURCE_IDX4
 CMP_INT_ISR=CONFIG_DRV_CMP_ISR_VECTOR_IDX4
CMP_INT_PRINUM=CONFIG_DRV_CMP_INT_PRIO_NUM_IDX4/>
</#if>
