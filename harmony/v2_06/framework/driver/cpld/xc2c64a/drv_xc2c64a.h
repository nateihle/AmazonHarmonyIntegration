...
//DOM-IGNORE-BEGIN
/*******************************************************************************
Copyright © 2008-2014 released Microchip Technology Inc.  All rights
reserved.
...
/******************************************************************************************
  ...
  Description:
    ...
    It will also select the Chip Select use for the device.
  ...
  Remarks:
    ...
    SPI channels 2A and 3A are only available on PIC32MX5xx/6xx/7xx series devices.
...
/******************************************************************************************
  ...
  Description:
    ...
    interfacing with the graphics controller.
...
/**************************************************************************************
  ...
  Remarks:
    The graphics controller interface configuration must be done before initializing the
    graphics controller.
*/
...
/**************************************************************************************
  ...
  Description:
    This routine configures the CPLD to communicate to the SPI Flash device with the 
...
/**************************************************************************************
  ...
  Description:
    This routine configures the CPLD to communicate to the Wi-Fi device with the 
...
/**************************************************************************************
  ...
  Description:
    This routine configures the CPLD to communicate to the ZigBee/MiWi device with the 
    selected SPI channel, chip select and external interrupt or change notice.
