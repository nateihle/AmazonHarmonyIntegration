...
#define DRV_SDHC_BUFFER_OBJ_NUMBER ${CONFIG_DRV_SDHC_BUFFER_OBJECT_NUMBER}
#define DRV_SDHC_CARD_DETECT_ENABLE  ${CONFIG_DRV_SDHC_SDCDEN?c}
#define	DRV_SDHC_WRITE_PROTECT_ENABLE  ${CONFIG_DRV_SDHC_SDWPEN?c}
