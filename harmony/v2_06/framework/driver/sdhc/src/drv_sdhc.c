        ...
        default:
            {
                ...
                dObj->tmrHandle = SYS_TMR_DelayMS (5);
                break;
            }
        ...
        default:
            {
                ...
                dObj->cmdTimerHandle = SYS_TMR_CallbackSingle (2000, (uintptr_t)&dObj->cmdTimerState, DRV_SDHC_TimerCallback);
        ...
        case DRV_SDHC_CMD_CHECK_TRANSFER_COMPLETE:
            {
                ...
                /* Stop the timer. */
                SYS_TMR_CallbackStop (dObj->cmdTimerHandle);
                dObj->cmdTimerState = false;
...
)
{
    ...
    if (clientObj == NULL)
    {
        SYS_DEBUG_PRINT (SYS_ERROR_INFO, "DRV_SDHC_Close(): Invalid handle.\n");
        return;
    }
