/*******************************************************************************
  IPF Driver Variant Mapping

  Company:
    Microchip Technology Inc.

  File Name:
    drv_ipf_variant_mapping.h
...
#ifndef _DRV_IPF_FEATURE_MAPPING_H
#define _DRV_IPF_FEATURE_MAPPING_H
...
*/
...
#if (DRV_IPF_HARDWARE_WRITE_PROTECTION_ENABLE == true)
    ...
    #define _DRV_IPF_HardwareWPIsEnabled()      true
#else
    #define _DRV_IPF_HardwareWPIsEnabled()      false
...
*/
#if (DRV_IPF_HARDWARE_HOLD_ENABLE == true)
    ...
    #define _DRV_IPF_HardwareHoldIsEnabled()    true
#else
    #define _DRV_IPF_HardwareHoldIsEnabled()    false
...
#endif //_DRV_IPF_FEATURE_MAPPING_H
