...
#ifndef _DRV_SST25VF020B_CONFIG_TEMPLATE_H
#define _DRV_SST25VF020B_CONFIG_TEMPLATE_H
...
/* SST25VF020B driver objects configuration
  ...
  Description
    ...
    SST25VF020B modules that are needed by the application. Hardware Instance
...
/* SST25VF020B Client Count Configuration
  ...
  Description:
    ...
    across all hardware instances. So if SST25VF020B-1 will be accessed by 2 clients
    and SST25VF020B-2 will accessed by 3 clients, then this number should be 5. 
    ...
    If this macro is not defined and the DRV_SST25VF020B_INSTANCES_NUMBER macro is not
    defined, then the driver will be built for static - single client operation.
    If this macro is defined and the DRV_SST25VF020B_INSTANCES_NUMBER macro is not
...
/* SST25VF020B Driver Instance combined queue depth.
  ...
  Description:
    ...
    entries that will be available for use between all SST25VF020B driver hardware
...
#endif // #ifndef _DRV_SST25VF020B_CONFIG_TEMPLATE_H
