/*******************************************************************************
  SST25VF016B Driver Variant Mapping

  Company:
    Microchip Technology Inc.

  File Name:
    drv_sst25vf016b_variant_mapping.h
...
#ifndef _DRV_SST25VF016B_FEATURE_MAPPING_H
#define _DRV_SST25VF016B_FEATURE_MAPPING_H
...
*/
...
#if (DRV_SST25VF016B_HARDWARE_WRITE_PROTECTION_ENABLE == true)
    ...
    #define _DRV_SST25VF016B_HardwareWPIsEnabled()      true
#else
    #define _DRV_SST25VF016B_HardwareWPIsEnabled()      false
...
*/
#if (DRV_SST25VF016B_HARDWARE_HOLD_ENABLE == true)
    ...
    #define _DRV_SST25VF016B_HardwareHoldIsEnabled()    true
#else
    #define _DRV_SST25VF016B_HardwareHoldIsEnabled()    false
...
#endif //_DRV_SST25VF016B_FEATURE_MAPPING_H
