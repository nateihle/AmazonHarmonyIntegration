/*******************************************************************************
  SST25VF016B SPI Flash Driver Local Data Structures

  Company:
    Microchip Technology Inc.

  File Name:
    drv_sst25vf016b_local.h
...
#ifndef _DRV_SST25VF016B_LOCAL_H
#define _DRV_SST25VF016B_LOCAL_H
...
#include "driver/spi_flash/sst25vf016b/src/drv_sst25vf016b_variant_mapping.h"
#include "osal/osal.h"
...
#define SST25VF016B_WREN_OP_CODE    0x06
#define SST25VF016B_WRSR_OP_CODE    0x01
#define SST25VF016B_ERASE_OP_CODE    0x20
#define SST25VF016B_WRITE_BYTE_OP_CODE    0x02
#define SST25VF016B_NORMAL_READ_OP_CODE    0x03
#define SST25VF016B_HIGH_SPEED_READ_OP_CODE    0x0B
#define SST25VF016B_RDSR_OP_CODE    0x05
...
// *****************************************************************************
/* DRV_SST25VF016B_BUFFER_PROCESS_STATE
...
typedef enum{
    ...
    DRV_SST25VF016B_BUFFER_PROCESS_INIT,

    /* Send write enable command */
    DRV_SST25VF016B_SEND_WREN_CMD,

    /* Check if write has been enabled */
    DRV_SST25VF016B_WREN_EXECUTION_STATUS_CHECK,

    /* Send Write command along with write address and data pointer */
    DRV_SST25VF016B_SEND_WRITE_CMD_ADDRESS_AND_DATA,

    /* Send erase command and address */
    DRV_SST25VF016B_SEND_ERASE_CMD_AND_ADDRESS,

    /* Send read command and address */
    DRV_SST25VF016B_SEND_READ_CMD_AND_ADDRESS,

    /* Start the read operation */
    DRV_SST25VF016B_START_READING,

    /* Wait for Write/Erase buffer completion */
    DRV_SST25VF016B_WAIT_FOR_WRITE_OR_ERASE_BUFFER_COMPLETE,

    /* Send command to read the status register */
    DRV_SST25VF016B_SEND_COMMAND_FOR_BUSY_STATUS,

    /* Read the status of Busy Bit */
    DRV_SST25VF016B_READ_BUSY_STATUS,

    /* Wait until BUSY bit is clear */
    DRV_SST25VF016B_WAIT_FOR_BUSY_CLEAR,

    /* Read operation is completed */
    DRV_SST25VF016B_READ_COMPLETED

}DRV_SST25VF016B_BUFFER_PROCESS_STATE;

// *****************************************************************************
/* SST25VF016B Driver task states

  Summary
    Lists the different states that SST25VF016B task routine can have.

  Description
    This enumeration lists the different states that SST25VF016B task routine
    can have.
...
{
    /* Open SPI driver */
    DRV_SST25VF016B_TASK_OPEN_SPI_DRIVER,

    /* This state is to send the WREN command to be able to modify
       SST Status register */
    DRV_SST25VF016B_SEND_WREN_CMD_WRSR,

    /* Check if write has been enabled */
    DRV_SST25VF016B_WREN_EXECUTION_STATUS_CHECK_WRSR,

    /* Send write status register command and status register value */
    DRV_SST25VF016B_SEND_WRSR_CMD_AND_VALUE,

    /* Check if Status register is written */
    DRV_SST25VF016B_WRSR_EXECUTION_STATUS_CHECK,

    /* Process Queue */
    DRV_SST25VF016B_TASK_PROCESS_QUEUE

} DRV_SST25VF016B_DATA_OBJECT_STATE;

// *****************************************************************************
/* SST25VF016B Driver Operations

  Summary
    Lists the different operations that SST25VF016B driver can do.

  Description
    This enumeration lists the different operations that SST25VF016B driver can
    do.
...
{
    /* Block Read */
    DRV_SST25VF016B_BLOCK_READ,

    /* Block Write */
    DRV_SST25VF016B_BLOCK_WRITE,

    /* Block Erase */
    DRV_SST25VF016B_BLOCK_ERASE

} DRV_SST25VF016B_BLOCK_OPERATION;

// *****************************************************************************
/* SST25VF016B SPI Flash Driver Buffer Object
...
typedef struct _DRV_SST25VF016B_BUFFER_OBJ
{
    ...
    DRV_SST25VF016B_BLOCK_OPERATION operation;
            
    /* Client that owns this buffer */
    void * hClient;

    /* Next buffer pointer */
    struct _DRV_SST25VF016B_BUFFER_OBJ * next;

    /* Previous buffer pointer */
    struct _DRV_SST25VF016B_BUFFER_OBJ * previous;

} DRV_SST25VF016B_BUFFER_OBJ;

// *****************************************************************************
/* SST25VF016B Driver Global Instances Object
  ...
  Description:
    ...
    instances of the SST25VF016B driver.
...
} DRV_SST25VF016B_COMMON_DATA_OBJ;

// *****************************************************************************
/* SST25VF016B SPI Flash Driver Instance Object

  Summary:
    Object used to keep any data required for an instance of the SST25VF016B SPI
    Flash driver.
...
typedef struct
{
     ...
     * queueTail */
    DRV_SST25VF016B_BUFFER_OBJ  *queueTail;
    ...
    /* State of the task */
    DRV_SST25VF016B_DATA_OBJECT_STATE    	state;

    /* State of the buffer object transfer */
    DRV_SST25VF016B_BUFFER_PROCESS_STATE    		bufferProcessState;
...
// *****************************************************************************
/* SST25VF016B SPI Flash Driver Client Object
...
typedef struct
{
    ...
    DRV_SST25VF016B_EVENT_HANDLER eventHandler;
...
} DRV_SST25VF016B_CLIENT_OBJ;


#endif //#ifndef _DRV_SST25VF016B_LOCAL_H
