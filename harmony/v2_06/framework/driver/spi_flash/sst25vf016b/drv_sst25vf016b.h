...
#ifndef _DRV_SST25VF016B_H
#define _DRV_SST25VF016B_H
...
/* Driver SPI Flash Module Index reference
  ...
  Remarks:
    ...
    These values should be passed into the DRV_SST25VF016B_Initialize and
    DRV_SST25VF016B_Open routines to identify the driver instance in use.
*/
...
#define DRV_SST25VF016B_BLOCK_COMMAND_HANDLE_INVALID   /*DOM-IGNORE-BEGIN*/ SYS_FS_MEDIA_BLOCK_COMMAND_HANDLE_INVALID /*DOM-IGNORE-END*/
...
/* SST25VF016B SPI Flash Driver Events
   ...
   Remarks:
    ...
    calling the DRV_SST25VF016B_BlockEventHandlerSet function when a block
...
/* SST25VF016B SPI Flash Driver Event Handler Function Pointer
   ...
   Description:
    This data type defines the required function signature for the SST25VF016B
  ...
  Remarks:
    If the event is DRV_SST25VF016B_EVENT_BLOCK_COMMAND_COMPLETE, it means that the
    data was transferred successfully.

    If the event is DRV_SST25VF016B_EVENT_BLOCK_COMMAND_ERROR, it means that the data
    was not transferred successfully.

    The context parameter contains the a handle to the client context,
    provided at the time the event handling function was  registered using the
    DRV_SST25VF016B_BlockEventHandlerSet function. This context handle value is
...
typedef void ( *DRV_SST25VF016B_EVENT_HANDLER )
(
    DRV_SST25VF016B_BLOCK_EVENT event,
    DRV_SST25VF016B_BLOCK_COMMAND_HANDLE commandHandle,
    uintptr_t context
...
/* SST SPI Flash Driver Initialization Data
  ...
  Remarks:
    ...
    initialization data must be passed into the DRV_SST25VF016B_Initialize
    function.
*/
...
/* Function:
  ...
  Summary:
    Initializes the SST25VF016B SPI Flash Driver instance for the specified
    driver index.
	<p><b>Implementation:</b> Dynamic</p>
  ...
  Remarks:
    ...
    unless DRV_SST25VF016B_Deinitialize is called to deinitialize the driver
    instance.
...
/* Function:
  ...
  Precondition:
    Function DRV_SST25VF016B_Initialize should have been called before calling
    this function.
...
/* Function:
  ...
  Precondition:
    The DRV_SST25VF016B_Initialize function must have been called for the
    specified SPI Flash driver instance.

  Parameters:
    object -  Object handle for the specified driver instance (returned from
              DRV_SST25VF016B_Initialize)
  Returns:
    None.
...
/* Function:
  ...
  Precondition:
    Function DRV_SST25VF016B_Initialize must have been called before calling
    this function.
  ...
  Returns:
    ...
    - if the number of client objects allocated via
         DRV_SST25VF016B_CLIENTS_NUMBER is insufficient
    ...
    The driver status becomes ready inside "DRV_SST25VF016B_Tasks" function. To
  ...
  Remarks:
    ...
    The handle returned is valid until the DRV_SST25VF016B_Close function is
    called.
...
/* Function:
  ...
  Precondition:
    ...
    DRV_SST25VF016B_Open must have been called to obtain a valid opened device
    handle.
  ...
  Remarks:
    ...
    calling DRV_SST25VF016B_Open before the caller may use the driver again.
...
/* Function:
  ...
  Returns:
    A DRV_SST25VF016B_CLIENT_STATUS value describing the current status of the
    driver.
...
/* Function:
  ...
  Description:
    ...
    The function returns DRV_SST25VF016B_BLOCK_COMMAND_HANDLE_INVALID in the
    ...
    erase operation was successful or DRV_SST25VF016B_EVENT_ERASE_ERROR
  ...
  Precondition:
    ...
    in the DRV_SST25VF016B_Open call.
  ...
  Parameters:
    ...
    commandHandle -  Pointer to an argument that will contain the return buffer
                   handle
    blockStart -   Start block address in SST25VF016B memory from where the
...
/* Function:
  ...
  Description:
    ...
    returns DRV_SST25VF016B_BLOCK_COMMAND_HANDLE_INVALID in the commandHandle
    ...
    - if the driver handle is invalid
    If the requesting client registered an event callback with the driver, the
    driver will issue a DRV_SST25VF016B_EVENT_BLOCK_COMMAND_COMPLETE event if the
    buffer was processed successfully of DRV_SST25VF016B_EVENT_BLOCK_COMMAND_ERROR
...
/* Function:
  ...
  Description:
    ...
    If the requesting client registered an event callback with the driver, the
    driver will issue a DRV_SST25VF016B_EVENT_BLOCK_COMMAND_COMPLETE event if the
    buffer was processed successfully or DRV_SST25VF016B_EVENT_BLOCK_COMMAND_ERROR
    event if the buffer was not processed successfully.
  ...
  Precondition:
    ...
    DRV_SST25VF016B_Open must have been called to obtain a valid opened
    device handle.
    ...
    using the API DRV_SST25VF016B_BlockErase().
  ...
  Parameters:
    ...
    blockStart -   Start block address of SST25VF016B Flash where the write
...
// #include "driver/SST25VF016B/drv_SST25VF016B_mapping.h"
...
#endif // #ifndef _DRV_SST25VF016B_H
/*******************************************************************************
 End of File
*/
