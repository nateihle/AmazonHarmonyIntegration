...
#include "driver/wifi/wilc1000/include/wdrv_wilc1000_common.h"
#include "driver/wifi/wilc1000/include/wdrv_wilc1000_stub.h"
...
/*
  Function:
        void WDRV_EXT_IsDisconnectRequestedSet(bool bValue)
...
/*
  Function:
        void WDRV_EXT_CmdPowerSaveGet(uint8_t mode, uint16_t listenInterval)

  Summary:
    Get the module in power save mode.
    <p><b>Implementation:</b> Dynamic</p>

  Description:
    The function get the module current power save mode.
...
/*
  Function:
        void WDRV_EXT_ScanInProgressSet(void)
  ...
  Description:
    This function indicates that scan is in progress.
...
/*
  Function:
        void WDRV_WILC1000_Tasks(void)

  Summary:
    Wi-Fi driver (WILC1000-specific) Task routine.
    <p><b>Implementation:</b> Dynamic</p>

  Description:
    This function is the Wi-Fi driver (WILC1000-specific) Task routine.
  ...
  Remarks:
    None.
 */
void WDRV_WILC1000_Tasks2(void);
...
bool WDRV_EXT_IsScanComplete(void);
