/*******************************************************************************
  WINC1500 Wireless Driver OS Abstraction Layer

  File Name:
    wdrv_winc1500_osal.c

  Summary:
    OS abstraction layer for WINC1500 wireless driver.
...
{
    *mutex_ptr = OSAL_Malloc(sizeof(OSAL_MUTEX_HANDLE_TYPE));
 ...
 *  is used.
 * These are the only two cases supported by current WINC1500 driver.
