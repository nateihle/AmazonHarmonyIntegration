...
#ifndef _WDRV_WINC1500_IWPRIV_H
#define _WDRV_WINC1500_IWPRIV_H
...
typedef enum {
    ...
    IWPRIV_CONNECTION_REESTABLISHED // not really used in WINC1500, it's here only because of consistency
} IWPRIV_CONN_STATUS;
...
#if defined(WDRV_WINC1500_IWPRIV_TASK)
...
/*
  ...
  Remarks:
    ...
    After the the module is connected, WINC1500 module can also do regular scans.
...
/*
  Function:
        uint8_t iwpriv_numberofscanresults_get(void)
...
/*
  ...
  Description:
    ...
    in server mode, which includes Ad hoc mode and SoftAP mode.
...
#endif /* WDRV_WINC1500_IWPRIV_TASK */
