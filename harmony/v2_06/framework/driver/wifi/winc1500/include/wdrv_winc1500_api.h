...
/*
  ...
  Description:
    This function initializes the WINC1500 Wi-Fi driver, making it ready for
    clients to use.
...
/*
  ...
  Description:
    This function causes the WINC1500 to connect to a Wi-Fi network. Upon
...
/*
  ...
  Description:
    ...
    address filters on the WINC1500 module.
...
/*
  ...
  Description:
    ...
    result at a time from the WINC1500 module.
...
/*
  ...
  Summary:
    Reads the WPS process results back from the WINC1500 module and updates the
    configuration data.
    <p><b>Implementation:</b> Dynamic</p>

  Description:
    After the WPS process has completed, this function is used to read the WPS process
    results from the WINC1500 module and update the configuration data.
