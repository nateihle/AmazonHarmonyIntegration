...
MACROS
*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*/
#define SVN_REVISION 14200 /* Directory tree SVN revision */
#define SVN_REL_URL "branches/WIFIIOT-1660_19_5_2_RC6" /* Directory tree relative SVN URL */
...
typedef enum {
	...
	*/
	M2M_WIFI_SEC_802_1X
	/*!< Wi-Fi network is secured with WPA/WPA2 Enterprise. IEEE 802.1x user-name/password authentication.
	 */
}tenuM2mSecType;
