...
@pre 
	Application users must provide a call back function responsible for receiving all the Wi-Fi events that are received on the M2M_WIFI layer.
...
@brief	Deinitilize the WINC driver and host enterface. 
		...
		Every function call of "nm_wifi_init" should be matched with a call to nm_wifi_deinit.
@see
	nm_wifi_init
