/*******************************************************************************
  MRF24WN Wireless Driver OS Abstraction Layer

  File Name:
    wdrv_mrf24wn_osal.c

  Summary:
    OS abstraction layer for MRF24WN wireless driver.
 ...
 *  is used.
 * These are the only two cases supported by current MRF24WN driver.
