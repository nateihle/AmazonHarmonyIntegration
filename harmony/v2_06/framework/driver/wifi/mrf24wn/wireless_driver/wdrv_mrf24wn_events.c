/*******************************************************************************
  MRF24WN Wireless Driver Event Handler

  File Name:  
    wdrv_mrf24wn_events.c  

  Summary:
    Event handler for MRF24WN wireless driver.
...
{
    WDRV_DBG_TRACE_PRINT("Process pending event(s)\r\n");
}
...
{
    WDRV_INTR_SourceDisable(); // disable further interrupts
