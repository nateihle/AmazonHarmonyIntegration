...
#include "driver/wifi/mrf24wn/wireless_driver/include/wdrv_mrf24wn_iwpriv.h"
...
static IWPRIV_CONN_STATUS _connstatus_get(void)
{
    ...
    conn_status = WDRV_ConnectionState_Get();
    switch (conn_status) {
    case WDRV_CSTATE_NOT_CONNECTED:
        res = IWPRIV_CONNECTION_IDLE;
        break;
    case WDRV_CSTATE_CONNECTED:
...
static bool _is_servermode(void)
{
    if (gp_wdrv_cfg->networkType == WDRV_NETWORK_TYPE_SOFT_AP ||
            gp_wdrv_cfg->networkType == WDRV_NETWORK_TYPE_ADHOC)
        return true;
    else
        return false;
}
...
void iwpriv_get(IWPRIV_CMD cmd, IWPRIV_GET_PARAM *param)
{
    ...
    case CONNSTATUS_GET:
        ...
        break;
    case DEVICEINFO_GET:
        ((WDRV_DEVICE_INFO *)param->devInfo.info)->deviceType = WDRV_MRF24WN0M_DEVICE;
        break;
    case DRVSTATUS_GET:
        param->driverStatus.isOpen = _drvstatus_get();
        break;
    case FWUPGRADEREQUEST_GET:
        param->fwUpgrade.requested = false;
        break;
...
void iwpriv_set(IWPRIV_CMD cmd, IWPRIV_SET_PARAM *param)
{
    ...
    case CONFIG_SET:
        ...
        break;
    case SSID_SET:
        WDRV_EXT_CmdSSIDSet(param->ssid.ssid);
        break;
    ...
    case MULTICASTFILTER_SET:
        ...
        break;
    case POWERSAVE_SET:
        WDRV_EXT_CmdPowerSaveSet(param->powerSave.enabled);
        break;
    default:
