...
/* PLIB ID Static Configuration Override
  ...
  Summary:
    Allows static override of the peripheral library ID.

  Description:
    These macros allow the peripheral library ID to be statically overridden by 
...
/* Interrupt Source Static Configuration Override
  ...
  Description:
    These macros allow the interrupt source to be statically overridden by the 
