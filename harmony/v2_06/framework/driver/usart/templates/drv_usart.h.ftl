...
#define DRV_USART_LINES_ENABLE_IDX0                 ${CONFIG_DRV_USART_LINES_ENABLE_IDX0}
...
#define DRV_USART_LINES_ENABLE_IDX1                 ${CONFIG_DRV_USART_LINES_ENABLE_IDX1}
...
#define DRV_USART_LINES_ENABLE_IDX2                 ${CONFIG_DRV_USART_LINES_ENABLE_IDX2}
...
#define DRV_USART_LINES_ENABLE_IDX3                 ${CONFIG_DRV_USART_LINES_ENABLE_IDX3}
...
#define DRV_USART_LINES_ENABLE_IDX4                 ${CONFIG_DRV_USART_LINES_ENABLE_IDX4}
...
#define DRV_USART_LINES_ENABLE_IDX5                 ${CONFIG_DRV_USART_LINES_ENABLE_IDX5}
