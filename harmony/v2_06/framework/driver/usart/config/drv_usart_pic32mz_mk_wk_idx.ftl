...
config DRV_USART_ERR_INT_PRIORITY_IDX${INSTANCE}
    ...
    depends on DRV_USART_INTERRUPT_MODE
    range INT_PRIORITY_LEVEL
    default DRV_USART_RCV_INT_PRIORITY_IDX${INSTANCE}
    ---help---
    IDH_HTML_INT_PRIORITY_LEVEL
    ---endhelp---
...
config DRV_USART_ERR_INT_SUB_PRIORITY_IDX${INSTANCE}
    ...
    depends on DRV_USART_INTERRUPT_MODE
    range INT_SUBPRIORITY_LEVEL
    default DRV_USART_RCV_INT_SUB_PRIORITY_IDX${INSTANCE}
    ---help---
    IDH_HTML_INT_SUBPRIORITY_LEVEL
    ---endhelp---
...
config DRV_USART_NON_PPS_LINES_ENABLE_IDX${INSTANCE}
    string "USART Lines Enable"
    depends on USE_DRV_USART && !HAVE_PPS
    range USART_OPERATION_MODE
    default "USART_ENABLE_TX_RX_CTS_RTS_USED" if DRV_USART_HANDSHAKE_MODE_IDX${INSTANCE} != "DRV_USART_HANDSHAKE_NONE"
    default "USART_ENABLE_TX_RX_BCLK_USED" if  DRV_USART_OPER_MODE_IDX${INSTANCE} = "DRV_USART_OPERATION_MODE_IRDA"
    default "USART_ENABLE_TX_RX_USED"
    ---help---
    IDH_HTML_USART_OPERATION_MODE
    ---endhelp---
    
config DRV_USART_LINES_ENABLE_IDX${INSTANCE}
    string
    depends on USE_DRV_USART
    range USART_OPERATION_MODE
    default DRV_USART_NON_PPS_LINES_ENABLE_IDX${INSTANCE} if !HAVE_PPS
    default "USART_ENABLE_TX_RX_CTS_RTS_USED" if DRV_USART_HANDSHAKE_MODE_IDX${INSTANCE} != "DRV_USART_HANDSHAKE_NONE" && HAVE_PPS
    default "USART_ENABLE_TX_RX_BCLK_USED" if  DRV_USART_OPER_MODE_IDX${INSTANCE} = "DRV_USART_OPERATION_MODE_IRDA" && HAVE_PPS
    default "USART_ENABLE_TX_RX_USED" if HAVE_PPS
    ---help---
    IDH_HTML_USART_OPERATION_MODE
    ---endhelp---
