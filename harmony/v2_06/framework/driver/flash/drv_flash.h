...
/* Function
   ...
   Description:
    This function starts the process of programming a Word into the Flash.
   ...
   Precondition:
    The flashAddr is taken as a valid Flash address.  No range checking occurs.
   ...
   Parameters:
    ...
    param3 uint32_t sourceData  This is the data which will be written to the Flash.
...
/* Function
   ...
   Description:
    ...
    It always erases a single page.  The size of a page in bytes will vary by
...
/* Function
   ...
   Description:
    This function checks whether the process of programming a Word into the Flash is
    still operating.
...
#include "framework/driver/flash/drv_flash_static.h"
#endif
