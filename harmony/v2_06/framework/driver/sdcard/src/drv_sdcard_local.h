...
#define _DRV_SDCARD_READ_TIMEOUT_IN_MS              (250)
#define _DRV_SDCARD_WRITE_TIMEOUT_IN_MS             (250)
...
typedef struct _DRV_SDCARD_OBJ_STRUCT
{
    ...
    DRV_SDCARD_TASK_STATES          nextTaskState;
