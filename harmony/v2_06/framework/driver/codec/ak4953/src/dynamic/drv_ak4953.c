...
void DRV_AK4953_IntExtMicSet(DRV_HANDLE handle, DRV_AK4953_INT_EXT_MIC micInput)
{
    if (micInput == INT_MIC)
    {
        //Internal Mic for AK4953 X32 DB
         DRV_AK4953_MicSet(handle, MIC1);
    }
    else
    {
        //External Mic for AK4953 X32 DB
         DRV_AK4953_MicSet(handle, MIC2);
    }
}
...
/*
  ...
  Summary:
    This function select the single-ended AK4953 microphone
    input for the AK4953 Codec 

  Description:
    This function selects the single-ended AK4953 microphone
    input for the AK4953 Codec (Where the MEMS mic is MIC1, and the 
    external Microphone input is MIC2 on the AK4953 XC32 Daughter Board)
...
void DRV_AK4953_MicSet(DRV_HANDLE handle, DRV_AK4953_MIC micInput)
{
    ...
    switch (micInput)
    {
        case MIC1:
        {
            if(drvObj->lastRegValue[AK4953A_REG_SIG_SLCT1] == 
               (DRV_AK4953_CONTROL_REG_FIELD_WRITE(AK4953A_REG_SIG_SLCT1, 
                                                   0x10, 
                                                   0, 
                                                   0)) && 
               drvObj->lastRegValue[AK4953A_REG_SIG_SLCT2] == 
               (DRV_AK4953_CONTROL_REG_FIELD_WRITE(AK4953A_REG_SIG_SLCT2, 
                                                   0x0F, 
                                                   0, 
                                                   0)))
            {
        ...
        {   //External Mic with +20dB Gain
            ...
            //MPWR with +20dB gain
            regValue0 = _DRV_AK4953_CONTROL_REG_FIELD_WRITE_Wrapper(
                                drvObj,
                                AK4953A_REG_SIG_SLCT1,
                                0x17,
                                0, 
                                SIGSLCT1_MPSEL_UP);
            //MIC2
            regValue1 = _DRV_AK4953_CONTROL_REG_FIELD_WRITE_Wrapper(
                                drvObj,
                                AK4953A_REG_SIG_SLCT2,
                                0x0F,
                                0, 
    ...
    micSetCmd->command = DRV_AK4953_COMMAND_MIC_SET;
    ...
    switch (drvObj->command)
    {
        ...
        case DRV_AK4953_COMMAND_INIT_MODE_CTRL_SET:
        {
            ...
            if  (DRV_I2C_TransferStatusGet(drvObj->drvI2CMasterHandle, drvObj->drvI2CBuffHandle) == DRV_I2C_BUFFER_EVENT_COMPLETE)
            {
                ...
                regValue = _DRV_AK4953_CONTROL_REG_FIELD_WRITE_Wrapper(
                                drvObj,
                                AK4953A_REG_SIG_SLCT1,
                                0x07,
                                0, 
                ...
                drvObj->drvI2CBuffHandle = _DRV_AK4953_ConrolRegisterSet(drvObj, command_array, 6);
            }
            break;
        }
                    ...
                    && false == drvObj->controlCommandStatus)
            {
                ...
                regValue = _DRV_AK4953_CONTROL_REG_FIELD_WRITE_Wrapper(drvObj,
                            ...
                            (PWRMGMT1_PMPFIL_UP | PWRMGMT1_PMVCM_UP | 
                             PWRMGMT1_PMSPK_UP | PWRMGMT1_PMDAC_UP | 
                ...
                regValue = _DRV_AK4953_CONTROL_REG_FIELD_WRITE_Wrapper(drvObj,
                            ...
                            0xFF,
                            0,
                            SIGSLCT1_SPPSN_UP | SIGSLCT1_MPSEL_UP | 
                            SIGSLCT1_PMMP_UP  //Mic enabled, Mic gain set
                            );
...
//                _DRV_AK4953_ConrolRegisterSet(drvObj,AK4953A_REG_LDIG_VOL_CTRL,drvObj->volume[DRV_AK4953_CHANNEL_LEFT]);
        ...
        case DRV_AK4953_COMMAND_MIC_SET:
