/*******************************************************************************
  ...
  Description:
    ...
    manage the AK4954 106dB 192kHz 24-Bit DAC that can be interfaced
    Microchip Microcontroller. This file provides the
    interface definition for the AK4954 CODEC device driver.
 *******************************************************************************/
...
#define DRV_I2C_INDEX DRV_AK4954_I2C_INSTANCES_NUMBER
...
/* AK4954 Driver Invalid Buffer Handle
  ...
  Description:
    ...
    is returned by DRV_AK4954_BufferAddWrite() function if the buffer add request
    was not successful.
...
/* Function:
  ...
  Description:
    ...
    AK4954 can be opened with DRV_IO_INTENT_WRITE, or DRV_IO_INTENT_READ or DRV_IO_INTENT_WRITEREAD io_intent option.
