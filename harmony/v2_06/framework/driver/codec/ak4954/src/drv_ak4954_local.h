...
// *****************************************************************************
/* AK4954 Master Clock from REFCLOCK
  ...
  Description:
    ...
    AK4954. The source t0 generate master clock is REFCLOCK.

  Remarks:
    None.
*/
#define DRV_AK4954_MCLK_RODIV(source, rate, ratio)  ((source / rate / (ratio << 1)) )
#define DRV_AK4954_MCLK_ROTRIM(source, rate, ratio) (((source / rate) & ((ratio << 1)-1)) )
...
typedef enum
{
    ...
    DRV_AK4954_COMMAND_INIT_MODE_CTRL_SET,
    DRV_AK4954_COMMAND_DFLTR_MODE_SET,
    DRV_AK4954_COMMAND_INIT_AUDIOFORMAT,
