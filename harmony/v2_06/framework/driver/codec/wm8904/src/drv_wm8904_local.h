/*******************************************************************************
  ...
  Summary:
    WM8904 Codec driver local declarations and definitions

  Description:
    This file contains the WM8904 Codec driver's local declarations and definitions.
*******************************************************************************/
...
#ifndef _DRV_WM8904_LOCAL_H
#define _DRV_WM8904_LOCAL_H
...
#include "osal/osal.h"
#include "driver/codec/wm8904/drv_wm8904.h"
...
/* WM8904 Driver Version Macros

  Summary:
    WM8904 driver version.

  Description:
    These constants provide WM8904 driver version information. The driver
    version is:
    DRV_WM8904_VERSION_MAJOR.DRV_WM8904_VERSION_MINOR[.<DRV_WM8904_VERSION_PATCH>][DRV_WM8904_VERSION_TYPE]
    It is represented in DRV_I2S_VERSION as:
    MAJOR *10000 + MINOR * 100 + PATCH, so as to allow comparisons.
    It is also represented in string format in DRV_WM8904_VERSION_STR.
    DRV_WM8904_VERSION_TYPE provides the type of the release when the
    release is a(alpha) or b(beta). The interfaces DRV_WM8904_VersionGet
    and DRV_WM8904_VersionStrGet provide interfaces to the access the
    version and the version string.

  Remarks:
    Modify the return value of DRV_I2S_VersionStrGet and the
    DRV_WM8904_VERSION_MAJOR, DRV_WM8904_VERSION_MINOR,
    DRV_WM8904_VERSION_PATCH, and DRV_WM8904_VERSION_TYPE.
 */

#define _DRV_WM8904_VERSION_MAJOR         0
#define _DRV_WM8904_VERSION_MINOR         1
#define _DRV_WM8904_VERSION_PATCH         0
#define _DRV_WM8904_VERSION_TYPE          a
#define _DRV_WM8904_VERSION_STR           "0.1.0a"

// *****************************************************************************
// *****************************************************************************
// Section: Register Definitions for WM8904 codec
// *****************************************************************************
// *****************************************************************************
...
// *****************************************************************************
/* I2C Address for the on-board WM8904 Codec.

  Summary:
    Defines the on-board WM8904 Codec's I2C Address.

  Description:
    This #define defines the on-board WM8904 Codec's I2C Address. It is used
    by the I2C Driver API's to transmit and receive data.
*/
    
#define DRV_WM8904_DEVICE_ADDR           0x34     // 0011 0100   In Harmony Driver format.
 ...
 * Driver Client Obj
 **********************************************/
typedef struct _DRV_WM8904_CLIENT_OBJ_STRUCT
{
    ...
    DRV_WM8904_BUFFER_EVENT_HANDLER  pEventCallBack;
...
typedef enum
{
    ...
    DRV_WM8904_STATE_READY,                        

    DRV_WM8904_STATE_RESET_ADDRESS,

    /* Application transmit bytes state */
	DRV_WM8904_STATE_DATA_TRANSMIT,

    DRV_WM8904_STATE_WRITE_COMPLETE_MAIN,
            
    /* Application error state */
    DRV_WM8904_STATE_ERROR,
            
    /* Application timer wait state */
    DRV_WM8904_STATE_WAIT,
            
    DRV_WM8904_STATE_DONE            
...
#define WM8904_MAX_I2C_COMMANDS  60     // current max at tone time is about 40
...
typedef struct _DRV_WM8904_OBJ_STRUCT
{
    ...
    uint8_t volume[DRV_WM8904_NUMBER_OF_CHANNELS];

    /* Command complete callback function */
    DRV_WM8904_COMMAND_EVENT_HANDLER commandCompleteCallback;
    ...
    uint32_t WM8904Delay;        // decremented in TimerCallback every ms
    
    WM8904_I2C_COMMAND_BUFFER I2C_Commands[WM8904_MAX_I2C_COMMANDS];
...
// *****************************************************************************
/* WM8904 Driver Global Instances Object
  ...
  Description:
    ...
    instances of the WM8904 driver.
