...
<#if CONFIG_DRV_EEPROM_DRIVER_MODE == "DYNAMIC">
...
{
<#if CONFIG_DRV_EEPROM_POWER_STATE?has_content>
    .moduleInit.sys.powerState = ${CONFIG_DRV_EEPROM_POWER_STATE},
</#if>
<#if CONFIG_DRV_EEPROM_PERIPHERAL_ID?has_content>
    .eepromId = ${CONFIG_DRV_EEPROM_PERIPHERAL_ID},
</#if>
