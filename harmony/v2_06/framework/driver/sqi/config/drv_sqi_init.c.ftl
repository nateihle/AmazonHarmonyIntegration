<#--
/*******************************************************************************
  SQI Driver Initialization File
...
<#if CONFIG_USE_SYS_INT == true && CONFIG_DRV_SQI_INTERRUPT_MODE == true>    
    /* Configure the Flash Controller Interrupt Priority */
    SYS_INT_VectorPrioritySet(${CONFIG_DRV_SQI_INTERRUPT_VECTOR}, ${CONFIG_DRV_SQI_INTERRUPT_PRIORITY});

    /* Configure the Flash Controller Interrupt Sub Priority */
    SYS_INT_VectorSubprioritySet(${CONFIG_DRV_SQI_INTERRUPT_VECTOR}, ${CONFIG_DRV_SQI_INTERRUPT_SUB_PRIORITY});
</#if>
