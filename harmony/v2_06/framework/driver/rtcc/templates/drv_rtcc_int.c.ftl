...
void __ISR(${CONFIG_DRV_RTCC_ISR_VECTOR}, ipl${CONFIG_DRV_RTCC_INT_PRIO_NUM}SOFT) _IntHandlerRTCC(void)
<#else>
<#if CONFIG_3RDPARTY_RTOS_USED == "embOS">
void __attribute__( (interrupt(ipl${CONFIG_DRV_RTCC_INT_PRIO_NUM}AUTO), vector(${CONFIG_DRV_RTCC_ISR_VECTOR}))) IntHandlerRTCC_ISR( void );
</#if>
