...
//DOM-IGNORE-END
-->
<#macro DRV_IC_ASM_INT DRV_IC_INSTANCE DRV_IC_ID IC_INTPRIO>
...
<@RTOS_ISR VECTOR = IC_ISR_VECTOR NAME = IC_ISR_NAME PRIORITY = IC_INTPRIO/>
<#else>
<#if DRV_IC_ID == "IC_ID_1">
<#assign IC_ISR_VECTOR = CONFIG_INT_VECT_INPUT_CAPTURE_1>
...
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX0>
</#if>
<#if DRV_IC_INSTANCE == "1">
<#assign IC_ISR_NAME = "DrvICInstance1">
<#assign IC_FAULT_ISR_NAME = "DrvICErrorInstance1">
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX1>
</#if>
<#if DRV_IC_INSTANCE == "2">
<#assign IC_ISR_NAME = "DrvICInstance2">
<#assign IC_FAULT_ISR_NAME = "DrvICErrorInstance2">
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX2>
</#if>
<#if DRV_IC_INSTANCE == "3">
<#assign IC_ISR_NAME = "DrvICInstance3">
<#assign IC_FAULT_ISR_NAME = "DrvICErrorInstance3">
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX3>
</#if>
<#if DRV_IC_INSTANCE == "4">
<#assign IC_ISR_NAME = "DrvICInstance4">
<#assign IC_FAULT_ISR_NAME = "DrvICErrorInstance4">
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX4>
</#if>
<#if DRV_IC_INSTANCE == "5">
<#assign IC_ISR_NAME = "DrvICInstance5">
<#assign IC_FAULT_ISR_NAME = "DrvICErrorInstance5">
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX5>
</#if>
<#if DRV_IC_INSTANCE == "6">
<#assign IC_ISR_NAME = "DrvICInstance6">
<#assign IC_FAULT_ISR_NAME = "DrvICErrorInstance6">
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX6>
</#if>
<#if DRV_IC_INSTANCE == "7">
<#assign IC_ISR_NAME = "DrvICInstance7">
<#assign IC_FAULT_ISR_NAME = "DrvICErrorInstance7">
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX7>
</#if>
<#if DRV_IC_INSTANCE == "8">
<#assign IC_ISR_NAME = "DrvICInstance8">
<#assign IC_FAULT_ISR_NAME = "DrvICErrorInstance8">
<#assign IC_FAULT_INT_PRIO = CONFIG_DRV_IC_ERR_INT_PRIORITY_IDX8>
</#if>
/* IC Instance ${DRV_IC_INSTANCE} Interrupts */
<@RTOS_ISR VECTOR = IC_ISR_VECTOR NAME = IC_ISR_NAME PRIORITY = IC_INTPRIO/>
<@RTOS_ISR VECTOR = IC_FAULT_ISR_VECTOR NAME = IC_FAULT_ISR_NAME PRIORITY = IC_FAULT_INT_PRIO/>
</#if>
</#macro>
<#if CONFIG_DRV_IC_INTERRUPT_MODE == true>
<#if CONFIG_DRV_IC_INST_IDX0 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="0" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX0 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX0/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX1 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="1" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX1 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX1/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX2 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="2" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX2 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX2/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX3 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="3" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX3 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX3/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX4 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="4" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX4 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX4/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX5 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="5" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX5 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX5/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX6 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="6" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX6 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX6/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX7 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="7" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX7 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX7/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX8 == true>
<@DRV_IC_ASM_INT DRV_IC_INSTANCE="8" DRV_IC_ID=CONFIG_DRV_IC_PERIPHERAL_ID_IDX8 IC_INTPRIO=CONFIG_DRV_IC_INT_PRIORITY_IDX8/>
</#if>
</#if>
