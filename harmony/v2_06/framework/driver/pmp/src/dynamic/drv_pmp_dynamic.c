...
//PMAENbits.PTEN15=1;
//	PMADDRbits.CS2=1; // temporary, remove later when plib is corrected
//	PMADDRbits.CS1=0; // temporary, remove later when plib is corrected
//	PMCONbits.CSF=01; // temporary, remove later when plib is corrected
