...
comment "*** Filters must use Type 1 and Type 2 inputs only. Please check the data sheet for correct inputs. ***"
    depends on USE_DRV_ADC
	depends on DRV_ADC_TYPE_ADCHS
	depends on DRV_ADCHS_DIGITAL_FILTER_INST_IDX${INSTANCE}
