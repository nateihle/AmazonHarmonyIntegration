...
ifblock DRV_ADCHS_CHANNEL_ID_IDX${INSTANCE} != "ADCHS_CHANNEL_7"
config DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_ENABLE_IDX${INSTANCE}
...
config DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE}
    string "Interrupt Priority"
    depends on USE_DRV_ADC && DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_ENABLE_IDX${INSTANCE}
...
config DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_SUB_PRIORITY_IDX${INSTANCE}
...
config DRV_ADCHS_CHANNEL_DATA_RDY_INT_IPL_IDX${INSTANCE}
    string
    depends on USE_DRV_ADC && DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_ENABLE_IDX${INSTANCE}
    default "0" if DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE} = "INT_DISABLE_INTERRUPT"
    default "1" if DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE} = "INT_PRIORITY_LEVEL1"
    default "2" if DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE} = "INT_PRIORITY_LEVEL2"
    default "3" if DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE} = "INT_PRIORITY_LEVEL3"
    default "4" if DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE} = "INT_PRIORITY_LEVEL4"
    default "5" if DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE} = "INT_PRIORITY_LEVEL5"
    default "6" if DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE} = "INT_PRIORITY_LEVEL6"
    default "7" if DRV_ADCHS_CHANNEL_DATA_RDY_INTERRUPT_PRIORITY_IDX${INSTANCE} = "INT_PRIORITY_LEVEL7"
