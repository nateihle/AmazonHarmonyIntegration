...
Microchip DSP Library
    Bartlett (Triangle) Windows Initialization

  Company:
    Microchip Technology Inc.

  File Name:
    dsp_transform_window_init_bartlett.c
  ...
  Description:
    ...
    the most accuracy possible.  Both 16-bit and 32-bit functions are provided. 
    Output values are in Q15 fractional format and Q31 fractional format
    respectively. 
