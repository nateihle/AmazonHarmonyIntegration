...
#define MAX_DEMO_EVENTS ${CONFIG_LIBARIA_DEMO_MODE_MAX_EVENTS}
<#if CONFIG_LIBARIA_DEMO_MODE_RECORD == true>
#define RECORD_TICK_PERIOD_MS ${CONFIG_LIBARIA_DEMO_MODE_RECORD_TICK_PERIOD_MS}
</#if>
#define DEMO_IDLE_TIMEOUT_S ${CONFIG_LIBARIA_DEMO_MODE_IDLE_TIMEOUT_SECS}
#define DEMO_REPEAT_TIMEOUT_S ${CONFIG_LIBARIA_DEMO_MODE_REPLAY_DELAY_SECS}
