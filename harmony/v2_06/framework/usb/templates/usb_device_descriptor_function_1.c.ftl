...
<#elseif CONFIG_USB_DEVICE_FUNCTION_1_DEVICE_CLASS_HID_IDX0 == true>
    ...
    USB_DESCRIPTOR_ENDPOINT,        // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_1_HID_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_IN,    // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_1_HID_ENDPOINT_NUMBER_IDX0} IN )
    ...
    0x07,                           // Size of this descriptor in bytes
    USB_DESCRIPTOR_ENDPOINT,        // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_1_HID_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_OUT,   // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_1_HID_ENDPOINT_NUMBER_IDX0} OUT )
    USB_TRANSFER_TYPE_INTERRUPT,    // Attributes
    0x40,0x00,                      // size
    0x01,                           // Interval
    ...
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_1_MSD_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_IN,    // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_1_MSD_ENDPOINT_NUMBER_IDX0} IN )
    USB_TRANSFER_TYPE_BULK,     // Attributes type of EP (BULK)
    <#if usbDeviceSpeed == 1>
    0x00, 0x02,                 // Max packet size of this EP
    <#elseif usbDeviceSpeed == 2 >
    ...
    7,                          // Size of this descriptor in bytes
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_1_MSD_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_OUT,   // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_1_MSD_ENDPOINT_NUMBER_IDX0} OUT )
    USB_TRANSFER_TYPE_BULK,     // Attributes type of EP (BULK)
    <#if usbDeviceSpeed == 1>
    0x00, 0x02,                 // Max packet size of this EP
    <#elseif usbDeviceSpeed == 2 >
   ...
   /* USB Speaker Standard Audio Control Interface Descriptor	*/
    ...
    0x07,                       // Size of this descriptor in bytes
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor 
    ${CONFIG_USB_DEVICE_FUNCTION_1_VENDOR_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_OUT,   // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_1_VENDOR_ENDPOINT_NUMBER_IDX0} OUT )
    ...
    0x07,                       // Size of this descriptor in bytes
    USB_DESCRIPTOR_ENDPOINT,    // Endpoint Descriptor
    ${CONFIG_USB_DEVICE_FUNCTION_1_VENDOR_ENDPOINT_NUMBER_IDX0} | USB_EP_DIRECTION_IN,    // EndpointAddress ( EP${CONFIG_USB_DEVICE_FUNCTION_1_VENDOR_ENDPOINT_NUMBER_IDX0} IN )
    USB_TRANSFER_TYPE_BULK,     // Attributes
    <#if usbDeviceSpeed == 1>
    0x00, 0x02,                 // Max packet size of this EP
    <#elseif usbDeviceSpeed == 2 >
