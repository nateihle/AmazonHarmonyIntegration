...
#ifndef _OSC_P32MK1024MCF064_H
#define _OSC_P32MK1024MCF064_H
...
typedef enum {
    ...
    SYS_OSC_USBCLK_FRC = 0x02,
    SYS_OSC_USBCLK_POSC = 0x01
...
typedef enum {
    ...
    OSC_UPLL_OUT_DIV_32 = 0x05,
    OSC_UPLL_OUT_DIV_16 = 0x04,
    OSC_UPLL_OUT_DIV_8 = 0x03,
    OSC_UPLL_OUT_DIV_4 = 0x02,
...
typedef enum {
    ...
    OSC_UPLL_FREQ_RANGE_54M_TO_90M = 0x06,
    OSC_UPLL_FREQ_RANGE_34M_TO_68M = 0x05,
    OSC_UPLL_FREQ_RANGE_21M_TO_42M = 0x04,
    OSC_UPLL_FREQ_RANGE_13M_TO_26M = 0x03,
    OSC_UPLL_FREQ_RANGE_8M_TO_16M = 0x02,
    OSC_UPLL_FREQ_RANGE_5M_TO_10M = 0x01,
...
#include "../templates/osc_UsbClockSource_PIC32MK.h"
...
#include "../templates/osc_UPLLInputDivisor_PIC32MK.h"
...
#include "../templates/osc_UPLLFrequencyRange_PIC32MK.h"
