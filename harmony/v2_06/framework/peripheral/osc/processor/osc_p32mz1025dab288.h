...
#ifndef _OSC_P32MZ1025DAB288_H
#define _OSC_P32MZ1025DAB288_H
...
typedef enum {
    ...
    OSC_CLOCK_SYSTEM_PLL = 0x7,
    OSC_CLOCK_DIVIDED_SYSTEM_PLL = 0x1
...
#include "../templates/osc_ReferenceOscDivisor_PIC32_3.h"
...
{
     return OSC_ExistsReferenceOscDivisor_PIC32_3(index);
}
...
{
     OSC_ReferenceOscDivisorValueSet_PIC32_3(index, referenceOsc, refOscDivValue);
}
