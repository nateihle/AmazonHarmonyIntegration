...
#ifndef _CAN_P32WK2057GPD132_H
#define _CAN_P32WK2057GPD132_H
...
typedef enum {
    ...
    CAN_NUMBER_OF_FILTER_MASKS = 0x03
...
typedef enum {
    ...
    CAN_ANYCHANNEL_MASK = 0x0000FFFF
...
#include "../templates/can_FilterMaskConfigure_pic32wk.h"
...
{
     CAN_FilterMaskConfigure_pic32wk(index, mask, maskBits, idType, mide);
}

PLIB_INLINE_API bool PLIB_CAN_ExistsFilterMaskConfigure(CAN_MODULE_ID index)
{
     return CAN_ExistsFilterMaskConfigure_pic32wk(index);
}
