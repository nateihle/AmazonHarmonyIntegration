...
#ifndef _SB_P32MK0512GPD100_H
#define _SB_P32MK0512GPD100_H
...
#include "../templates/sb_ADCPriority_Default.h"
...
{
     return SB_ExistsADCPriority_Default(index);
}

PLIB_INLINE_API void PLIB_SB_ADCPrioritySet(SB_MODULE_ID index, PLIB_SB_ARB_POLICY priority)
{
     SB_ADCPrioritySet_Default(index, priority);
}
