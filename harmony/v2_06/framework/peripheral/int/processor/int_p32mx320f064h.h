...
#ifndef _INT_P32MX320F064H_H
#define _INT_P32MX320F064H_H
...
typedef enum {
    ...
    INT_SOURCE_SPI_1_RECEIVE = 25,
    INT_SOURCE_SPI_1_TRANSMIT = 24,
    ...
    INT_SOURCE_SPI_2_RECEIVE = 39,
    INT_SOURCE_SPI_2_TRANSMIT = 38,
