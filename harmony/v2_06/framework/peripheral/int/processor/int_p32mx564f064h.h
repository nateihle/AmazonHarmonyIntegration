...
#ifndef _INT_P32MX564F064H_H
#define _INT_P32MX564F064H_H
...
typedef enum {
    ...
    INT_SOURCE_USART_1A_ERROR = 26,
    INT_SOURCE_USART_1A_RECEIVE = 27,
    INT_SOURCE_USART_1A_TRANSMIT = 28,
    INT_SOURCE_SPI_1A_ERROR = 26,
    INT_SOURCE_SPI_1A_RECEIVE = 27,
    INT_SOURCE_SPI_1A_TRANSMIT = 28,
    INT_SOURCE_I2C_1A_ERROR = 26,
    INT_SOURCE_I2C_1A_RECEIVE = 27,
    INT_SOURCE_I2C_1A_TRANSMIT = 28,
    INT_SOURCE_USART_2A_ERROR = 37,
    INT_SOURCE_USART_2A_RECEIVE = 38,
    INT_SOURCE_USART_2A_TRANSMIT = 39,
    INT_SOURCE_USART_3A_ERROR = 40,
    INT_SOURCE_USART_3A_RECEIVE = 41,
    INT_SOURCE_USART_3A_TRANSMIT = 42,
    INT_SOURCE_SPI_2A_ERROR = 37,
    INT_SOURCE_SPI_2A_RECEIVE = 38,
    INT_SOURCE_SPI_2A_TRANSMIT = 39,
    INT_SOURCE_SPI_3A_ERROR = 40,
    INT_SOURCE_SPI_3A_RECEIVE = 41,
    INT_SOURCE_SPI_3A_TRANSMIT = 42,
    INT_SOURCE_I2C_4_MASTER = 39,
    INT_SOURCE_I2C_5_ERROR = 40,
    INT_SOURCE_I2C_2A_ERROR = 37,
    INT_SOURCE_I2C_2A_RECEIVE = 38,
    INT_SOURCE_I2C_2A_TRANSMIT = 39,
    INT_SOURCE_I2C_3A_ERROR = 40,
    INT_SOURCE_I2C_3A_RECEIVE = 41,
    INT_SOURCE_I2C_3A_TRANSMIT = 42,
    INT_SOURCE_USART_1B_ERROR = 67,
    INT_SOURCE_USART_1B_RECEIVE = 68,
    INT_SOURCE_USART_1B_TRANSMIT = 69,
    INT_SOURCE_USART_2B_ERROR = 70,
    INT_SOURCE_USART_2B_RECEIVE = 71,
    INT_SOURCE_USART_2B_TRANSMIT = 72,
    INT_SOURCE_USART_3B_ERROR = 73,
    INT_SOURCE_USART_3B_RECEIVE = 74,
    INT_SOURCE_USART_3B_TRANSMIT = 75
...
typedef enum {
    ...
    INT_VECTOR_UART4 = _UART_1B_VECTOR,
