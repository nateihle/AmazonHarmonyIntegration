...
#ifndef _WDT_P32MZ1064DAA288_H
#define _WDT_P32MZ1064DAA288_H
...
#include "../templates/wdt_SleepModePostscalerValue_Default.h"
...
{
     return WDT_ExistsSleepModePostscalerValue_Default(index);
}

PLIB_INLINE_API char PLIB_WDT_SleepModePostscalerValueGet(WDT_MODULE_ID index)
{
     return WDT_SleepModePostscalerValueGet_Default(index);
}
