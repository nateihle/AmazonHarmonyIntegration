...
#ifndef _WDT_P32MX575F256H_H
#define _WDT_P32MX575F256H_H
...
#include "../templates/wdt_WindowEnable_Unsupported.h"
...
{
     return WDT_ExistsWindowEnable_Unsupported(index);
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_WDT_WindowEnable(WDT_MODULE_ID index)
{
     WDT_WindowEnable_Unsupported(index);
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_WDT_WindowDisable(WDT_MODULE_ID index)
{
     WDT_WindowDisable_Unsupported(index);
}
