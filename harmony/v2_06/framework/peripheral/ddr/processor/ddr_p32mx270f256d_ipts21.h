...
#ifndef _DDR_P32MX270F256D_IPTS21_H
#define _DDR_P32MX270F256D_IPTS21_H
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_DDR_PHY_DriveStrengthSet(DDR_MODULE_ID index, DDR_PHY_DRIVE_STRENGTH drvStr)
{
    switch (index) {
        case DDR_NUMBER_OF_MODULES :
        default :
