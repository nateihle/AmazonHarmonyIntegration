...
#ifndef _NVM_P32MK0512GPE100_H
#define _NVM_P32MK0512GPE100_H
...
typedef enum {
    ...
    CALIBRATION_REG_0 = 0x0,
    CALIBRATION_REG_1 = 0x1,
    CALIBRATION_REG_2 = 0x2,
    CALIBRATION_REG_3 = 0x3
...
#include "../templates/nvm_EEPROMCalibrationData_Default.h"
#include "../templates/nvm_EEPROMWaitStates_Default.h"
...
{
     return NVM_ExistsEEPROMCalibrationData_Default(index);
}

PLIB_INLINE_API uint32_t PLIB_NVM_EEPROMReadCalibrationData(NVM_MODULE_ID index, EEPROM_CALIBRATION_REG regIndex)
{
     return NVM_EEPROMReadCalibrationData_Default(index, regIndex);
}

PLIB_INLINE_API bool PLIB_NVM_ExistsEEPROMWaitStates(NVM_MODULE_ID index)
{
     return NVM_ExistsEEPROMWaitStates_Default(index);
}

PLIB_INLINE_API uint8_t PLIB_NVM_EEPROMWaitStatesGet(NVM_MODULE_ID index)
{
     return NVM_EEPROMWaitStatesGet_Default(index);
}

PLIB_INLINE_API void PLIB_NVM_EEPROMWaitStatesSet(NVM_MODULE_ID index, uint8_t eews)
{
     NVM_EEPROMWaitStatesSet_Default(index, eews);
}
