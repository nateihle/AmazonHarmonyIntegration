...
#ifndef _ADCHS_P32WK2057GPD132_H
#define _ADCHS_P32WK2057GPD132_H
...
typedef enum {
    ...
    ADCHS_SCAN_TRIGGER_SOURCE_TMR7_MATCH = 8,
    ADCHS_SCAN_TRIGGER_SOURCE_OC1 = 9,
    ADCHS_SCAN_TRIGGER_SOURCE_OC2 = 10,
    ADCHS_SCAN_TRIGGER_SOURCE_OC3 = 11,
    ADCHS_SCAN_TRIGGER_SOURCE_OC4 = 12,
    ADCHS_SCAN_TRIGGER_SOURCE_PTG12 = 13,
    ADCHS_SCAN_TRIGGER_SOURCE_PTG13 = 14,
    ADCHS_SCAN_TRIGGER_SOURCE_PTG14 = 15,
    ADCHS_SCAN_TRIGGER_SOURCE_PTG15 = 16
...
typedef enum {
    ...
    ADCHS_CHANNEL_0_ALTERNATE_INP_AN0 = 1,
    ADCHS_CHANNEL_0_ALTERNATE_INP_AN1 = 2
...
typedef enum {
    ...
    ADCHS_ALTERNATE_CLASS1_AN0 = 1,
    ADCHS_ALTERNATE_CLASS1_AN1 = 2
...
typedef enum {
    ...
    ADCHS_TRIGGER_SOURCE_TMR7_MATCH = 8,
    ADCHS_TRIGGER_SOURCE_OC1 = 9,
    ADCHS_TRIGGER_SOURCE_OC2 = 10,
    ADCHS_TRIGGER_SOURCE_OC3 = 11,
    ADCHS_TRIGGER_SOURCE_OC4 = 12,
    ADCHS_TRIGGER_SOURCE_PTG12 = 13,
    ADCHS_TRIGGER_SOURCE_PTG13 = 14,
    ADCHS_TRIGGER_SOURCE_PTG14 = 15,
    ADCHS_TRIGGER_SOURCE_PTG15 = 16
...
#include "../templates/adchs_Registers_pic32wk.h"
#include "../templates/adchs_EnableControl_Default.h"
#include "../templates/adchs_TurboMode_Default.h"
#include "../templates/adchs_DigitalComparator_pic32wk.h"
#include "../templates/adchs_DigitalFilter_pic32wk.h"
#include "../templates/adchs_FIFO_Default.h"
#include "../templates/adchs_DMA_wk.h"
#include "../templates/adchs_CVD_wk.h"
#include "../templates/adchs_VREFControl_Default.h"
#include "../templates/adchs_AnalogInputScan_pic32wk.h"
#include "../templates/adchs_AnalogFeatureControl_pic32wk.h"
#include "../templates/adchs_DigitalFeatureControl_pic32wk.h"
#include "../templates/adchs_AnalogInputModeControl_pic32wk.h"
#include "../templates/adchs_TriggerControl_pic32wk.h"
#include "../templates/adchs_ChannelTriggerSampleControl_pic32wk.h"
#include "../templates/adchs_EarlyInterruptControl_Unsupported.h"
#include "../templates/adchs_ManualControl_Default.h"
#include "../templates/adchs_UpdateReadyControl_Default.h"
#include "../templates/adchs_InputControl_pic32wk.h"
#include "../templates/adchs_ExternalConversionRequest_Default.h"
#include "../templates/adchs_Setup_pic32wk.h"
#include "../templates/adchs_AnalogInputCheck_pic32wk.h"
#include "../templates/adchs_ChannelConfiguration_pic32wk.h"
#include "../templates/adchs_ConversionResult_pic32wk.h"
#include "../templates/adchs_ScanEnable_Default.h"
...
{
     ADCHS_DigitalComparatorAnalogInputSelect_pic32wk(index, digComparator, analogInput);
}
...
{
     ADCHS_DigitalComparatorInterruptEnable_pic32wk(index, digComparator);
}
...
{
     ADCHS_DigitalComparatorInterruptDisable_pic32wk(index, digComparator);
}
...
{
     ADCHS_DigitalComparatorSetup_pic32wk(index, id, intEnable, inBetweenOrEqual, greaterEqualHi, lessThanHi, greaterEqualLo, lessThanLo, analogInput, hiLimit, loLimit);
}

PLIB_INLINE_API bool PLIB_ADCHS_DigitalComparatorEventHasOccurred(ADCHS_MODULE_ID index, ADCHS_DIGITAL_COMPARATOR_ID id)
{
     return ADCHS_DigitalComparatorEventHasOccurred_pic32wk(index, id);
}
...
{
     ADCHS_DigitalFilterOversamplingModeSetup_pic32wk(index, id, analogInput, length, ratio, intEnable);
}
...
{
     ADCHS_DigitalFilterAveragingModeSetup_pic32wk(index, id, analogInput, length, count, intEnable);
}
...
{
     ADCHS_DigitalFilterOversamplingModeRatioSelect_pic32wk(index, id, ratio);
}
...
{
     ADCHS_DigitalFilterDataReadyInterruptEnable_pic32wk(index, digFilter);
}
...
{
     ADCHS_DigitalFilterDataReadyInterruptDisable_pic32wk(index, digFilter);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsDigitalFilter(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsDigitalFilter_pic32wk(index);
}
...
{
     ADCHS_CVDSetup_wk(index, capSel, inBetweenOrEqual, greaterEqualHi, lessThanHi, greaterEqualLo, lessThanLo, inputEnable, hiLimit, loLimit);
}

PLIB_INLINE_API int16_t PLIB_ADCHS_CVDResultGet(ADCHS_MODULE_ID index)
{
     return ADCHS_CVDResultGet_wk(index);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsCVD(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsCVD_wk(index);
}
...
{
     ADCHS_AnalogInputEarlyInterruptEnable_Unsupported(index, analogInput);
}
...
{
     ADCHS_AnalogInputEarlyInterruptDisable_Unsupported(index, analogInput);
}
...
{
     return ADCHS_AnalogInputEarlyInterruptIsReady_Unsupported(index, analogInput);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsEarlyInterruptControl(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsEarlyInterruptControl_Unsupported(index);
}
...
{
     return ADCHS_ChannelInputSelect_pic32wk(index, channelID, sel);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsChannelInputSelectControl(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsChannelInputSelectControl_pic32wk(index);
}

PLIB_INLINE_API void PLIB_ADCHS_ExternalConversionRequestEnable(ADCHS_MODULE_ID index)
{
     ADCHS_ExternalConversionRequestEnable_Default(index);
}

PLIB_INLINE_API void PLIB_ADCHS_ExternalConversionRequestDisable(ADCHS_MODULE_ID index)
{
     ADCHS_ExternalConversionRequestDisable_Default(index);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsExternalConversionRequestControl(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsExternalConversionRequestControl_Default(index);
}
...
{
     ADCHS_Setup_pic32wk(index, voltageRefSelect, chargePump, outputFormat, stopInIdle, sysClk, periClk, intVectorShift, intVectorBase, adcClockSource, adcClockDivider, warmUpClock);
}
