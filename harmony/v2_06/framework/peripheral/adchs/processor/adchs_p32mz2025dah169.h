...
#ifndef _ADCHS_P32MZ2025DAH169_H
#define _ADCHS_P32MZ2025DAH169_H
...
typedef enum {
    ...
    ADCHS_SCAN_TRIGGER_SOURCE_CTMU = 13
...
#include "../templates/adchs_Registers_Default.h"
...
#include "../templates/adchs_Setup_PIC32MZ_DA.h"
...
{
     return ADCHS_ExistsRegisters_Default(index);
}
...
{
     ADCHS_Setup_PIC32MZ_DA(index, voltageRefSelect, chargePump, outputFormat, stopInIdle, sysClk, periClk, intVectorShift, intVectorBase, adcClockSource, adcClockDivider, warmUpClock);
}
...
{
     ADCHS_ChannelSetup_PIC32MZ_DA(index, channelID, res, channelClockDivider, sampleTimeCount, earlyInterruptClk);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsConfiguration(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsConfiguration_PIC32MZ_DA(index);
}
