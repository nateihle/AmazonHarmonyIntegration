...
PLIB_TEMPLATE void ADCHS_Setup_pic32mk( ADCHS_MODULE_ID index , ADCHS_VREF_SOURCE voltageRefSelect , ADCHS_CHARGEPUMP_MODE chargePump , ADCHS_OUTPUT_DATA_FORMAT outputFormat , bool stopInIdle , ADCHS_FAST_SYNC_SYSTEM_CLOCK sysClk , ADCHS_FAST_SYNC_PERIPHERAL_CLOCK periClk , ADCHS_INTERRUPT_BIT_SHIFT_LEFT intVectorShift , uint16_t intVectorBase , ADCHS_CLOCK_SOURCE adcClockSource , int8_t adcClockDivider , ADCHS_WARMUP_CLOCK warmUpClock )
{
    ...
    regs->ADCBASE.bits = intVectorBase;

    ADCANCON->WKUPCLKCNT = warmUpClock;
}

//******************************************************************************
/* Function :  ADCHS_ChannelSetup_pic32mk

  Summary:
    Implements pic32mk variant of PLIB_ADCHS_ChannelSetup 

  Description:
    This template implements the pic32mk variant of the PLIB_ADCHS_ChannelSetup function.
    Operation is not atomic.
*/

PLIB_TEMPLATE void ADCHS_ChannelSetup_pic32mk( ADCHS_MODULE_ID index , ADCHS_CHANNEL_ID channelID , ADCHS_DATA_RESOLUTION res , uint8_t	channelClockDivider , uint16_t sampleTimeCount , ADCHS_EARLY_INTERRUPT_PRIOR_CLOCK earlyInterruptClk )
{
    volatile adchs_register_t *regs = (adchs_register_t *)index;
	...
	*ADCCON2 = tempVal;
	...
	tempVal = regs->ADCxTIME[channelID].bits;
	...
	regs->ADCxTIME[channelID].bits = tempVal;
    }
}


//******************************************************************************
/* Function :  ADCHS_ExistsConfiguration_pic32mk

  Summary:
    Implements pic32mk variant of PLIB_ADCHS_ExistsConfiguration

  Description:
    This template implements the pic32mk variant of the PLIB_ADCHS_ExistsConfiguration function.
*/

#define PLIB_ADCHS_ExistsConfiguration PLIB_ADCHS_ExistsConfiguration
PLIB_TEMPLATE bool ADCHS_ExistsConfiguration_pic32mk( ADCHS_MODULE_ID index )
{
    return true;
}


#endif /*_ADCHS_SETUP_PIC32MK_H*/
