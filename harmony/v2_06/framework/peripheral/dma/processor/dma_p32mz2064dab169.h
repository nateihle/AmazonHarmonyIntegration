...
#ifndef _DMA_P32MZ2064DAB169_H
#define _DMA_P32MZ2064DAB169_H
...
typedef enum {
    ...
    DMA_TRIGGER_ADC_DC1 = 46,
    DMA_TRIGGER_ADC_DC2 = 47,
    DMA_TRIGGER_ADC_DC3 = 48,
    DMA_TRIGGER_ADC_DC4 = 49,
    DMA_TRIGGER_ADC_DC5 = 50,
    DMA_TRIGGER_ADC_DC6 = 51,
    DMA_TRIGGER_ADC_DF1 = 52,
    DMA_TRIGGER_ADC_DF2 = 53,
    DMA_TRIGGER_ADC_DF3 = 54,
    DMA_TRIGGER_ADC_DF4 = 55,
    DMA_TRIGGER_ADC_DF5 = 56,
    DMA_TRIGGER_ADC_DF6 = 57,
    DMA_TRIGGER_ADC_FAULT = 58,
    DMA_TRIGGER_ADC_DATA0 = 59,
    DMA_TRIGGER_ADC_DATA1 = 60,
    DMA_TRIGGER_ADC_DATA2 = 61,
    DMA_TRIGGER_ADC_DATA3 = 62,
    DMA_TRIGGER_ADC_DATA4 = 63,
    DMA_TRIGGER_ADC_DATA5 = 64,
    DMA_TRIGGER_ADC_DATA6 = 65,
    DMA_TRIGGER_ADC_DATA7 = 66,
    DMA_TRIGGER_ADC_DATA8 = 67,
    DMA_TRIGGER_ADC_DATA9 = 68,
    DMA_TRIGGER_ADC_DATA10 = 69,
    DMA_TRIGGER_ADC_DATA11 = 70,
    DMA_TRIGGER_ADC_DATA12 = 71,
    DMA_TRIGGER_ADC_DATA13 = 72,
    DMA_TRIGGER_ADC_DATA14 = 73,
    DMA_TRIGGER_ADC_DATA15 = 74,
    DMA_TRIGGER_ADC_DATA16 = 75,
    DMA_TRIGGER_ADC_DATA17 = 76,
    DMA_TRIGGER_ADC_DATA18 = 77,
    DMA_TRIGGER_ADC_DATA19 = 78,
    DMA_TRIGGER_ADC_DATA20 = 79,
    DMA_TRIGGER_ADC_DATA21 = 80,
    DMA_TRIGGER_ADC_DATA22 = 81,
    DMA_TRIGGER_ADC_DATA23 = 82,
    DMA_TRIGGER_ADC_DATA24 = 83,
    DMA_TRIGGER_ADC_DATA25 = 84,
    DMA_TRIGGER_ADC_DATA26 = 85,
    DMA_TRIGGER_ADC_DATA27 = 86,
    DMA_TRIGGER_ADC_DATA28 = 87,
    DMA_TRIGGER_ADC_DATA29 = 88,
    DMA_TRIGGER_ADC_DATA30 = 89,
    DMA_TRIGGER_ADC_DATA31 = 90,
    DMA_TRIGGER_ADC_DATA32 = 91,
    DMA_TRIGGER_ADC_DATA33 = 92,
    DMA_TRIGGER_ADC_DATA34 = 93,
    DMA_TRIGGER_ADC_DATA35 = 94,
    DMA_TRIGGER_ADC_DATA36 = 95,
    DMA_TRIGGER_ADC_DATA37 = 96,
    DMA_TRIGGER_ADC_DATA38 = 97,
    DMA_TRIGGER_ADC_DATA39 = 98,
    DMA_TRIGGER_ADC_DATA40 = 99,
    DMA_TRIGGER_ADC_DATA41 = 100,
    DMA_TRIGGER_ADC_DATA42 = 101,
    DMA_TRIGGER_ADC_DATA43 = 102,
    ...
    DMA_TRIGGER_CTMU = 195,
    DMA_TRIGGER_PREFETCH = 168,
    DMA_TRIGGER_SQI1 = 169,
    DMA_TRIGGER_SDHC = 191,
    DMA_TRIGGER_GLCD = 192,
    DMA_TRIGGER_GPU = 193,
    DMA_TRIGGER_ADC_EOS = 196,
    DMA_TRIGGER_ADC_ARDY = 197,
    DMA_TRIGGER_ADC_URDY = 198,
    DMA_TRIGGER_ADC0_EARLY = 199,
    DMA_TRIGGER_ADC1_EARLY = 200,
    DMA_TRIGGER_ADC2_EARLY = 201,
    DMA_TRIGGER_ADC3_EARLY = 202,
    DMA_TRIGGER_ADC4_EARLY = 203,
    DMA_TRIGGER_ADC_EARLY = 205,
    DMA_TRIGGER_ADC7_EARLY = 206,
    DMA_TRIGGER_ADC0_WARM = 207,
    DMA_TRIGGER_ADC1_WARM = 208,
    DMA_TRIGGER_ADC2_WARM = 209,
    DMA_TRIGGER_ADC3_WARM = 210,
    DMA_TRIGGER_ADC4_WARM = 211,
    DMA_TRIGGER_ADC7_WARM = 214
