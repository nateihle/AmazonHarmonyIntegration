...
#ifndef _DMA_P32MX775F512L_H
#define _DMA_P32MX775F512L_H
...
typedef enum {
    ...
    DMA_CHANNEL_4_INT_SOURCE = 52,
    DMA_CHANNEL_5_INT_SOURCE = 53,
    DMA_CHANNEL_6_INT_SOURCE = 54,
    DMA_CHANNEL_7_INT_SOURCE = 55
...
typedef enum {
    ...
    DMA_TRIGGER_INPUT_CAPTURE_1_ERROR = 61,
    DMA_TRIGGER_INPUT_CAPTURE_2_ERROR = 62,
    DMA_TRIGGER_INPUT_CAPTURE_3_ERROR = 63,
    DMA_TRIGGER_INPUT_CAPTURE_4_ERROR = 64,
    DMA_TRIGGER_INPUT_CAPTURE_5_ERROR = 65,
    ...
    DMA_TRIGGER_SPI_1_RECEIVE = 24,
    DMA_TRIGGER_SPI_1_TRANSMIT = 25,
    DMA_TRIGGER_SPI_1A_ERROR = 26,
    DMA_TRIGGER_SPI_1A_RECEIVE = 27,
    DMA_TRIGGER_SPI_1A_TRANSMIT = 28,
    DMA_TRIGGER_SPI_2_ERROR = 37,
    DMA_TRIGGER_SPI_2_RECEIVE = 38,
    DMA_TRIGGER_SPI_2_TRANSMIT = 39,
    DMA_TRIGGER_SPI_2A_ERROR = 37,
    DMA_TRIGGER_SPI_2A_RECEIVE = 38,
    DMA_TRIGGER_SPI_2A_TRANSMIT = 39,
    DMA_TRIGGER_SPI_3_ERROR = 26,
    DMA_TRIGGER_SPI_3_RECEIVE = 27,
    DMA_TRIGGER_SPI_3_TRANSMIT = 28,
    DMA_TRIGGER_SPI_3A_ERROR = 40,
    DMA_TRIGGER_SPI_3A_RECEIVE = 41,
    DMA_TRIGGER_SPI_3A_TRANSMIT = 42,
    DMA_TRIGGER_SPI_4_ERROR = 40,
    DMA_TRIGGER_SPI_4_RECEIVE = 41,
    DMA_TRIGGER_SPI_4_TRANSMIT = 42,
    DMA_TRIGGER_I2C_1_ERROR = 29,
    DMA_TRIGGER_I2C_1_SLAVE = 30,
    DMA_TRIGGER_I2C_1_MASTER = 31,
    DMA_TRIGGER_I2C_1A_ERROR = 26,
    DMA_TRIGGER_I2C_1A_SLAVE = 27,
    DMA_TRIGGER_I2C_1A_MASTER = 28,
    DMA_TRIGGER_I2C_2_ERROR = 43,
    DMA_TRIGGER_I2C_2_SLAVE = 44,
    DMA_TRIGGER_I2C_2_MASTER = 45,
    DMA_TRIGGER_I2C_2A_ERROR = 37,
    DMA_TRIGGER_I2C_2A_SLAVE = 38,
    DMA_TRIGGER_I2C_2A_MASTER = 39,
    DMA_TRIGGER_I2C_3_ERROR = 26,
    DMA_TRIGGER_I2C_3_SLAVE = 27,
    DMA_TRIGGER_I2C_3_MASTER = 28,
    DMA_TRIGGER_I2C_3A_ERROR = 40,
    DMA_TRIGGER_I2C_3A_SLAVE = 41,
    DMA_TRIGGER_I2C_3A_MASTER = 42,
    DMA_TRIGGER_I2C_4_ERROR = 37,
    DMA_TRIGGER_I2C_4_SLAVE = 38,
    DMA_TRIGGER_I2C_4_MASTER = 39,
    DMA_TRIGGER_I2C_5_ERROR = 40,
    DMA_TRIGGER_I2C_5_SLAVE = 41,
    DMA_TRIGGER_I2C_5_MASTER = 42,
    DMA_TRIGGER_USART_1_ERROR = 26,
    DMA_TRIGGER_USART_1_RECEIVE = 27,
    DMA_TRIGGER_USART_1_TRANSMIT = 28,
    DMA_TRIGGER_USART_1A_ERROR = 26,
    DMA_TRIGGER_USART_1A_RECEIVE = 27,
    DMA_TRIGGER_USART_1A_TRANSMIT = 28,
    DMA_TRIGGER_USART_1B_ERROR = 67,
    DMA_TRIGGER_USART_1B_RECEIVE = 68,
    DMA_TRIGGER_USART_1B_TRANSMIT = 69,
    DMA_TRIGGER_USART_2_ERROR = 40,
    DMA_TRIGGER_USART_2_RECEIVE = 41,
    DMA_TRIGGER_USART_2_TRANSMIT = 42,
    DMA_TRIGGER_USART_2A_ERROR = 37,
    DMA_TRIGGER_USART_2A_RECEIVE = 38,
    DMA_TRIGGER_USART_2A_TRANSMIT = 39,
    DMA_TRIGGER_USART_2B_ERROR = 70,
    DMA_TRIGGER_USART_2B_RECEIVE = 71,
    DMA_TRIGGER_USART_2B_TRANSMIT = 72,
    DMA_TRIGGER_USART_3_ERROR = 37,
    DMA_TRIGGER_USART_3_RECEIVE = 38,
    DMA_TRIGGER_USART_3_TRANSMIT = 39,
    DMA_TRIGGER_USART_3A_ERROR = 40,
    DMA_TRIGGER_USART_3A_RECEIVE = 41,
    DMA_TRIGGER_USART_3A_TRANSMIT = 42,
    DMA_TRIGGER_USART_3B_ERROR = 73,
    DMA_TRIGGER_USART_3B_RECEIVE = 74,
    DMA_TRIGGER_USART_3B_TRANSMIT = 75,
    DMA_TRIGGER_USART_4_ERROR = 67,
    DMA_TRIGGER_USART_4_RECEIVE = 68,
    DMA_TRIGGER_USART_4_TRANSMIT = 69,
    DMA_TRIGGER_USART_5_ERROR = 73,
    DMA_TRIGGER_USART_5_RECEIVE = 74,
    DMA_TRIGGER_USART_5_TRANSMIT = 75,
    DMA_TRIGGER_USART_6_ERROR = 70,
    DMA_TRIGGER_USART_6_RECEIVE = 71,
    DMA_TRIGGER_USART_6_TRANSMIT = 72,
    DMA_TRIGGER_CHANGE_NOTICE = 32,
    DMA_TRIGGER_DMA_0 = 48,
    DMA_TRIGGER_DMA_1 = 49,
    DMA_TRIGGER_DMA_2 = 50,
    DMA_TRIGGER_DMA_3 = 51,
    DMA_TRIGGER_DMA_4 = 52,
    DMA_TRIGGER_DMA_5 = 53,
    DMA_TRIGGER_DMA_6 = 54,
    DMA_TRIGGER_DMA_7 = 55,
    DMA_TRIGGER_COMPARATOR_1 = 35,
    DMA_TRIGGER_COMPARATOR_2 = 36,
    DMA_TRIGGER_ADC_1 = 33,
    DMA_TRIGGER_PARALLEL_PORT = 34,
    DMA_TRIGGER_CAN_1 = 58,
    DMA_TRIGGER_CAN_2 = 59,
    DMA_TRIGGER_CLOCK_MONITOR = 46,
    DMA_TRIGGER_RTCC = 47,
    DMA_TRIGGER_FLASH_CONTROL = 56,
    DMA_TRIGGER_USB_1 = 57,
    DMA_TRIGGER_ETH_1 = 60,
    DMA_TRIGGER_PARALLEL_PORT_ERROR = 66
