...
#ifndef _DMA_P32WK2057GPB132_H
#define _DMA_P32WK2057GPB132_H
...
typedef enum {
    ...
    DMA_CHANNEL_0_INT_SOURCE = 68,
    DMA_CHANNEL_1_INT_SOURCE = 69,
    DMA_CHANNEL_2_INT_SOURCE = 70,
    DMA_CHANNEL_3_INT_SOURCE = 71,
    DMA_CHANNEL_4_INT_SOURCE = 72,
    DMA_CHANNEL_5_INT_SOURCE = 73,
    DMA_CHANNEL_6_INT_SOURCE = 74,
    DMA_CHANNEL_7_INT_SOURCE = 75
...
typedef enum {
    ...
    DMA_TRIGGER_SPI_0_ERROR = 25,
    DMA_TRIGGER_SPI_0_RECEIVE = 26,
    DMA_TRIGGER_SPI_0_TRANSMIT = 27,
    ...
    DMA_TRIGGER_CHANGE_NOTICE_K = 47,
    DMA_TRIGGER_DMA_0 = 68,
    DMA_TRIGGER_DMA_1 = 69,
    DMA_TRIGGER_DMA_2 = 70,
    DMA_TRIGGER_DMA_3 = 71,
    DMA_TRIGGER_DMA_4 = 72,
    DMA_TRIGGER_DMA_5 = 73,
    DMA_TRIGGER_DMA_6 = 74,
    DMA_TRIGGER_DMA_7 = 75,
    DMA_TRIGGER_ADC_1 = 92,
    DMA_TRIGGER_ADC1_DC1 = 94,
    DMA_TRIGGER_ADC1_DC2 = 95,
    DMA_TRIGGER_ADC1_DF1 = 96,
    DMA_TRIGGER_ADC1_DF2 = 97,
    DMA_TRIGGER_ADC1_FAULT = 100,
    DMA_TRIGGER_ADC1_EOS = 101,
    DMA_TRIGGER_ADC1_RDY = 102,
    DMA_TRIGGER_ADC1_RS = 103,
    DMA_TRIGGER_ADC1_FC = 104,
    DMA_TRIGGER_ADC1_DATA0 = 106,
    DMA_TRIGGER_ADC1_DATA1 = 107,
    DMA_TRIGGER_ADC1_DATA2 = 108,
    DMA_TRIGGER_ADC1_DATA3 = 109,
    DMA_TRIGGER_ADC1_DATA4 = 110,
    DMA_TRIGGER_ADC1_DATA5 = 111,
    DMA_TRIGGER_ADC1_DATA6 = 112,
    DMA_TRIGGER_ADC1_DATA7 = 113,
    DMA_TRIGGER_ADC1_DATA8 = 114,
    DMA_TRIGGER_ADC1_DATA9 = 115,
    DMA_TRIGGER_ADC1_DATA10 = 116,
    DMA_TRIGGER_ADC1_DATA11 = 117,
    DMA_TRIGGER_ADC1_DATA12 = 118,
    DMA_TRIGGER_ADC1_DATA13 = 119,
    DMA_TRIGGER_ADC1_DATA14 = 120,
    DMA_TRIGGER_ADC1_DATA15 = 121,
    DMA_TRIGGER_ADC1_DATA16 = 122,
    DMA_TRIGGER_ADC1_DATA17 = 123,
    DMA_TRIGGER_ADC1_DATA18 = 124,
    DMA_TRIGGER_ADC1_DATA19 = 125,
    DMA_TRIGGER_CAN_1 = 142,
    DMA_TRIGGER_RTCC = 32,
    DMA_TRIGGER_USB_1 = 34,
    DMA_TRIGGER_SQI1 = 150,
    DMA_TRIGGER_PTG0_STEP = 152,
    DMA_TRIGGER_PTG0_WDT = 153,
    DMA_TRIGGER_PTG0_TRG0 = 154,
    DMA_TRIGGER_PTG0_TRG1 = 155,
    DMA_TRIGGER_PTG0_TRG2 = 156,
    DMA_TRIGGER_PTG0_TRG3 = 157,
    DMA_TRIGGER_MPUPC = 162,
    DMA_TRIGGER_FDC = 163,
    DMA_TRIGGER_CTR1_EVENT = 28,
    DMA_TRIGGER_CTR1_TRG = 29,
    DMA_TRIGGER_OTP_DONE = 30,
    DMA_TRIGGER_OTP_FAULT = 31,
    DMA_TRIGGER_RFMAC = 84,
    DMA_TRIGGER_RFSNIF = 85,
    DMA_TRIGGER_RFTM0 = 86,
    DMA_TRIGGER_RFTM1 = 87,
    DMA_TRIGGER_RFTM2 = 88,
    DMA_TRIGGER_RFTM3 = 89,
    DMA_TRIGGER_RFARB = 90,
    DMA_TRIGGER_RFWCOE = 91
