...
#ifndef _ADC_P32MX230F128H_H
#define _ADC_P32MX230F128H_H
...
typedef enum {
    ...
    ADC_INPUT_POSITIVE_CTMU = 0x1D,
    ADC_INPUT_POSITIVE_IVREF = 0x1C,
    ADC_INPUT_POSITIVE_OPEN = 0x1E
...
typedef enum {
    ...
    ADC_INPUT_SCAN_CTMU = 0x20000000,
