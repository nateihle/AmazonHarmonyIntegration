...
#ifndef _ADC_P32MX150F256L_H
#define _ADC_P32MX150F256L_H
...
typedef enum {
    ...
    ADC_INPUT_POSITIVE_AN16 = 0x10,
    ADC_INPUT_POSITIVE_AN17 = 0x11,
    ADC_INPUT_POSITIVE_AN18 = 0x12,
    ADC_INPUT_POSITIVE_AN19 = 0x13,
    ADC_INPUT_POSITIVE_AN20 = 0x14,
    ADC_INPUT_POSITIVE_AN21 = 0x15,
    ADC_INPUT_POSITIVE_AN22 = 0x16,
    ADC_INPUT_POSITIVE_AN23 = 0x17,
    ADC_INPUT_POSITIVE_AN24 = 0x18,
    ADC_INPUT_POSITIVE_AN25 = 0x19,
    ADC_INPUT_POSITIVE_AN26 = 0x1A,
    ADC_INPUT_POSITIVE_AN27 = 0x1B,
    ADC_INPUT_POSITIVE_AN28 = 0x1C,
    ADC_INPUT_POSITIVE_AN29 = 0x1D,
    ADC_INPUT_POSITIVE_AN30 = 0x1E,
    ADC_INPUT_POSITIVE_AN31 = 0x1F,
    ADC_INPUT_POSITIVE_AN32 = 0x20,
    ADC_INPUT_POSITIVE_AN33 = 0x21,
    ADC_INPUT_POSITIVE_AN34 = 0x22,
    ADC_INPUT_POSITIVE_AN35 = 0x23,
    ADC_INPUT_POSITIVE_AN36 = 0x24,
    ADC_INPUT_POSITIVE_AN37 = 0x25,
    ADC_INPUT_POSITIVE_AN38 = 0x26,
    ADC_INPUT_POSITIVE_AN39 = 0x27,
    ADC_INPUT_POSITIVE_AN40 = 0x28,
    ADC_INPUT_POSITIVE_AN41 = 0x29,
    ADC_INPUT_POSITIVE_AN42 = 0x2A,
    ADC_INPUT_POSITIVE_AN43 = 0x2B,
    ADC_INPUT_POSITIVE_AN44 = 0x2C,
    ADC_INPUT_POSITIVE_AN45 = 0x2D,
    ADC_INPUT_POSITIVE_AN46 = 0x2E,
    ADC_INPUT_POSITIVE_AN47 = 0x2F,
    ADC_INPUT_POSITIVE_CTMU = 0x31,
    ADC_INPUT_POSITIVE_IVREF = 0x30,
    ADC_INPUT_POSITIVE_OPEN = 0x32
...
typedef enum {
    ...
    ADC_INPUT_SCAN_AN17 = 0x00020000,
    ADC_INPUT_SCAN_AN18 = 0x00040000,
    ADC_INPUT_SCAN_AN19 = 0x00080000,
    ADC_INPUT_SCAN_AN20 = 0x00100000,
    ADC_INPUT_SCAN_AN21 = 0x00200000,
    ADC_INPUT_SCAN_AN22 = 0x00400000,
    ADC_INPUT_SCAN_AN23 = 0x00800000,
    ADC_INPUT_SCAN_AN24 = 0x01000000,
    ADC_INPUT_SCAN_AN25 = 0x02000000,
    ADC_INPUT_SCAN_AN26 = 0x04000000,
    ADC_INPUT_SCAN_AN27 = 0x08000000,
...
typedef enum {
    ...
    ADC_INPUT_SCAN_AN32 = 0x0001,
    ADC_INPUT_SCAN_AN33 = 0x0002,
    ADC_INPUT_SCAN_AN34 = 0x0004,
    ADC_INPUT_SCAN_AN35 = 0x0008,
    ADC_INPUT_SCAN_AN36 = 0x0010,
    ADC_INPUT_SCAN_AN37 = 0x0020,
    ADC_INPUT_SCAN_AN38 = 0x0040,
    ADC_INPUT_SCAN_AN39 = 0x0080,
    ADC_INPUT_SCAN_AN40 = 0x0100,
    ADC_INPUT_SCAN_AN41 = 0x0200,
    ADC_INPUT_SCAN_AN42 = 0x0400,
    ADC_INPUT_SCAN_AN43 = 0x0800,
    ADC_INPUT_SCAN_AN44 = 0x1000,
    ADC_INPUT_SCAN_AN45 = 0x2000,
    ADC_INPUT_SCAN_AN46 = 0x4000,
    ADC_INPUT_SCAN_AN47 = 0x8000,
    ADC_INPUT_SCAN_IVREF = 0x00010000,
    ADC_INPUT_SCAN_CTMU = 0x00020000,
    ADC_INPUT_SCAN_VSS = 0x00040000
...
#include "../templates/adc_MuxInputScanSelectExtended_Default.h"
...
PLIB_INLINE_API void PLIB_ADC_InputScanMaskAddExtended(ADC_MODULE_ID index, ADC_INPUTS_SCAN_EXTENDED scanInputs)
{
     ADC_InputScanMaskAddExtended_Default(index, scanInputs);
}

PLIB_INLINE_API void PLIB_ADC_InputScanMaskRemoveExtended(ADC_MODULE_ID index, ADC_INPUTS_SCAN_EXTENDED scanInputs)
{
     ADC_InputScanMaskRemoveExtended_Default(index, scanInputs);
}

PLIB_INLINE_API bool PLIB_ADC_ExistsMuxInputScanSelectExtended(ADC_MODULE_ID index)
{
     return ADC_ExistsMuxInputScanSelectExtended_Default(index);
}
