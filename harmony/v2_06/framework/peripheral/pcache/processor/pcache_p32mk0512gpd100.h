...
#ifndef _PCACHE_P32MK0512GPD100_H
#define _PCACHE_P32MK0512GPD100_H
...
typedef enum {
    ...
    PLIB_PCACHE_PREFETCH_ENABLE_ALL = 0x01
...
typedef enum {
    ...
    PLIB_PCACHE_PERIPHERAL_CACHE = 0x04,
    PLIB_PCACHE_DATA_CACHE = 0x02,
    PLIB_PCACHE_INSTRUCTION_CACHE = 0x01
...
#include "../templates/pcache_PFMAddressWaitStateEnable_Default.h"
#include "../templates/pcache_CachePerformanceCountersEnable_Default.h"
#include "../templates/pcache_PrefetchEnable_Default.h"
#include "../templates/pcache_DataCacheEnable_Unsupported.h"
#include "../templates/pcache_CacheEnable_Default.h"
...
#include "../templates/pcache_InvalidateCache_Default.h"
...
{
     return PCACHE_ExistsPFMAddressWaitStateEnable_Default(index);
}

PLIB_INLINE_API void PLIB_PCACHE_PFMAddressWaitStateEnable(PCACHE_MODULE_ID index)
{
     PCACHE_PFMAddressWaitStateEnable_Default(index);
}

PLIB_INLINE_API void PLIB_PCACHE_PFMAddressWaitStateDisable(PCACHE_MODULE_ID index)
{
     PCACHE_PFMAddressWaitStateDisable_Default(index);
}

PLIB_INLINE_API bool PLIB_PCACHE_PFMAddressWaitStateIsEnabled(PCACHE_MODULE_ID index)
{
     return PCACHE_PFMAddressWaitStateIsEnabled_Default(index);
}

PLIB_INLINE_API bool PLIB_PCACHE_ExistsCachePerformanceCountersEnable(PCACHE_MODULE_ID index)
{
     return PCACHE_ExistsCachePerformanceCountersEnable_Default(index);
}

PLIB_INLINE_API void PLIB_PCACHE_CachePerformanceCountersEnable(PCACHE_MODULE_ID index)
{
     PCACHE_CachePerformanceCountersEnable_Default(index);
}

PLIB_INLINE_API void PLIB_PCACHE_CachePerformanceCountersDisable(PCACHE_MODULE_ID index)
{
     PCACHE_CachePerformanceCountersDisable_Default(index);
}

PLIB_INLINE_API bool PLIB_PCACHE_CachePerformanceCountersIsEnabled(PCACHE_MODULE_ID index)
{
     return PCACHE_CachePerformanceCountersIsEnabled_Default(index);
}
...
{
     return PCACHE_ExistsCacheEnable_Default(index);
}

PLIB_INLINE_API void PLIB_PCACHE_CacheEnable(PCACHE_MODULE_ID index, PCACHE_CACHE_TYPE cache_type)
{
     PCACHE_CacheEnable_Default(index, cache_type);
}

PLIB_INLINE_API void PLIB_PCACHE_CacheDisable(PCACHE_MODULE_ID index, PCACHE_CACHE_TYPE cache_type)
{
     PCACHE_CacheDisable_Default(index, cache_type);
}

PLIB_INLINE_API bool PLIB_PCACHE_CacheIsEnabled(PCACHE_MODULE_ID index, PCACHE_CACHE_TYPE cache_type)
{
     return PCACHE_CacheIsEnabled_Default(index, cache_type);
}
...
{
     return PCACHE_ExistsInvalidateCache_Default(index);
}

PLIB_INLINE_API void PLIB_PCACHE_ForceInvalidateCacheEnable(PCACHE_MODULE_ID index, PCACHE_CACHE_TYPE cache_type)
{
     PCACHE_ForceInvalidateCacheEnable_Default(index, cache_type);
}

PLIB_INLINE_API bool PLIB_PCACHE_ForceInvalidateCacheIsEnabled(PCACHE_MODULE_ID index, PCACHE_CACHE_TYPE cache_type)
{
     return PCACHE_ForceInvalidateCacheIsEnabled_Default(index, cache_type);
}

PLIB_INLINE_API void PLIB_PCACHE_AutoInvalidateCacheEnable(PCACHE_MODULE_ID index, PCACHE_CACHE_TYPE cache_type)
{
     PCACHE_AutoInvalidateCacheEnable_Default(index, cache_type);
}

PLIB_INLINE_API void PLIB_PCACHE_AutoInvalidateCacheDisable(PCACHE_MODULE_ID index, PCACHE_CACHE_TYPE cache_type)
{
     PCACHE_AutoInvalidateCacheDisable_Default(index, cache_type);
}

PLIB_INLINE_API bool PLIB_PCACHE_AutoInvalidateCacheIsEnabled(PCACHE_MODULE_ID index, PCACHE_CACHE_TYPE cache_type)
{
     return PCACHE_AutoInvalidateCacheIsEnabled_Default(index, cache_type);
}
