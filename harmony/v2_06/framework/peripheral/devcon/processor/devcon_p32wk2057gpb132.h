...
#ifndef _DEVCON_P32WK2057GPB132_H
#define _DEVCON_P32WK2057GPB132_H
...
#include "../templates/devcon_AlternateClock_PIC32WK.h"
#include "../templates/devcon_DeviceRegsLockUnlock_PIC32WK.h"
#include "../templates/devcon_OTPConfigLockUnlock_PIC32WK.h"
#include "../templates/devcon_USB_PHY_SleepModeSet_PIC32WK.h"
#include "../templates/devcon_ECCModes_Unsupported.h"
#include "../templates/devcon_JTAGEnable_PIC32WK.h"
#include "../templates/devcon_AnalogChargePumpControl_Unsupported.h"
#include "../templates/devcon_TraceOutput_PIC32WK.h"
#include "../templates/devcon_JTAGUsesTDO_PIC32WK.h"
...
#include "../templates/devcon_HSUARTControl_WK.h"
#include "../templates/devcon_BootSelection_WK.h"
...
PLIB_INLINE_API void PLIB_DEVCON_HSUARTEnable(DEVCON_MODULE_ID index)
{
     DEVCON_HSUARTEnable_WK(index);
}

PLIB_INLINE_API void PLIB_DEVCON_HSUARTDisable(DEVCON_MODULE_ID index)
{
     DEVCON_HSUARTDisable_WK(index);
}

PLIB_INLINE_API bool PLIB_DEVCON_ExistsHSUARTControl(DEVCON_MODULE_ID index)
{
     return DEVCON_ExistsHSUARTControl_WK(index);
}

PLIB_INLINE_API void PLIB_DEVCON_BootIPFSelect(DEVCON_MODULE_ID index)
{
     DEVCON_BootIPFSelect_WK(index);
}

PLIB_INLINE_API void PLIB_DEVCON_BootExtSelect(DEVCON_MODULE_ID index)
{
     DEVCON_BootExtSelect_WK(index);
}

PLIB_INLINE_API bool PLIB_DEVCON_ExistsBootSelection(DEVCON_MODULE_ID index)
{
     return DEVCON_ExistsBootSelection_WK(index);
}
