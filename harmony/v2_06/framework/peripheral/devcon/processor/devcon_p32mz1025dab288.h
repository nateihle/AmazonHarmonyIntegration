...
#ifndef _DEVCON_P32MZ1025DAB288_H
#define _DEVCON_P32MZ1025DAB288_H
...
#include "../templates/devcon_MPLL_Default.h"
...
PLIB_INLINE_API bool PLIB_DEVCON_MPLLIsReady(DEVCON_MODULE_ID index)
{
     return DEVCON_MPLLIsReady_Default(index);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLEnable(DEVCON_MODULE_ID index)
{
     DEVCON_MPLLEnable_Default(index);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLDisable(DEVCON_MODULE_ID index)
{
     DEVCON_MPLLDisable_Default(index);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLODiv1Set(DEVCON_MODULE_ID index, DEVCON_MPLL_OUTPUT_DIVIDER bits)
{
     DEVCON_MPLLODiv1Set_Default(index, bits);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLODiv2Set(DEVCON_MODULE_ID index, DEVCON_MPLL_OUTPUT_DIVIDER bits)
{
     DEVCON_MPLLODiv2Set_Default(index, bits);
}

PLIB_INLINE_API bool PLIB_DEVCON_MPLLVregIsReady(DEVCON_MODULE_ID index)
{
     return DEVCON_MPLLVregIsReady_Default(index);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLVregEnable(DEVCON_MODULE_ID index)
{
     DEVCON_MPLLVregEnable_Default(index);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLVregDisable(DEVCON_MODULE_ID index)
{
     DEVCON_MPLLVregDisable_Default(index);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLMultiplierSet(DEVCON_MODULE_ID index, uint8_t value)
{
     DEVCON_MPLLMultiplierSet_Default(index, value);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLVrefSet(DEVCON_MODULE_ID index, DEVCON_MPLL_VREF_CONTROL vref)
{
     DEVCON_MPLLVrefSet_Default(index, vref);
}

PLIB_INLINE_API void PLIB_DEVCON_MPLLInputDivSet(DEVCON_MODULE_ID index, uint8_t value)
{
     DEVCON_MPLLInputDivSet_Default(index, value);
}

PLIB_INLINE_API bool PLIB_DEVCON_ExistsMPLL(DEVCON_MODULE_ID index)
{
     return DEVCON_ExistsMPLL_Default(index);
}
