...
#ifndef _RTCC_P32MX274F256B_H
#define _RTCC_P32MX274F256B_H
...
typedef enum {
    ...
    RTCC_OUTPUT_RTCC_CLOCK = 0x02

} RTCC_OUTPUT_SELECT;

typedef enum {

    RTCC_CLOCK_SOURCE_LPRC = 0x00,
    RTCC_CLOCK_SOURCE_SOSC = 0x01
...
#include "../templates/rtcc_OutputSelect_pic32mx_xlp.h"
#include "../templates/rtcc_ClockSelect_Default.h"
...
{
     RTCC_OutputSelect_pic32mx_xlp(index, data);
}

PLIB_INLINE_API bool PLIB_RTCC_ExistsOutputSelect(RTCC_MODULE_ID index)
{
     return RTCC_ExistsOutputSelect_pic32mx_xlp(index);
}

PLIB_INLINE_API void PLIB_RTCC_ClockSourceSelect(RTCC_MODULE_ID index, RTCC_CLOCK_SOURCE_SELECT source)
{
     RTCC_ClockSourceSelect_Default(index, source);
}

PLIB_INLINE_API bool PLIB_RTCC_ExistsClockSelect(RTCC_MODULE_ID index)
{
     return RTCC_ExistsClockSelect_Default(index);
}
