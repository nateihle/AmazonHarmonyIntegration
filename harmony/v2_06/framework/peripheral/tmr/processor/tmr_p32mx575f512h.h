...
#ifndef _TMR_P32MX575F512H_H
#define _TMR_P32MX575F512H_H
...
#include "../templates/tmr_ClockSource_Default_1.h"
...
{
     TMR_ClockSourceSelect_Default_1(index, source);
}

PLIB_INLINE_API bool PLIB_TMR_ExistsClockSource(TMR_MODULE_ID index)
{
     return TMR_ExistsClockSource_Default_1(index);
}
