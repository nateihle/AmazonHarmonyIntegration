...
#ifndef _USART_P32WK2057GPD132_H
#define _USART_P32WK2057GPD132_H
...
typedef enum {
    ...
    USART_BRG_CLOCK_SOURCE_PBCLK2_OFF_IN_SLEEP = 0x00,
    USART_BRG_CLOCK_SOURCE_SYSCLK_OFF_IN_SLEEP = 0x01,
    USART_BRG_CLOCK_SOURCE_FRC = 0x02,
    USART_BRG_CLOCK_SOURCE_PBCLK2 = 0x03
...
#include "../templates/usart_RunInOverflow_Default.h"
#include "../templates/usart_BRGClockSourceSelect_Default.h"
#include "../templates/usart_UsartModuleStatus_Default.h"
#include "../templates/usart_RunInSleepMode_Default.h"
...
#include "../templates/usart_ReceiverAddressAutoDetect_Unsupported.h"
#include "../templates/usart_ReceiverAddressDetect_Default.h"
#include "../templates/usart_ReceiverAddress_Default.h"
#include "../templates/usart_ReceiverAddressMask_Default.h"
...
{
     return USART_ExistsRunInOverflow_Default(index);
}

PLIB_INLINE_API void PLIB_USART_RunInOverflowEnable(USART_MODULE_ID index)
{
     USART_RunInOverflowEnable_Default(index);
}

PLIB_INLINE_API void PLIB_USART_RunInOverflowDisable(USART_MODULE_ID index)
{
     USART_RunInOverflowDisable_Default(index);
}

PLIB_INLINE_API bool PLIB_USART_RunInOverflowIsEnabled(USART_MODULE_ID index)
{
     return USART_RunInOverflowIsEnabled_Default(index);
}

PLIB_INLINE_API bool PLIB_USART_ExistsBRGClockSourceSelect(USART_MODULE_ID index)
{
     return USART_ExistsBRGClockSourceSelect_Default(index);
}

PLIB_INLINE_API void PLIB_USART_BRGClockSourceSelect(USART_MODULE_ID index, USART_BRG_CLOCK_SOURCE brgClockSource)
{
     USART_BRGClockSourceSelect_Default(index, brgClockSource);
}

PLIB_INLINE_API USART_BRG_CLOCK_SOURCE PLIB_USART_BRGClockSourceGet(USART_MODULE_ID index)
{
     return USART_BRGClockSourceGet_Default(index);
}

PLIB_INLINE_API bool PLIB_USART_ExistsModuleBusyStatus(USART_MODULE_ID index)
{
     return USART_ExistsModuleBusyStatus_Default(index);
}

PLIB_INLINE_API bool PLIB_USART_ModuleIsBusy(USART_MODULE_ID index)
{
     return USART_ModuleIsBusy_Default(index);
}

PLIB_INLINE_API bool PLIB_USART_ExistsRunInSleepMode(USART_MODULE_ID index)
{
     return USART_ExistsRunInSleepMode_Default(index);
}

PLIB_INLINE_API void PLIB_USART_RunInSleepModeEnable(USART_MODULE_ID index)
{
     USART_RunInSleepModeEnable_Default(index);
}

PLIB_INLINE_API void PLIB_USART_RunInSleepModeDisable(USART_MODULE_ID index)
{
     USART_RunInSleepModeDisable_Default(index);
}

PLIB_INLINE_API bool PLIB_USART_RunInSleepModeIsEnabled(USART_MODULE_ID index)
{
     return USART_RunInSleepModeIsEnabled_Default(index);
}
...
{
     return USART_ExistsReceiverAddressAutoDetect_Unsupported(index);
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_USART_ReceiverAddressAutoDetectEnable(USART_MODULE_ID index, int8_t Mask)
{
     USART_ReceiverAddressAutoDetectEnable_Unsupported(index, Mask);
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_USART_ReceiverAddressAutoDetectDisable(USART_MODULE_ID index)
{
     USART_ReceiverAddressAutoDetectDisable_Unsupported(index);
}
...
{
     return USART_ExistsReceiverAddressMask_Default(index);
}

PLIB_INLINE_API void PLIB_USART_AddressMaskSet(USART_MODULE_ID index, uint8_t mask)
{
     USART_AddressMaskSet_Default(index, mask);
}

PLIB_INLINE_API uint8_t PLIB_USART_AddressMaskGet(USART_MODULE_ID index)
{
     return USART_AddressMaskGet_Default(index);
}
