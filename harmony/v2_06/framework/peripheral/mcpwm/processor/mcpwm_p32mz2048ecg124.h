...
#ifndef _MCPWM_P32MZ2048ECG124_H
#define _MCPWM_P32MZ2048ECG124_H
...
PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_MCPWM_ChannelPrimaryTriggerCompareSet(MCPWM_MODULE_ID index, MCPWM_CHANNEL_ID channel, uint16_t trigger_compare_value)
{
     
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_MCPWM_ChannelSecondaryTriggerCompareSet(MCPWM_MODULE_ID index, MCPWM_CHANNEL_ID channel, uint16_t trigger_compare_value)
{
