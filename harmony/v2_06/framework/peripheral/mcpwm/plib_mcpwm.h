...
// *****************************************************************************
/* Function:
    void PLIB_MCPWM_ChannelPrimaryTriggerCompareSet( MCPWM_MODULE_ID index, MCPWM_CHANNEL_ID channel,
                                          uint16_t trigger_compare_value)

  Summary:
    Sets the Primary Trigger Compare Value for MCPWM Channel specified

  Description:
    This function sets the Primary Trigger Compare Value of the MCPWM Channel ID passed using function parameters.
  ...
  Parameters:
    index                   - Identifier for the device instance to be configured
    channel					- MCPWM Channel ID for which the primary trigger compare value is to be set.
	trigger_compare_value   - Primary Trigger Compare value (in MCPWM timer counts)
  ...
  Example:
    ...
    // Where MY_MCPWM_INSTANCE, is the MCPWM instance selected for use by the
    // application developer.
	// MY_MCPWM_CHANNEL, is the MCPWM Channel for which the primary trigger compare needs to be set.
    // 100 is the Primary Trigger Compare Value (in MCPWM timer counts)
   
    PLIB_MCPWM_ChannelPrimaryTriggerCompareSet( MY_MCPWM_INSTANCE, MY_MCPWM_CHANNEL,100);
    </code>
...
void PLIB_MCPWM_ChannelPrimaryTriggerCompareSet( MCPWM_MODULE_ID index, MCPWM_CHANNEL_ID channel, uint16_t trigger_compare_value);

// *****************************************************************************
/* Function:
    void PLIB_MCPWM_ChannelSecondaryTriggerCompareSet( MCPWM_MODULE_ID index, MCPWM_CHANNEL_ID channel,
                                          uint16_t trigger_compare_value)

  Summary:
    Sets the Secondary Trigger Compare Value for MCPWM Channel specified

  Description:
    This function sets the Secondary Trigger Compare Value of the MCPWM Channel ID passed using function parameters.
  ...
  Parameters:
    index                   - Identifier for the device instance to be configured
    channel					- MCPWM Channel ID for which the primary trigger compare value is to be set.
	trigger_compare_value   - Secondary Trigger Compare value (in MCPWM timer counts)
  ...
  Example:
    ...
    // application developer.
	// MY_MCPWM_CHANNEL, is the MCPWM Channel for which the primary trigger compare needs to be set.
    // 100 is the Secondary Trigger Compare Value (in MCPWM timer counts)
   
    PLIB_MCPWM_ChannelSecondaryTriggerCompareSet( MY_MCPWM_INSTANCE, MY_MCPWM_CHANNEL,100);
    </code>
...
void PLIB_MCPWM_ChannelSecondaryTriggerCompareSet( MCPWM_MODULE_ID index, MCPWM_CHANNEL_ID channel, uint16_t trigger_compare_value);
