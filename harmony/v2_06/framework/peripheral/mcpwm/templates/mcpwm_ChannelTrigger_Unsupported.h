...
//******************************************************************************
/* Function :  MCPWM_ChannelPrimaryTriggerCompareSet_Unsupported

  Summary:
    Implements Unsupported variant of PLIB_MCPWM_ChannelPrimaryTriggerCompareSet 

  Description:
    This template implements the Unsupported variant of the PLIB_MCPWM_ChannelPrimaryTriggerCompareSet function.
*/

PLIB_TEMPLATE void MCPWM_ChannelPrimaryTriggerCompareSet_Unsupported( MCPWM_MODULE_ID index , MCPWM_CHANNEL_ID channel, uint16_t trigger_compare_value )
{
    PLIB_ASSERT(false, "The device selected does not implement PLIB_MCPWM_ChannelPrimaryTriggerCompareSet");
}

//******************************************************************************
/* Function :  MCPWM_ChannelSecondaryTriggerCompareSet_Unsupported

  Summary:
    Implements Unsupported variant of PLIB_MCPWM_ChannelSecondaryTriggerCompareSet 

  Description:
    This template implements the Unsupported variant of the PLIB_MCPWM_ChannelSecondaryTriggerCompareSet function.
*/

PLIB_TEMPLATE void MCPWM_ChannelSecondaryTriggerCompareSet_Unsupported( MCPWM_MODULE_ID index , MCPWM_CHANNEL_ID channel, uint16_t trigger_compare_value )
{
    PLIB_ASSERT(false, "The device selected does not implement PLIB_MCPWM_ChannelSecondaryTriggerCompareSet");
}
