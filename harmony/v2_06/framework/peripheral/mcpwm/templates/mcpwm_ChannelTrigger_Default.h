/*******************************************************************************
  ...
  Description:
    ...
    For following APIs :
        ...
        PLIB_MCPWM_ChannelPrimaryTriggerCompareSet
        PLIB_MCPWM_ChannelSecondaryTriggerCompareSet
...
//******************************************************************************
/* Function :  MCPWM_ChannelPrimaryTriggerCompareSet_Default

  Summary:
    Implements Default variant of MCPWM_ChannelPrimaryTriggerCompareSet 

  Description:
    This template implements the Default variant of the MCPWM_ChannelPrimaryTriggerCompareSet function.
*/

PLIB_TEMPLATE void MCPWM_ChannelPrimaryTriggerCompareSet_Default( MCPWM_MODULE_ID index , MCPWM_CHANNEL_ID channel, uint16_t trigger_compare_value )
{
    volatile mcpwm_channel_registers_t *channel_regs = (mcpwm_channel_registers_t *)channel;
    channel_regs->TRIGx = trigger_compare_value;
}

//******************************************************************************
/* Function :  MCPWM_ChannelSecondaryTriggerCompareSet_Default

  Summary:
    Implements Default variant of MCPWM_ChannelSecondaryTriggerCompareSet 

  Description:
    This template implements the Default variant of the MCPWM_ChannelSecondaryTriggerCompareSet function.
*/

PLIB_TEMPLATE void MCPWM_ChannelSecondaryTriggerCompareSet_Default( MCPWM_MODULE_ID index , MCPWM_CHANNEL_ID channel, uint16_t trigger_compare_value )
{
    volatile mcpwm_channel_registers_t *channel_regs = (mcpwm_channel_registers_t *)channel;
    channel_regs->STRIGx = trigger_compare_value;
}
//******************************************************************************
