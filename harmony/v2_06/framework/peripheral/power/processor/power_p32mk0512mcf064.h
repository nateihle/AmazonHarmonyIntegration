...
#ifndef _POWER_P32MK0512MCF064_H
#define _POWER_P32MK0512MCF064_H
...
typedef enum {
    ...
    POWER_MODULE_PWM1 = 0x70,
    POWER_MODULE_PWM2 = 0x71,
    POWER_MODULE_PWM3 = 0x72,
    POWER_MODULE_PWM4 = 0x73,
    POWER_MODULE_PWM5 = 0x74,
    POWER_MODULE_PWM6 = 0x75,
    POWER_MODULE_PWM7 = 0x76,
    POWER_MODULE_PWM8 = 0x77,
    POWER_MODULE_PWM9 = 0x78,
    POWER_MODULE_PWM10 = 0x79,
    POWER_MODULE_PWM11 = 0x7A,
    POWER_MODULE_PWM12 = 0x7B,
    ...
    POWER_MODULE_QEI5 = 0xB2,
    POWER_MODULE_QEI6 = 0xB3,
    POWER_MODULE_QEI1 = 0xB8,
    POWER_MODULE_QEI2 = 0xB9,
    POWER_MODULE_QEI3 = 0xBA,
    POWER_MODULE_QEI4 = 0xBB,
