...
#ifndef _EBI_P32MZ2025DAH169_H
#define _EBI_P32MZ2025DAH169_H
...
#include "../templates/ebi_ControlEnable_Unsupported.h"
...
PLIB_INLINE_API void PLIB_EBI_FlashResetPinSet(EBI_MODULE_ID index, bool FlashResetPin)
{
     EBI_FlashResetPinSet_Default(index, FlashResetPin);
}

PLIB_INLINE_API bool PLIB_EBI_FlashResetPinGet(EBI_MODULE_ID index)
{
...
PLIB_INLINE_API void PLIB_EBI_ByteSelectPinSet(EBI_MODULE_ID index, bool ByteSelect0, bool ByteSelect1)
{
