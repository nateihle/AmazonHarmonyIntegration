...
#ifndef _USB_P32MX440F256H_H
#define _USB_P32MX440F256H_H
...
#include "../templates/usb_ModuleBusy_Unsupported.h"
...
#include "../templates/usb_AutomaticSuspend_Unsupported.h"
...
{
     return USB_ModuleIsBusy_Unsupported(index);
}

PLIB_INLINE_API bool PLIB_USB_ExistsModuleBusy(USB_MODULE_ID index)
{
     return USB_ExistsModuleBusy_Unsupported(index);
}
