...
{
    .drvType          = TYPE_${CONFIG_BOOTLOADER_TYPE},
    <#if CONFIG_BOOTLOADER_TRIGGER_TYPE == "BUTTON">
    .drvTrigger       = BootloaderButtonTriggerCheck
    </#if>
    <#if CONFIG_BOOTLOADER_TRIGGER_TYPE == "MEMORY">
