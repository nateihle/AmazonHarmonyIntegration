...
static String VERSION_INFO = "  v2.0.1  ";
...
{
    VERSION_INFO  = VERSION_INFO + " <Friday, Mar 07, 2014>\n";
    VERSION_MESSAGE = VERSION_MESSAGE + VERSION_INFO + "Copyright (c) 2013 Microchip Technology Inc.\n";
