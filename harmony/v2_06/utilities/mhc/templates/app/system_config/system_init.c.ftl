...
<#if CONFIG_POSCAGCRNG?has_content>
#pragma config POSCAGCRNG =  ${CONFIG_POSCAGCRNG}
</#if>
...
// *****************************************************************************
// *****************************************************************************
<#if LIST_SYSTEM_INIT_C_SYSTEM_INITIALIZATION?has_content>
<@mhc_expand_list list=LIST_SYSTEM_INIT_C_SYSTEM_INITIALIZATION/>
</#if>
