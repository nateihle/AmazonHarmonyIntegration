...
<#if CONFIG_USE_HARMONY_EXCEPTION_HANDLER?has_content>
<#if CONFIG_USE_HARMONY_EXCEPTION_HANDLER == true>
...
<#if CONFIG_USE_SYS_DEBUG_PRINT == true || CONFIG_USE_SYS_CONSOLE_WRITE == true >
