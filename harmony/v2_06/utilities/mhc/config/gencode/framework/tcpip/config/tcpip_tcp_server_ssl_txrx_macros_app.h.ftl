...
typedef enum
{
    ...
    ${APP_NAME?upper_case}_TCPIP_OPENING_SERVER_SOCKET,
    ${APP_NAME?upper_case}_TCPIP_WAIT_FOR_CONNECTION,
    ${APP_NAME?upper_case}_TCPIP_NEGOTIATING_SSL,
    ${APP_NAME?upper_case}_TCPIP_SENDING_MSG,
    ${APP_NAME?upper_case}_TCPIP_WAIT_FOR_RESPONSE,
    ${APP_NAME?upper_case}_TCPIP_CLOSING_CONNECTION
