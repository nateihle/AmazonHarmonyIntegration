<#-- motor_control_ds_foc_pll_hv_int_opamp_macros_app.h.ftl -->
...
// *****************************************************************************
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_h_includes>
#include <math.h>
...
// *****************************************************************************
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_h_type_definitions>
...
// DC offset = 1.65V
// max current = x
// (x * 0.01 * 15) + 1.65V = 3.3V
// x = 11Amps
#define     MAX_BOARD_CURRENT                                   (float)(11)
...
#define     Q_CURRENT_REF_OPENLOOP           1.2
...
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_h_data>
...
*/
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_h_callback_function_declarations>
</#macro>
...
// *****************************************************************************
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_h_function_declarations>
/* MC Core Routines */
...
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_h_states>
</#macro>
