<#-- motor_control_ds_foc_pll_hv_int_opamp_macros_app.c.ftl -->
...
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_includes>
</#macro>
...
*/
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_global_data>
...
// *****************************************************************************
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_callback_functions>
</#macro>
...
// *****************************************************************************
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_local_functions>
...
{
	phaseCurrentA = PLIB_ADCHS_AnalogInputResultGet(DRV_ADC_ID_1 , ADCHS_AN3) ; // Phase Current A is connected to AN4 on ADC4
    phaseCurrentB = PLIB_ADCHS_AnalogInputResultGet(DRV_ADC_ID_1 , ADCHS_AN1);// Phase Current B is connected to AN8 on ADC1
...
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_initialize>
	${APP_NAME?lower_case}Data.mcState = ${APP_NAME?upper_case}_MC_STATE_INIT;
		/* Initialize DAC */
	${APP_NAME?upper_case}_DAC_Initialize();
</#macro>
...
{
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_tasks_data>
</#macro>
...
-->   
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_tasks_state_init>
			DRV_ADC0_Open();
			DRV_ADC1_Open();
			DRV_ADC2_Open();
</#macro>    
...
<#--        
            ...
            {
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_tasks_calls_after_init>
</#macro>
...
<#--            /* Advance to the next state */
        ...
        {
-->
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_tasks_state_service_tasks>
...
<#macro macro_motor_control_ds_foc_pll_hv_int_opamp_app_c_tasks_states>
</#macro>
