...
/*******************************************************************************
  ...
  Summary:      
    Board Support Package header for PIC32 Bluetooth Audio Development
    Kit BTADK (with default AK4384 DAC daughter board) plus the BM64 Bluetooth DB
    and PIC32MX270F512L PIM.

  Description:
    This file contains constants, macros, type definitions and function
    declarations required by the BTADK with AK4384 plus BM64 DB and PIC32MX270F512L PIM.
*******************************************************************************/
