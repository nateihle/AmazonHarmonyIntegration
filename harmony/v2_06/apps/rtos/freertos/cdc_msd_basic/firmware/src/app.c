...
/* This is the string that will written to the CDC device */
 ...
 /* This is the string that will written to the CDC device */
uint8_t prompt[10] ATTRIB_COHERENT __attribute__((aligned(16)))  = "\r\nData : ";


/* Application MSD Task Object */
APP_MSD_DATA appMSDData ATTRIB_COHERENT __attribute__((aligned(16))) ;;

/* Application CDC Task Object */
APP_CDC_DATA  appCDCData ATTRIB_COHERENT __attribute__((aligned(16))) ;
