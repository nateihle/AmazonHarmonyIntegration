...
//#include "user_config.h"  //For cdbt Bluetooth Stack
//#include "error.h"        //For cdbt Bluetooth Stack
...
#define SYS_LOG_MESSAGE_QUEUE_SIZE  700 //700

#define SYS_LOG_MESSAGE_CHAR_LENGTH (100)
