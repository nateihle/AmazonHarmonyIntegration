...
const uint8_t fullSpeedConfigurationDescriptor[]=
{
    ...
    0x00,0x77,0x01,                 // Sampling Frequency = 96000 Hz(tSamFreq)
    ...
    //KEEP THIS - 96Khz 24 bit 1ms Packet size
    0x40,0x02,                      // ?(wMaxPacketSize) //96 * 6 = 0x0240 
    //0x00,0x03,                      // ?(wMaxPacketSize) //96000Hz/1000ms * bSubFrameSize = 768
