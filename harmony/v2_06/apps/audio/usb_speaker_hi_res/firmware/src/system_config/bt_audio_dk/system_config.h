...
#define DRV_AK4384_AUDIO_SAMPLING_RATE                      96000
...
#define QUEUE_SIZE_TX_IDX0                      16
#define QUEUE_SIZE_RX_IDX0                      16
...
//
//      1ms Frame @ 96Khz sampling rate: 
//        4x2=8 bytes per 24bit stereo sample for bSubFrameSize 0x04 or
//           96*8 = 768 bytes per packet buffer
//        3x2=6 bytes per 24bit stereo sample for bSubFrameSize 0x03
//           96*6 = 576 bytes per packet buffer
//        
//==============================================================================
