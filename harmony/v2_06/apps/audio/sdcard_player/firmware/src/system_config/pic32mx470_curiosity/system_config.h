...
#define SYS_PORT_B_ANSEL        0xFEDC
...
#define SYS_PORT_D_ANSEL        0xF002
#define SYS_PORT_D_TRIS         0xFF6F
...
#define DRV_I2C_INT_PRIORITY_IDX0                 		INT_PRIORITY_LEVEL2
...
#define BSP_AK4642_PDNToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_7)
#define BSP_AK4642_PDNOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_7)
#define BSP_AK4642_PDNOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_7)
#define BSP_AK4642_PDNStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_7)
#define BSP_AK4642_PDNStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_7, Value)
