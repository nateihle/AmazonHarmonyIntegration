...
void __ISR(_I2C2_MASTER_VECTOR, ipl2AUTO) _IntHandlerDrvI2CMasterInstance0(void)
{
    DRV_I2C_Tasks(sysObj.drvI2C0);
}


void __ISR(_I2C2_BUS_VECTOR, ipl2AUTO) _IntHandlerDrvI2CErrorInstance0(void)
{
