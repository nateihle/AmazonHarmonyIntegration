...
const DRV_SDCARD_INIT drvSDCardInit =
{
    ...
    .chipSelectBitPosition = PORTS_BIT_POS_4,
};
// </editor-fold>
...
void SYS_Initialize ( void* data )
{
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_I2C2_MASTER, INT_PRIORITY_LEVEL2);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_I2C2_MASTER, INT_SUBPRIORITY_LEVEL0);
    SYS_INT_VectorPrioritySet(INT_VECTOR_I2C2_BUS, INT_PRIORITY_LEVEL2);
