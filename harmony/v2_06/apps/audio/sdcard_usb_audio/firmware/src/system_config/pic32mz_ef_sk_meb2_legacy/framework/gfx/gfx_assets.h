...
// string IDs
#define string_demo_title_str    0
#define string_group_box_str    1
#define string_sd_radio_button_str    2
#define string_usb_radio_button_str    3
#define string_volume_down_button_str    4
#define string_volume_up_button_str    5
