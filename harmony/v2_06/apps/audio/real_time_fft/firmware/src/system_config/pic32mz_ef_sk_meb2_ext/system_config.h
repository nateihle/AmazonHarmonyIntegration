...
#define DRV_I2C_BIT_BANG_TMR_MODULE_IDX0                TMR_ID_8
#define DRV_I2C_BIT_BANG_INT_SRC_IDX0                   INT_SOURCE_TIMER_8
...
#define DRV_I2C_BIT_BANG_BAUD_RATE_IDX1                 10000
...
#define APP_MICROPHONE_READ_QUEUE_SIZE              QUEUE_SIZE_RX_IDX0
#define APP_SPEAKER_WRITE_QUEUE_SIZE                QUEUE_SIZE_TX_IDX0
#define APP_CODEC_SAMPLING_RATE                     DRV_AK4953_AUDIO_SAMPLING_RATE
...
#define APP_DISPLAY_DEFAULT_VOLUME                  DRV_AK4953_VOLUME
// END OF CUSTOM CODE    
