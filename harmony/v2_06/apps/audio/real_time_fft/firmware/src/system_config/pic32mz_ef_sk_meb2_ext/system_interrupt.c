...
void __ISR(_TIMER_8_VECTOR, ipl3AUTO) _IntHandlerDrvI2CMasterInstance0(void)
{
...
void __ISR(_TIMER_9_VECTOR, ipl3AUTO) _IntHandlerDrvI2CMasterInstance1(void)
{
...
void __ISR(_DMA2_VECTOR, ipl7AUTO) _IntHandlerSysDmaCh0(void)
{          
    SYS_DMA_Tasks(sysObj.sysDma, DMA_CHANNEL_2);
}

void __ISR(_DMA3_VECTOR, ipl3AUTO) _IntHandlerSysDmaCh1(void)
{          
