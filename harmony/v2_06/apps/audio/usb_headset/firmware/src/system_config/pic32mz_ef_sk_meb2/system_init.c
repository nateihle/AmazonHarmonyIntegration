...
const uint8_t fullSpeedConfigurationDescriptor[]=
{
    ...
    234,0,                //(234 Bytes)Size of the Config descriptor.e
 ...
 *******************************************/
    const struct
    {
        uint8_t bLength;        // Size of this descriptor in bytes
        uint8_t bDscType;       // STRING descriptor type
        uint16_t string[50];    // String
    }
    sd002 =
    {
        sizeof(sd002),
        USB_DESCRIPTOR_STRING,
		{'H','a','r','m','o','n','y',' ','U','S','B',' ','H','e','a','d','s','e','t',' ','M','u','l','t','i','p','l','e',' ','S','a','m','p','l','i','n','g',' ','R','a','t','e',' ','E','x','a','m','p','l','e'}
    }; 
