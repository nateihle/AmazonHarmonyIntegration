...
void __ISR(_TIMER_7_VECTOR, ipl3AUTO) _IntHandlerDrvI2CMasterInstance1(void)
{
    ...
    void __ISR(_CHANGE_NOTICE_B_VECTOR, ipl1AUTO) _IntHandlerChangeNotification_PortB(void)
{
   //KEEP THIS 
    ...
    portBState = ((SYS_PORTS_Read(PORTS_ID_0, PORT_CHANNEL_B))  &
                   ((1<<PORTS_BIT_POS_12) | (1<<PORTS_BIT_POS_13) | (1<<PORTS_BIT_POS_14)));

    // Handle buttons interrupt
    APP_ButtonsHandleInterrupt(( portBState));
