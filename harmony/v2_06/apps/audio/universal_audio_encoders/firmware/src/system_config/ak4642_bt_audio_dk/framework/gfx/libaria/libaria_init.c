...
static void ScreenCreate_default(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)PanelWidget1, 218, 35);
    ...
    laWidget_SetPosition((laWidget*)EncoderList, 55, 76);
    laWidget_SetSize((laWidget*)EncoderList, 122, 97);
    laWidget_SetBackgroundType((laWidget*)EncoderList, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)EncoderList, LA_WIDGET_BORDER_LINE);
