...
#define DRV_I2C_BIT_BANG_TMR_MODULE_IDX1                TMR_ID_7
#define DRV_I2C_BIT_BANG_INT_SRC_IDX1                   INT_SOURCE_TIMER_7
...
#define APP_LED1 APP_USB_LED_1
#define APP_LED2 APP_USB_LED_2
#define APP_LED3 APP_USB_LED_3
    
#define SUPPORT_ENCODER_COUNT 4 // pcm, adpcm, opus and speex
#define MIC_SELECT MIC2
    
#define APP_LEDS_ALL_ON() BSP_LEDOn(APP_USB_LED_1); \
