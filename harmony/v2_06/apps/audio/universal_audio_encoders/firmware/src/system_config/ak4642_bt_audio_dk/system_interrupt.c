...
void __ISR(_CHANGE_NOTICE_VECTOR, ipl7AUTO) _IntHandlerChangeNotification(void)
{
    ...
    portAState = ((SYS_PORTS_Read(PORTS_ID_0, PORT_CHANNEL_A)
                   ...
                   ((1<<PORTS_BIT_POS_0) | (1<<PORTS_BIT_POS_1) | (1<<PORTS_BIT_POS_10)));
    portBState = ((SYS_PORTS_Read(PORTS_ID_0, PORT_CHANNEL_B))  &
                   ((1<<PORTS_BIT_POS_12) | (1<<PORTS_BIT_POS_13)));

    // Handle buttons interrupt
    APP_ButtonsHandleInterrupt((portAState | portBState));
