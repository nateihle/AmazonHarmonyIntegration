...
laRectangleWidget* EchoLedOff;
laRectangleWidget* DTLedOff;
laLabelWidget* EchoLabel;
laLabelWidget* ConvergedLable;
laLabelWidget* DTLable;
laRectangleWidget* EchoLedOn;
laRectangleWidget* DTLedOn;
...
static void ScreenCreate_Welcome(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)layer0, 480, 270);
    ...
    laWidget_SetSize((laWidget*)DemoNameLabel, 194, 25);
    ...
    ConnectPrompt = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)ConnectPrompt, 126, 136);
    laWidget_SetSize((laWidget*)ConnectPrompt, 232, 25);
    laWidget_SetScheme((laWidget*)ConnectPrompt, &text_label);
    laWidget_SetBackgroundType((laWidget*)ConnectPrompt, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)ConnectPrompt, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetText(ConnectPrompt, laString_CreateFromID(string_InsertUSB));
    laWidget_AddChild((laWidget*)layer0, (laWidget*)ConnectPrompt);

    MHVersion = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)MHVersion, 381, 50);
    laWidget_SetSize((laWidget*)MHVersion, 90, 25);
    ...
    MCHPLogo = laImageWidget_New();
    laWidget_SetPosition((laWidget*)MCHPLogo, 3, 7);
    laWidget_SetSize((laWidget*)MCHPLogo, 146, 34);
    laWidget_SetScheme((laWidget*)MCHPLogo, &image_button);
    laWidget_SetBackgroundType((laWidget*)MCHPLogo, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)MCHPLogo, LA_WIDGET_BORDER_NONE);
    laImageWidget_SetImage(MCHPLogo, &MCHP_LOGO);
    laImageWidget_SetHAlignment(MCHPLogo, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)MCHPLogo);
    ...
    laWidget_SetPosition((laWidget*)LabelWidget1, 6, 83);
    laWidget_SetSize((laWidget*)LabelWidget1, 174, 25);
    ...
    laLabelWidget_SetText(LabelWidget1, laString_CreateFromID(string_ProcType));
    laLabelWidget_SetHAlignment(LabelWidget1, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)LabelWidget1);

    AecEnRadio = laRadioButtonWidget_New();
    laWidget_SetPosition((laWidget*)AecEnRadio, 22, 230);
    laWidget_SetSize((laWidget*)AecEnRadio, 29, 25);
    laWidget_SetScheme((laWidget*)AecEnRadio, &_default);
    laWidget_SetBackgroundType((laWidget*)AecEnRadio, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)AecEnRadio, LA_WIDGET_BORDER_NONE);
    laRadioButtonWidget_SetHAlignment(AecEnRadio, LA_HALIGN_LEFT);
    laRadioButtonWidget_SetSelected(AecEnRadio);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)AecEnRadio);

    AecEnLabel = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)AecEnLabel, 42, 226);
    laWidget_SetSize((laWidget*)AecEnLabel, 49, 25);
    laWidget_SetScheme((laWidget*)AecEnLabel, &text_label);
    laWidget_SetBackgroundType((laWidget*)AecEnLabel, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)AecEnLabel, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetText(AecEnLabel, laString_CreateFromID(string_aecEn));
    laLabelWidget_SetHAlignment(AecEnLabel, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)AecEnLabel);

    ConvergedLed = laRectangleWidget_New();
    laWidget_SetPosition((laWidget*)ConvergedLed, 106, 237);
    laWidget_SetSize((laWidget*)ConvergedLed, 15, 15);
    laWidget_SetScheme((laWidget*)ConvergedLed, &_default);
    laWidget_SetBackgroundType((laWidget*)ConvergedLed, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)ConvergedLed, LA_WIDGET_BORDER_NONE);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)ConvergedLed);

    EchoLedOff = laRectangleWidget_New();
    laWidget_SetPosition((laWidget*)EchoLedOff, 392, 231);
    laWidget_SetSize((laWidget*)EchoLedOff, 15, 15);
    laWidget_SetScheme((laWidget*)EchoLedOff, &filled_circle);
    laWidget_SetBackgroundType((laWidget*)EchoLedOff, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)EchoLedOff, LA_WIDGET_BORDER_NONE);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)EchoLedOff);

    DTLedOff = laRectangleWidget_New();
    laWidget_SetPosition((laWidget*)DTLedOff, 432, 230);
    laWidget_SetSize((laWidget*)DTLedOff, 15, 15);
    laWidget_SetScheme((laWidget*)DTLedOff, &filled_circle);
    laWidget_SetBackgroundType((laWidget*)DTLedOff, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)DTLedOff, LA_WIDGET_BORDER_NONE);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)DTLedOff);

    EchoLabel = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)EchoLabel, 380, 208);
    laWidget_SetSize((laWidget*)EchoLabel, 39, 20);
    laWidget_SetScheme((laWidget*)EchoLabel, &text_label);
    laWidget_SetBackgroundType((laWidget*)EchoLabel, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)EchoLabel, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetText(EchoLabel, laString_CreateFromID(string_Echo));
    laWidget_AddChild((laWidget*)layer0, (laWidget*)EchoLabel);

    ConvergedLable = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)ConvergedLable, 122, 220);
    laWidget_SetSize((laWidget*)ConvergedLable, 78, 25);
    laWidget_SetEnabled((laWidget*)ConvergedLable, LA_FALSE);
    laWidget_SetVisible((laWidget*)ConvergedLable, LA_FALSE);
    laWidget_SetScheme((laWidget*)ConvergedLable, &text_label);
    laWidget_SetBackgroundType((laWidget*)ConvergedLable, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)ConvergedLable, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetText(ConvergedLable, laString_CreateFromID(string_Converged));
    laLabelWidget_SetHAlignment(ConvergedLable, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)ConvergedLable);

    DTLable = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)DTLable, 425, 208);
    laWidget_SetSize((laWidget*)DTLable, 29, 19);
    laWidget_SetScheme((laWidget*)DTLable, &text_label);
    laWidget_SetBackgroundType((laWidget*)DTLable, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)DTLable, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetText(DTLable, laString_CreateFromID(string_DT));
    laWidget_AddChild((laWidget*)layer0, (laWidget*)DTLable);

    EchoLedOn = laRectangleWidget_New();
    laWidget_SetPosition((laWidget*)EchoLedOn, 392, 231);
    laWidget_SetSize((laWidget*)EchoLedOn, 15, 15);
    laWidget_SetScheme((laWidget*)EchoLedOn, &filled_circle);
    laWidget_SetBackgroundType((laWidget*)EchoLedOn, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)EchoLedOn, LA_WIDGET_BORDER_NONE);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)EchoLedOn);

    DTLedOn = laRectangleWidget_New();
    laWidget_SetPosition((laWidget*)DTLedOn, 432, 230);
    laWidget_SetSize((laWidget*)DTLedOn, 15, 15);
    laWidget_SetScheme((laWidget*)DTLedOn, &filled_circle);
    laWidget_SetBackgroundType((laWidget*)DTLedOn, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)DTLedOn, LA_WIDGET_BORDER_NONE);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)DTLedOn);
