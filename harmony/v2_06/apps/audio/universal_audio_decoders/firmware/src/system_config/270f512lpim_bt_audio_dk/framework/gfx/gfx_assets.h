...
#define string_AlbumName    1
#define string_ArtistName    2
#define string_DemoName    3
#define string_InsertUSB    4
#define string_MP3Decoder    5
#define string_NOPlayerDisplay    6
#define string_NOPlayerDisplay1    7
#define string_Playtime    8
#define string_TrackLength    9
#define string_TrackName    10
#define string_WAVDecoder    11
