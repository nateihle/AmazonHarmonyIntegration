...
// Generated Event Handler - Origin: PlayButton, Event: ReleasedEvent
void PlayButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: NextTrackButton, Event: ReleasedEvent
void NextTrackButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: PrevTrackButton, Event: ReleasedEvent
void PrevTrackButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: ToFileExplorerButton, Event: ReleasedEvent
void ToFileExplorerButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: ToPlayerButton, Event: ReleasedEvent
