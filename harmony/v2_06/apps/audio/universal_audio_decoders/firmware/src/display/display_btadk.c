...
{
//    _updateLabelWidgetText(TrackNameLabel, " ", 1);
//    _updateLabelWidgetText(TrackArtistLabel, " ", 1);
//    _updateLabelWidgetText(TrackAlbumLabel, " ", 1);
}
...
void _display_track_name()
{
    if(laContext_GetActiveScreenIndex() == MainScreen_ID)
    {
        ...
        {
            _updateLabelWidgetText(TrackNameLabel, (GFXU_CHAR*)(_displayData->track), _displayData->trackLen, 1);
        }
    }
...
void _display_artist_name()
{
    if(laContext_GetActiveScreenIndex() == MainScreen_ID)
    {
        ...
        {
            _updateLabelWidgetText(TrackArtistLabel, (GFXU_CHAR*)(_displayData->artist), _displayData->artistLen, 1);
        }
    }
}
...
void _display_album_name()
{
    if(laContext_GetActiveScreenIndex() == MainScreen_ID)
    {
        ...
        {
            _updateLabelWidgetText(TrackAlbumLabel, (GFXU_CHAR*)(_displayData->album), _displayData->albumLen, 1);
        }
    }
}
...
void _display_prompt_message()
{
    if(laContext_GetActiveScreenIndex() == Welcome_ID)
    {
        ...
        {
            _updateLabelWidgetText(MessageLabel, _displayData->prompt_msg, _displayData->prompt_msg_len, 1);
        }
    }
}
