...
//KEEP THIS
//MAXIMUM Queue SIZE ALLOWED by USB HOST AUDIO V1.0 Library is 8
...
// AK4642 Codec DB (External Mic(Line-In) is MIC2, Internal Mic is MIC1)
