...
static void ScreenCreate_Welcome(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)DemoNameLabel, 204, 25);
    ...
    ConnectLabel = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)ConnectLabel, 17, 110);
    laWidget_SetSize((laWidget*)ConnectLabel, 180, 25);
    laWidget_SetScheme((laWidget*)ConnectLabel, &text_label);
    laWidget_SetBackgroundType((laWidget*)ConnectLabel, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)ConnectLabel, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetText(ConnectLabel, laString_CreateFromID(string_InsertUSB));
    laWidget_AddChild((laWidget*)layer0, (laWidget*)ConnectLabel);

    MHVersion = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)MHVersion, 157, 10);
