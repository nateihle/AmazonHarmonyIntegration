...
#define string_MHVersion    3
#define string_PLAY_TIME    4
#define string_TRACK_ARTIST    5
#define string_TRACK_LENGTH    6
#define string_TRACK_NAME    7
#define string_USB_STATUS    8
#define string_alphaNumSans12italic    9
