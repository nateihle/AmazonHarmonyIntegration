...
int32_t libaria_initialize(void)
{
    ...
    image_button.background = 0xFFFF;
...
static void ScreenCreate_Welcome(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)LabelWidget2, 2, 113);
    laWidget_SetSize((laWidget*)LabelWidget2, 211, 25);
    ...
    laWidget_SetPosition((laWidget*)MHVersion, 148, 46);
