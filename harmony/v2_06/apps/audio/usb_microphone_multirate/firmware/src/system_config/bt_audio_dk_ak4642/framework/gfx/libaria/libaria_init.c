...
laLabelWidget* DeviceType1;
laLabelWidget* DeviceType;
...
static void ScreenCreate_Welcome(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)RectangleWidget1, 220, 176);
    ...
    laWidget_SetSize((laWidget*)DemoNameLabel, 205, 24);
    ...
    laWidget_SetPosition((laWidget*)MHVersion, 161, 10);
    ...
    DeviceType1 = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)DeviceType1, 6, 66);
    laWidget_SetSize((laWidget*)DeviceType1, 194, 25);
    laWidget_SetScheme((laWidget*)DeviceType1, &text_label);
    laWidget_SetBackgroundType((laWidget*)DeviceType1, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)DeviceType1, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetText(DeviceType1, laString_CreateFromID(string_DeviceType));
    laLabelWidget_SetHAlignment(DeviceType1, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)DeviceType1);

    DeviceType = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)DeviceType, 6, 86);
    laWidget_SetSize((laWidget*)DeviceType, 144, 25);
    laWidget_SetScheme((laWidget*)DeviceType, &text_label);
    laWidget_SetBackgroundType((laWidget*)DeviceType, LA_WIDGET_BACKGROUND_NONE);
    laWidget_SetBorderType((laWidget*)DeviceType, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetText(DeviceType, laString_CreateFromID(string_CodecType));
    laLabelWidget_SetHAlignment(DeviceType, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)layer0, (laWidget*)DeviceType);

    LabelWidget1 = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)LabelWidget1, 20, 122);
    laWidget_SetSize((laWidget*)LabelWidget1, 190, 25);
    ...
    laLabelWidget_SetText(LabelWidget1, laString_CreateFromID(string_InsertUSB));
