...
// string IDs
#define string_CodecType    0
#define string_DEMO_NAME    1
#define string_DeviceType    2
#define string_InsertUSB    3
#define string_MHVersion    4
#define string_PLAY_TIME    5
#define string_TRACK_ARTIST    6
#define string_TRACK_LENGTH    7
#define string_TRACK_NAME    8
#define string_USB_STATUS    9
