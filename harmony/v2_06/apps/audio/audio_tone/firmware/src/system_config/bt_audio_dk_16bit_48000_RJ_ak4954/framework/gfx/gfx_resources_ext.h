...
// string IDs
#define string_Resolution    0
#define string_Resolution_value    1
#define string_Sample_Frequency    2
#define string_Sample_Frequency_value    3
#define string_String12    4
#define string_String14    5
#define string_Title    6
#define string_Volume    7
#define string_f1_Hz    8
#define string_f2_Hz    9
#define string_t_ms    10
