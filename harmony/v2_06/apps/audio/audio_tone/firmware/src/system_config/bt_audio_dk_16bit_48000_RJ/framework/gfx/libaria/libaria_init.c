...
static void ScreenCreate_DemoScreen(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)GFX_AUDIO_PLAY, 94, 141);
    ...
    laWidget_AddChild((laWidget*)layer0, (laWidget*)GFX_AUDIO_PLAY);

    GFX_AUDIO_MUTE = laImageWidget_New();
    laWidget_SetPosition((laWidget*)GFX_AUDIO_MUTE, 94, 141);
    ...
    laWidget_AddChild((laWidget*)layer0, (laWidget*)GFX_AUDIO_MUTE);
