...
#define APP_LED1_ON()                                   BSP_LEDOn(BSP_LED_RED)
#define APP_LED1_OFF()                                  BSP_LEDOff(BSP_LED_RED)
#define APP_LED1_TOGGLE()                               BSP_LEDToggle(BSP_LED_RED)
#define APP_LED2_ON()                                   BSP_LEDOn(BSP_LED_GREEN)
#define APP_LED2_OFF()                                  BSP_LEDOff(BSP_LED_GREEN)
#define APP_LED2_TOGGLE()                               BSP_LEDToggle(BSP_LED_GREEN)
#define APP_LED3_ON()                                   BSP_LEDOn(BSP_LED_BLUE)
#define APP_LED3_OFF()                                  BSP_LEDOff(BSP_LED_BLUE)
#define APP_LED3_TOGGLE()                               BSP_LEDToggle(BSP_LED_BLUE)
#define APP_LED4_ON()                                   BSP_LEDOn(BSP_LED_RED)
#define APP_LED4_OFF()                                  BSP_LEDOff(BSP_LED_RED)
#define APP_LED4_TOGGLE()                               BSP_LEDToggle(BSP_LED_RED)
#define APP_LED5_ON()                                   BSP_LEDOn(BSP_LED_GREEN)
#define APP_LED5_OFF()                                  BSP_LEDOff(BSP_LED_GREEN)
#define APP_LED5_TOGGLE()                               BSP_LEDToggle(BSP_LED_GREEN)
