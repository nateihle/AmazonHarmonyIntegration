...
#if (WDRV_DEFAULT_NETWORK_TYPE == WDRV_NETWORK_TYPE_INFRASTRUCTURE)
    SYS_CONSOLE_MESSAGE("\r\n=======================================");
    SYS_CONSOLE_MESSAGE("\r\n*** WILC1000 FreeRTOS STA Mode Demo ***");
    SYS_CONSOLE_MESSAGE("\r\n=======================================\r\n");
#else
    SYS_CONSOLE_MESSAGE("\r\n======================================");
    SYS_CONSOLE_MESSAGE("\r\n*** WILC1000 FreeRTOS AP Mode Demo ***");
    SYS_CONSOLE_MESSAGE("\r\n======================================\r\n");
#endif	
#else
    SYS_CONSOLE_MESSAGE("\r\n================================");
    SYS_CONSOLE_MESSAGE("\r\n*** WILC1000 Non-OS STA Mode Demo ***");
    SYS_CONSOLE_MESSAGE("\r\n================================\r\n");
#endif
}
