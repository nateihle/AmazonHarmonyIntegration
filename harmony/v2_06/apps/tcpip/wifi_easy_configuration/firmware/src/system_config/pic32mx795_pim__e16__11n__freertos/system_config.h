...
#define WF_POWER_PORT_CHANNEL       PORT_CHANNEL_F
#define WF_POWER_BIT_POS            1
...
#define TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX0		"MRF24WN"
...
#define TCPIP_NETWORK_DEFAULT_MAC_DRIVER_IDX0			WDRV_MRF24WN_MACObject
