...
#define WDRV_NVM_SPACE_ADDR (40 * 1024)
...
#define WDRV_CHIP_EN_BIT_POS        3

#define WDRV_IRQN_PORT_CHANNEL      PORT_CHANNEL_E
#define WDRV_IRQN_BIT_POS           8

#define WDRV_RESET_N_PORT_CHANNEL   PORT_CHANNEL_E
#define WDRV_RESET_N_BIT_POS        9
...
#define TCPIP_STACK_CALLOC_FUNC                     APP_OSAL_Calloc
