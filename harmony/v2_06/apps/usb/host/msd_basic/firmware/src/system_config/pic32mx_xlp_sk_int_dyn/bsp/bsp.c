/*******************************************************************************
  ...
  Summary:
    Board Support Package implementation for PIC32MX XLP Starter Kit.
...
void BSP_USBVBUSSwitchStateSet(BSP_USB_VBUS_SWITCH_STATE state)
{
    ...
    PLIB_PORTS_PinWrite( PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_7, state );
}
...
void BSP_USBVBUSPowerEnable(uint8_t port, bool enable)
{
    ...
    PLIB_PORTS_PinWrite( PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_7, enable );
}
