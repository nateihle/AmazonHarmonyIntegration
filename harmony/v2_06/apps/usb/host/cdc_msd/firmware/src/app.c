...
APP_DATA appData APP_COHERENT_ATTRIBUTE __attribute__((aligned(16)));
...
APP_MSD_DATA appMSDData APP_COHERENT_ATTRIBUTE __attribute__((aligned(16)));;

/* Application CDC Task Object */
APP_CDC_DATA  appCDCData APP_COHERENT_ATTRIBUTE __attribute__((aligned(16))) ;
