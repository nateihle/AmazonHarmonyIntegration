...
APP_DATA appData;
static SYS_TMR_HANDLE fpsUpdateTimer;
...
static void fpsUpdateTimer_Callback ( uintptr_t context, uint32_t currTick )
{
        ...
        case APP_STATE_RUN_FPS_COUNTERS:
        {
            ...
            switch (appData.event)
            {
                ...
                case APP_EVENT_INIT_STATE:
                {
                    ...
                    SYS_TMR_ObjectDelete(fpsUpdateTimer);
                    fpsUpdateTimer = SYS_TMR_CallbackPeriodic(
        ...
        case APP_STATE_RUN_FPS_IMAGE_RENDER:
        {
            switch (appData.event)
            {
                ...
                case APP_EVENT_INIT_STATE:
                {
                    ...
                    appData.imgType = APP_IMG_JPG_24;
                    appData.imgIndex = 0;
