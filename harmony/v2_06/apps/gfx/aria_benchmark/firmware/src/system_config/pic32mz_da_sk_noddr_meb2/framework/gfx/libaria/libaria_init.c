...
static void ScreenCreate_FPSCounters(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)ButtonWidget1, 360, 238);
    laWidget_SetSize((laWidget*)ButtonWidget1, 55, 29);
...
static void ScreenCreate_FPSMotion(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)ButtonWidget2, 361, 237);
    laWidget_SetSize((laWidget*)ButtonWidget2, 54, 30);
...
static void ScreenCreate_FPSImages(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)ButtonWidget3, 360, 234);
