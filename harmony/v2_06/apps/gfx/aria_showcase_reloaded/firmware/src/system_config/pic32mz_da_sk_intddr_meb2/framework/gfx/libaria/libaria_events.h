...
// Generated Event Handler - Origin: RadialMenuButton, Event: ReleasedEvent
void RadialMenuButton_ReleasedEvent(laButtonWidget* btn);
...
// Generated Event Handler - Origin: BarGraphTouchedButton, Event: PressedEvent
void BarGraphTouchedButton_PressedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: BarGraphTouchedButton, Event: ReleasedEvent
void BarGraphTouchedButton_ReleasedEvent(laButtonWidget* btn);
...
// Generated Event Handler - Origin: RadialMenu_NextButton, Event: ReleasedEvent
void RadialMenu_NextButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: RadialMenu_HomeButton, Event: ReleasedEvent
void RadialMenu_HomeButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: RadialMenuWidget35, Event: ItemSelectedEvent
void RadialMenuWidget35_ItemSelectedEvent(laRadialMenuWidget * mn, laWidget * selectedWidget, int32_t value);
