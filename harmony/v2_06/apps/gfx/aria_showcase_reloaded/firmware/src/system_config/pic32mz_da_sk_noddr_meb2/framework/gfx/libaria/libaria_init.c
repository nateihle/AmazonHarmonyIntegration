...
int32_t libaria_initialize(void)
{
    ...
    laScheme_Initialize(&RadialMenuDemoScheme, GFX_COLOR_MODE_RGB_565);
    RadialMenuDemoScheme.base = 0xE5AD;
    RadialMenuDemoScheme.highlight = 0xC67A;
    RadialMenuDemoScheme.highlightLight = 0xFFFF;
    RadialMenuDemoScheme.shadow = 0x8410;
    RadialMenuDemoScheme.shadowDark = 0x4208;
    RadialMenuDemoScheme.foreground = 0x0;
    RadialMenuDemoScheme.foregroundInactive = 0xD71C;
    RadialMenuDemoScheme.foregroundDisabled = 0x8410;
    RadialMenuDemoScheme.background = 0xFEB7;
    RadialMenuDemoScheme.backgroundInactive = 0xD71C;
    RadialMenuDemoScheme.backgroundDisabled = 0xC67A;
    RadialMenuDemoScheme.text = 0x0;
    RadialMenuDemoScheme.textHighlight = 0x1F;
    RadialMenuDemoScheme.textHighlightText = 0xFFFF;
    RadialMenuDemoScheme.textInactive = 0xD71C;
    RadialMenuDemoScheme.textDisabled = 0x8C92;
...
static void ScreenCreate_MainMenu(laScreen* screen)
{
    ...
    PanelWidget39 = laWidget_New();
    laWidget_SetPosition((laWidget*)PanelWidget39, 255, 154);
    laWidget_SetSize((laWidget*)PanelWidget39, 100, 100);
    laWidget_SetScheme((laWidget*)PanelWidget39, &BlackBaseScheme);
    laWidget_SetBackgroundType((laWidget*)PanelWidget39, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)PanelWidget39, LA_WIDGET_BORDER_NONE);
    laWidget_AddChild((laWidget*)layer0, PanelWidget39);
    ...
    laWidget_SetPosition((laWidget*)LabelWidget28, 360, 162);
    ...
    laWidget_SetPosition((laWidget*)LabelWidget, 378, 200);
    ...
    ButtonWidget36 = laButtonWidget_New();
    laWidget_SetPosition((laWidget*)ButtonWidget36, 251, 150);
    laWidget_SetSize((laWidget*)ButtonWidget36, 100, 100);
    laWidget_SetScheme((laWidget*)ButtonWidget36, &RadialMenuDemoScheme);
    laWidget_SetBackgroundType((laWidget*)ButtonWidget36, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)ButtonWidget36, LA_WIDGET_BORDER_NONE);
    laButtonWidget_SetPressedImage(ButtonWidget36, &RadialMenuIcon);
    laButtonWidget_SetReleasedImage(ButtonWidget36, &RadialMenuIcon);
    laButtonWidget_SetReleasedEventCallback(ButtonWidget36, &ButtonWidget36_ReleasedEvent);

    laWidget_AddChild((laWidget*)layer0, (laWidget*)ButtonWidget36);
...
static void ScreenCreate_LineGraphScreen(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)LineGraphTouchedButton, 0, 55);
    laWidget_SetSize((laWidget*)LineGraphTouchedButton, 480, 217);
    ...
    laWidget_SetPosition((laWidget*)CheckBoxPhantomButton, 266, 54);
    laWidget_SetSize((laWidget*)CheckBoxPhantomButton, 64, 22);
    ...
    laWidget_SetPosition((laWidget*)CheckBoxWidget17, 0, 1);
    laWidget_SetSize((laWidget*)CheckBoxWidget17, 54, 20);
...
static void ScreenCreate_RadialMenuDemoScreen(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)PanelWidget2, 19, 19);
    laWidget_SetSize((laWidget*)PanelWidget2, 30, 30);
    laWidget_SetScheme((laWidget*)PanelWidget2, &BlackBaseScheme);
    ...
    laWidget_AddChild((laWidget*)RadialMenu_HomeButton, PanelWidget2);

    PanelWidget16 = laWidget_New();
    laWidget_SetPosition((laWidget*)PanelWidget16, 15, 15);
    laWidget_SetSize((laWidget*)PanelWidget16, 30, 30);
    laWidget_SetScheme((laWidget*)PanelWidget16, &RadialMenuDemoScheme);
    ...
    laWidget_AddChild((laWidget*)RadialMenu_HomeButton, PanelWidget16);

    ImageWidget17 = laImageWidget_New();
    laWidget_SetPosition((laWidget*)ImageWidget17, 15, 15);
    laWidget_SetSize((laWidget*)ImageWidget17, 30, 30);
    ...
    laImageWidget_SetImage(ImageWidget17, &HomeButton30x30Glow);
    laWidget_AddChild((laWidget*)RadialMenu_HomeButton, (laWidget*)ImageWidget17);
    ...
    laWidget_SetScheme((laWidget*)RadialMenu_NextButton, &RadialMenuDemoScheme);
    ...
    laWidget_SetPosition((laWidget*)PanelWidget19, 15, 19);
    laWidget_SetSize((laWidget*)PanelWidget19, 30, 30);
    laWidget_SetScheme((laWidget*)PanelWidget19, &BlackBaseScheme);
    ...
    PanelWidget20 = laWidget_New();
    laWidget_SetPosition((laWidget*)PanelWidget20, 19, 15);
    laWidget_SetSize((laWidget*)PanelWidget20, 30, 30);
    laWidget_SetScheme((laWidget*)PanelWidget20, &RadialMenuDemoScheme);
    laWidget_SetBackgroundType((laWidget*)PanelWidget20, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)PanelWidget20, LA_WIDGET_BORDER_NONE);
    laWidget_AddChild((laWidget*)RadialMenu_NextButton, PanelWidget20);

    ImageWidget21 = laImageWidget_New();
    laWidget_SetPosition((laWidget*)ImageWidget21, 19, 15);
    laWidget_SetSize((laWidget*)ImageWidget21, 30, 30);
    ...
    laImageWidget_SetImage(ImageWidget21, &NextButton30x30Glow);
    laWidget_AddChild((laWidget*)RadialMenu_NextButton, (laWidget*)ImageWidget21);
    ...
    laWidget_SetPosition((laWidget*)RadialMenuWidget35, 20, 60);
    laWidget_SetSize((laWidget*)RadialMenuWidget35, 440, 181);
    ...
    laRadialMenuWidget_SetTouchArea(RadialMenuWidget35, 0, 50, 440, 130);
    ...
    laWidget_SetPosition((laWidget*)RadialMenuWidget35_Item0, 240, 150);
    ...
    laWidget_SetPosition((laWidget*)RadialMenuWidget35_Item1, 240, 150);
    ...
    laWidget_SetPosition((laWidget*)RadialMenuWidget35_Item2, 240, 150);
    ...
    laImagePlusWidget_SetImage(RadialMenuWidget35_Item3, &LineGraphFilled100x100);
    ...
    laWidget_SetPosition((laWidget*)RadialMenuWidget35_Item3, 240, 150);
    ...
    laImagePlusWidget_SetImage(RadialMenuWidget35_Item4, &PieChartFilled100x100);
    ...
    laWidget_SetPosition((laWidget*)RadialMenuWidget35_Item4, 240, 150);
    ...
    laImagePlusWidget_SetImage(RadialMenuWidget35_Item5, &CircularSliderFill100x100);
    ...
    laWidget_SetPosition((laWidget*)RadialMenuWidget35_Item5, 240, 150);
