...
int32_t libaria_initialize(void)
{
    ...
    defaultScheme.background = 0xFC00;
...
static void ScreenCreate_default(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)LabelWidget1, 311, 120);
    ...
    laWidget_SetPosition((laWidget*)ImageWidget1, 279, 160);
    ...
    laWidget_SetPosition((laWidget*)ButtonWidget1, 266, 410);
