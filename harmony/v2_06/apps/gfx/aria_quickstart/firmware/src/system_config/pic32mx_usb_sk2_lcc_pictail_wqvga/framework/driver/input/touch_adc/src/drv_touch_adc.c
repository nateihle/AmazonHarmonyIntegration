...
short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00E0,
                                                         0x00E3,
                                                         0x033C,
                                                         0x033A };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUly = 0x00E0;

    samplePoints.touchCalUrx = 0x0366;
    samplePoints.touchCalUry = 0x00E3;

    samplePoints.touchCalLrx = 0x0362;
    samplePoints.touchCalLry = 0x033C;

    samplePoints.touchCalLlx = 0x0097;
    samplePoints.touchCalLly = 0x033A;
