...
static void ScreenCreate_default(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)LabelWidget1, 70, 7);
    ...
    laWidget_SetPosition((laWidget*)ButtonWidget1, 25, 185);
    ...
    laWidget_SetPosition((laWidget*)ImageWidget1, 65, 44);
    laWidget_SetSize((laWidget*)ImageWidget1, 190, 131);
    ...
    laImageWidget_SetImage(ImageWidget1, &harmony_80);
