...
*/
#define CAL_X_INSET    (((800)*(20>>1))/100)
...
*/
#define CAL_Y_INSET    (((480)*(20>>1))/100)
...
short xRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x0093,
                                                         0x037c,
                                                         0x0376,
                                                         0x009f };

short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x0340,
                                                         0x0348,
                                                         0x00d1,
                                                         0x00d1 };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUlx = 0x0093;
    samplePoints.touchCalUly = 0x0340;

    samplePoints.touchCalUrx = 0x037c;
    samplePoints.touchCalUry = 0x0348;

    samplePoints.touchCalLrx = 0x0376;
    samplePoints.touchCalLry = 0x00d1;

    samplePoints.touchCalLlx = 0x009f;
    samplePoints.touchCalLly = 0x00d1;
...
void DRV_TOUCH_ADC_CoefficientSet(short xraw[], short yraw[])
{
    ...
    yPoint[2] = yPoint[3] = (480 - CAL_Y_INSET);
    xPoint[0] = xPoint[3] = CAL_X_INSET;
    xPoint[1] = xPoint[2] = (800 - CAL_X_INSET);
