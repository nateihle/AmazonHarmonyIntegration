...
static void ScreenCreate_default(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)LabelWidget1, 21, 0);
    ...
    laWidget_SetPosition((laWidget*)LabelWidget2, 30, 144);
    laWidget_SetSize((laWidget*)LabelWidget2, 167, 25);
    laWidget_SetOptimizationFlags((laWidget*)LabelWidget2, LA_WIDGET_OPT_LOCAL_REDRAW);
    ...
    laLabelWidget_SetText(LabelWidget2, laString_CreateFromID(string_Instructions));
    ...
    laWidget_SetPosition((laWidget*)ImageWidget1, 52, 46);
    laWidget_SetSize((laWidget*)ImageWidget1, 115, 84);
    laWidget_SetOptimizationFlags((laWidget*)ImageWidget1, LA_WIDGET_OPT_LOCAL_REDRAW);
    ...
    laImageWidget_SetImage(ImageWidget1, &newharmonylogo_sm);
