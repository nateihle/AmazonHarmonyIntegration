...
int32_t libaria_initialize(void)
{
    ...
    GFXU_PreprocessImage(&Bar,0xA8F55000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&audio_icons_01,0xA904EC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&audio_icons_05,0xA9052C80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&audio_icons_06,0xA9056C80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&audio_icons_07,0xA905AC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&portrait01,0xA8E4D000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&portrait02,0xA8E6D000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&portrait03,0xA8E8D000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&portrait07,0xA8F6EC80,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&portrait05,0xA8F7EC80,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&portrait04,0xA8F8EC80,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&portrait06,0xA8F9EC80,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&ConcertBackground,0xA8CB8000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&MoleculeBackground,0xA8D3F000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&TouchBackground,0xA8DC6000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover1,0xA8FAEC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover10,0xA8FBEC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover2,0xA8FCEC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover3,0xA8FDEC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover4,0xA8FEEC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover5,0xA8FFEC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover6,0xA900EC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover7,0xA901EC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover8,0xA902EC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&cover9,0xA903EC80,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&card1,0xA8EAD000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&card2,0xA8EC9000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&card3,0xA8EE5000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&card4,0xA8F01000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&card5,0xA8F1D000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
    GFXU_PreprocessImage(&card6,0xA8F39000,GFX_COLOR_MODE_RGBA_8888,GFX_FALSE);
...
static void ScreenCreate_InfoScreen(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)InfoTextImage, 475, 300);
