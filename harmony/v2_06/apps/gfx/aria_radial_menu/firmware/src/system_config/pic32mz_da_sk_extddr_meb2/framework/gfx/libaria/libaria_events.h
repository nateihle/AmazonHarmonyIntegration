...
// Generated Event Handler - Origin: RadialMenuWidget_Main, Event: ItemSelectedEvent
void RadialMenuWidget_Main_ItemSelectedEvent(laRadialMenuWidget * mn, laWidget * selectedWidget, int32_t value);

// Generated Event Handler - Origin: RadialMenuWidget_Main, Event: ItemProminenceChangedEvent
void RadialMenuWidget_Main_ItemProminenceChangedEvent(laRadialMenuWidget * mn, laWidget * prominentWidget, int32_t value);

// Generated Event Handler - Origin: InfoButton, Event: ReleasedEvent
...
// Generated Event Handler - Origin: ButtonWidget, Event: ReleasedEvent
