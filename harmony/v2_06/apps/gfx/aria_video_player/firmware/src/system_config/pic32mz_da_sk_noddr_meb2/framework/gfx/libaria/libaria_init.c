...
static void ScreenCreate_PlayBackScreen(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)MetricsPanelWidget1, 0, 8);
    ...
    laWidget_SetPosition((laWidget*)BandWidthLabelWidget, 0, 12);
    ...
    laWidget_SetPosition((laWidget*)frameRateLabelWidget, 0, 29);
...
static void ScreenCreate_PlayBackScreenSmall(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)StopButtonWidget2, 36, 170);
    ...
    laWidget_SetPosition((laWidget*)FFButtonWidget2, 35, 130);
    ...
    laWidget_SetPosition((laWidget*)RWButtonWidget2, 35, 50);
    ...
    laWidget_SetPosition((laWidget*)PauseButtonWidget2, 35, 90);
    ...
    laWidget_SetPosition((laWidget*)RestartButtonWidget2, 35, 10);
    ...
    laWidget_SetPosition((laWidget*)SliderControlSmall, 9, 0);
