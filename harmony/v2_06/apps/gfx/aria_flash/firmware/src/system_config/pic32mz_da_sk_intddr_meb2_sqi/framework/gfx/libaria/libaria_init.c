...
int32_t libaria_initialize(void)
{
    ...
    laScheme_Initialize(&ProgressScheme, GFX_COLOR_MODE_RGBA_8888);
    ProgressScheme.base = 0xC8D0D4FF;
    ProgressScheme.highlight = 0xC8D0D4FF;
    ProgressScheme.highlightLight = 0xBDBEBDFF;
    ProgressScheme.shadow = 0x808080FF;
    ProgressScheme.shadowDark = 0x404040FF;
    ProgressScheme.foreground = 0xFF;
    ProgressScheme.foregroundInactive = 0xD6E3E7FF;
    ProgressScheme.foregroundDisabled = 0x808080FF;
    ProgressScheme.background = 0xFFFFFFFF;
    ProgressScheme.backgroundInactive = 0xD6E3E7FF;
    ProgressScheme.backgroundDisabled = 0xC8D0D4FF;
    ProgressScheme.text = 0xFF;
    ProgressScheme.textHighlight = 0xFFFF;
    ProgressScheme.textHighlightText = 0xFFFFFFFF;
    ProgressScheme.textInactive = 0xD6E3E7FF;
    ProgressScheme.textDisabled = 0x8C9294FF;
...
static void ScreenCreate_default(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)WatermarkImage, 149, 68);
    ...
    laWidget_SetPosition((laWidget*)USBButton, 169, 21);
