...
#define SCALE_FACTOR (1<<8)
    ...
    #define ADC_MaxXGet() (320 - 1)
#elif (DISP_ORIENTATION == 270)
    #define ADC_MaxXGet() (320 - 1)
#elif (DISP_ORIENTATION == 0)
    #define ADC_MaxXGet() (240 - 1)
#elif (DISP_ORIENTATION == 180)
    #define ADC_MaxXGet() (240 - 1)
#endif
#if (DISP_ORIENTATION == 90)
    #define ADC_MaxYGet() (240 - 1)
#elif (DISP_ORIENTATION == 270)
    #define ADC_MaxYGet() (240 - 1)
#elif (DISP_ORIENTATION == 0)
    #define ADC_MaxYGet() (320 - 1)
#elif (DISP_ORIENTATION == 180)
    #define ADC_MaxYGet() (320 - 1)
#endif
...
volatile short xRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00C0,
                                                         0x037C,
                                                         0x035A,
                                                         0x00B9 };

volatile short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00D4,
                                                         0x00D7,
                                                         0x0333,
                                                         0x0350 };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUlx = 0x00C0;
    samplePoints.touchCalUly = 0x00D4;

    samplePoints.touchCalUrx = 0x037C;
    samplePoints.touchCalUry = 0x00D7;

    samplePoints.touchCalLrx = 0x035A;
    samplePoints.touchCalLry = 0x0333;

    samplePoints.touchCalLlx = 0x00B9;
