...
short xRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00e1,
                                                         0x033d,
                                                         0x0337,
                                                         0x00de };

short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x0348,
                                                         0x034d,
                                                         0x00af,
                                                         0x00b0 };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUlx = 0x00e1;
    samplePoints.touchCalUly = 0x0348;

    samplePoints.touchCalUrx = 0x033d;
    samplePoints.touchCalUry = 0x034d;

    samplePoints.touchCalLrx = 0x0337;
    samplePoints.touchCalLry = 0x00af;

    samplePoints.touchCalLlx = 0x00de;
    samplePoints.touchCalLly = 0x00b0;
