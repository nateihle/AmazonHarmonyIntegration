...
#ifndef _DRV_GFX_S1D13517_COMMON_H
#define _DRV_GFX_S1D13517_COMMON_H
...
#define INIT_REGISTER_COUNT 40

static uint8_t registers[INIT_REGISTER_COUNT][2] =
{
    ...
    { S1D13517_REG12_CLK_SRC_SELECT,   0x00 },
    { S1D13517_REG04_PLL_DDIVIDER,     0x97 },
    { S1D13517_REG0E_SS_CONTROL_0,     0x8F },
    { S1D13517_REG14_LCD_PANEL_TYPE,   0x00 },
    { S1D13517_REG16_HDISP_WIDTH,      0x00 },
    { S1D13517_REG18_HNDP_PERIOD,      0x00 },
    { S1D13517_REG1A_VDISP_HEIGHT_0,   0x00 },
    { S1D13517_REG1C_VDISP_HEIGHT_1,   0x00 },
    { S1D13517_REG1E_VNDP_PERIOD,      0x00 },
    { S1D13517_REG20_PHS_PULSE_WIDTH,  0x00 },
    { S1D13517_REG22_PHS_PULSE_START,  0x00 },
    { S1D13517_REG24_PVS_PULSE_WIDTH,  0x00 },
    { S1D13517_REG26_PVS_PULSE_START,  0x00 },
    { S1D13517_REG28_PCLK_POLARITY,    0x00 },
    ...
    { S1D13517_REG52_INPUT_MODE,       0x00 },
    { S1D13517_REG54_TRANSP_KEY_RED,   0x00 },
    { S1D13517_REG56_TRANSP_KEY_GREEN, 0x00 },
    { S1D13517_REG58_TRANSP_KEY_BLUE,  0x00 },
...
typedef struct layerRegister_t
{
    uint8_t XStart;
    uint8_t XEnd;
    uint8_t YStart0;
...
static layerRegister PIPRegister[2] = 
{
	{ 
		S1D13517_REG32_PIP1_WIN_X_SP,
		S1D13517_REG38_PIP1_WIN_X_EP,
		S1D13517_REG34_PIP1_WIN_Y_SP_0,
		S1D13517_REG36_PIP1_WIN_Y_SP_1,
		S1D13517_REG3A_PIP1_WIN_Y_EP_0,
		S1D13517_REG3C_PIP1_WIN_Y_EP_1,
		S1D13517_REG2C_PIP1_DSP_SA_0,
		S1D13517_REG2E_PIP1_DSP_SA_1,
		S1D13517_REG30_PIP1_DSP_SA_2
	},
	{ 
		S1D13517_REG44_PIP2_WIN_X_SP,
		S1D13517_REG4A_PIP2_WIN_X_EP,
		S1D13517_REG46_PIP2_WIN_Y_SP_0,
		S1D13517_REG48_PIP2_WIN_Y_SP_1,
		S1D13517_REG4C_PIP2_WIN_Y_EP_0,
		S1D13517_REG4E_PIP2_WIN_Y_EP_1,
		S1D13517_REG3E_PIP2_DSP_SA_0,
		S1D13517_REG40_PIP2_DSP_SA_1,
		S1D13517_REG42_PIP2_DSP_SA_2
	}
};

typedef void (*TCONInit_FnPtr)(void);
typedef void (*Task_FnPtr)(GFX_Context*);

typedef void (*writePixel_FnPtr)(GFX_Color);

typedef struct S1D13517DriverData_t
{
    uint32_t state;
	
	uint16_t predrawCount;
	uint16_t postdrawCount;
	
	writePixel_FnPtr writePixel;
...
#endif /* DRV_GFX_S1D13517_COMMON_H */