...
/* Macro:
  ...
  Description:
    This constant identifies the number of valid ADC Driver indices.
...
/* Function:
  ...
  Summary:
    Set calibration translate coefficient

  Description:
    This function sets translate coefficient.

  Precondition:
    The DRV_TOUCH_ADC_Initialize routine must have been called.
  ...
  Example:
    <code>
    DRV_TOUCH_ADC_CoefficientSet (short rawValuesX[], short rawValuesY[]);
    </code>
