...
#define SCALE_FACTOR (1<<8)
    ...
    #define ADC_MaxXGet() (480 - 1)
#elif (DISP_ORIENTATION == 270)
    #define ADC_MaxXGet() (480 - 1)
#elif (DISP_ORIENTATION == 0)
    #define ADC_MaxXGet() (800 - 1)
#elif (DISP_ORIENTATION == 180)
    #define ADC_MaxXGet() (800 - 1)
#endif
#if (DISP_ORIENTATION == 90)
    #define ADC_MaxYGet() (800 - 1)
#elif (DISP_ORIENTATION == 270)
    #define ADC_MaxYGet() (800 - 1)
#elif (DISP_ORIENTATION == 0)
    #define ADC_MaxYGet() (480 - 1)
#elif (DISP_ORIENTATION == 180)
    #define ADC_MaxYGet() (480 - 1)
#endif
...
*/
#define CAL_X_INSET    (((ADC_MaxXGet()+1)*(20>>1))/100)
...
*/
#define CAL_Y_INSET    (((ADC_MaxYGet()+1)*(20>>1))/100)
...
volatile short xRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00ad,
                                                         0x03ac,
                                                         0x0378,
                                                         0x0081 };

volatile short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x033f,
                                                         0x0363,
                                                         0x00d4,
                                                         0x00e2 };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUlx = 0x00ad;
    samplePoints.touchCalUly = 0x033f;

    samplePoints.touchCalUrx = 0x03ac;
    samplePoints.touchCalUry = 0x0363;

    samplePoints.touchCalLrx = 0x0378;
    samplePoints.touchCalLry = 0x00d4;

    samplePoints.touchCalLlx = 0x0081;
    samplePoints.touchCalLly = 0x00e2;
