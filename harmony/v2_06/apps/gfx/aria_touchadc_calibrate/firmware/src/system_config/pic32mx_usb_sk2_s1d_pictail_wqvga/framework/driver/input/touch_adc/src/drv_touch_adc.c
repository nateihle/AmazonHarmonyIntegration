...
short xRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00b1,
                                                         0x0372,
                                                         0x0374,
                                                         0x00ab };

short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00ea,
                                                         0x00e2,
                                                         0x033f,
                                                         0x0344 };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUlx = 0x00b1;
    samplePoints.touchCalUly = 0x00ea;

    samplePoints.touchCalUrx = 0x0372;
    samplePoints.touchCalUry = 0x00e2;

    samplePoints.touchCalLrx = 0x0374;
    samplePoints.touchCalLry = 0x033f;

    samplePoints.touchCalLlx = 0x00ab;
    samplePoints.touchCalLly = 0x0344;
