...
static void ScreenCreate_test_screen1(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)LabelWidget1, 120, 2);
...
static void ScreenCreate_test_screen2(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)LabelWidget, 120, 2);
    ...
    laWidget_SetPosition((laWidget*)KeyPadWidget1, 12, 60);
    laWidget_SetSize((laWidget*)KeyPadWidget1, 458, 200);
...
static void ScreenCreate_calibration_screen(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)LabelWidget5, 55, 64);
    ...
    laWidget_SetPosition((laWidget*)LabelWidget6, 336, 65);
    ...
    laWidget_SetPosition((laWidget*)LabelWidget7, 336, 189);
    ...
    laWidget_SetPosition((laWidget*)LabelWidget8, 55, 189);
    ...
    laWidget_SetPosition((laWidget*)Continue, 140, 86);
