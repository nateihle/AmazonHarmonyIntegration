...
short xRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00aa,
                                                         0x0368,
                                                         0x0374,
                                                         0x00ae };

short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x034a,
                                                         0x0345,
                                                         0x0100,
                                                         0x0102 };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUlx = 0x00aa;
    samplePoints.touchCalUly = 0x034a;

    samplePoints.touchCalUrx = 0x0368;
    samplePoints.touchCalUry = 0x0345;

    samplePoints.touchCalLrx = 0x0374;
    samplePoints.touchCalLry = 0x0100;

    samplePoints.touchCalLlx = 0x00ae;
    samplePoints.touchCalLly = 0x0102;
