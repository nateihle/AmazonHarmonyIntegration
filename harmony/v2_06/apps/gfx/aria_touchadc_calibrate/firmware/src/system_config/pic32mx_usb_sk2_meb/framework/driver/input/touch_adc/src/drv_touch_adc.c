...
short xRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x00C8,
                                                         0x00c2,
                                                         0x0332,
                                                         0x033c };

short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x009e,
                                                         0x035d,
                                                         0x035f,
                                                         0x00ab };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUlx = 0x00C8;
    samplePoints.touchCalUly = 0x009e;

    samplePoints.touchCalUrx = 0x00c2;
    samplePoints.touchCalUry = 0x035d;

    samplePoints.touchCalLrx = 0x0332;
    samplePoints.touchCalLry = 0x035f;

    samplePoints.touchCalLlx = 0x033c;
    samplePoints.touchCalLly = 0x00ab;
