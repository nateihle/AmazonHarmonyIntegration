 ...
 * Format: RAW
 ***********************************/
extern GFXU_ImageAsset red_crosshair;
	
/*********************************
 * GFX Image Asset
 * Name:   green_crosshair
 * Size:   48x48 pixels
 * Mode:   RGB_888
 * Format: RAW
 ***********************************/
extern GFXU_ImageAsset green_crosshair;
...
// string IDs
#define string_Results    0
#define string_UL    1
#define string_UR    2
#define string_calibrate_string    3
#define string_continue_string    4
#define string_keypad_string    5
#define string_test_string1    6
#define string_test_string2    7
#define string_touchwidget_string    8
