...
SYS_MODULE_OBJ DRV_SPI0_Initialize(void)
{
    ...
    PLIB_SPI_ClockPolaritySelect( SPI_ID_2, SPI_CLOCK_POLARITY_IDLE_HIGH );
    ...
    /* Baud rate selection */
    PLIB_SPI_BaudRateSet( SPI_ID_2 , SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_1), 6000 );
