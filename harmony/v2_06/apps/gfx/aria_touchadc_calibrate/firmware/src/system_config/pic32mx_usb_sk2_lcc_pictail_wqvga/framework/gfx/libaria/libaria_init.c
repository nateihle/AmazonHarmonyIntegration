...
int32_t libaria_initialize(void)
{
    ...
    TestWidgetScheme.background = 0x7FF;
    TestWidgetScheme.backgroundInactive = 0x1F;
    TestWidgetScheme.backgroundDisabled = 0xF81F;
...
static void ScreenCreate_test_screen2(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)KeyPadWidget1, 20, 60);
    laWidget_SetSize((laWidget*)KeyPadWidget1, 440, 201);
