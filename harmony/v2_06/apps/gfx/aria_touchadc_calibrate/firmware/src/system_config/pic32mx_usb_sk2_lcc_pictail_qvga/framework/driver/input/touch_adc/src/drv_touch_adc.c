...
*/
#define CAL_X_INSET    (((240)*(20>>1))/100)
...
*/
#define CAL_Y_INSET    (((320)*(20>>1))/100)
...
short xRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x0116,
                                                         0x0352,
                                                         0x033d,
                                                         0x00f5 };

short yRawTouch[DRV_TOUCH_ADC_SAMPLE_POINTS] = { 0x0355,
                                                         0x0352,
                                                         0x009a,
                                                         0x009b };
                                              ...
                                              const SYS_MODULE_INIT * const init )
{
    ...
    samplePoints.touchCalUlx = 0x0116;
    samplePoints.touchCalUly = 0x0355;

    samplePoints.touchCalUrx = 0x0352;
    samplePoints.touchCalUry = 0x0352;

    samplePoints.touchCalLrx = 0x033d;
    samplePoints.touchCalLry = 0x009a;

    samplePoints.touchCalLlx = 0x00f5;
    samplePoints.touchCalLly = 0x009b;
...
void DRV_TOUCH_ADC_CoefficientSet(short xraw[], short yraw[])
{
    ...
    yPoint[2] = yPoint[3] = (320 - CAL_Y_INSET);
    xPoint[0] = xPoint[3] = CAL_X_INSET;
    xPoint[1] = xPoint[2] = (240 - CAL_X_INSET);
