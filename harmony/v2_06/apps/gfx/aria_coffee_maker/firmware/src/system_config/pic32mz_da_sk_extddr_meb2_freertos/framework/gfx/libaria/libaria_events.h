...
// Generated Event Handler - Origin: SizeSelect, Event: SelectedItemChangedEvent
void SizeSelect_SelectedItemChangedEvent(laListWheelWidget* whl, uint32_t idx);

// Generated Event Handler - Origin: BrewButton, Event: PressedEvent
void BrewButton_PressedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: BrewButton, Event: ReleasedEvent
void BrewButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: ChangeLanguage, Event: ReleasedEvent
void ChangeLanguage_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: CoffeeButton, Event: ReleasedEvent
void CoffeeButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: CoffeeBeanButton, Event: ReleasedEvent
void CoffeeBeanButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: TeaButton, Event: ReleasedEvent
void TeaButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: InfoPageButton, Event: ReleasedEvent
void InfoPageButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: GPUButton, Event: ReleasedEvent
