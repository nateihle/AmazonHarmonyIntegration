...
static void ScreenCreate_SplashScreen(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)ImageWidget1, 220, 165);
    ...
    laWidget_SetPosition((laWidget*)ImageWidget2, 244, 90);
    ...
    laWidget_SetPosition((laWidget*)ImageWidget4, 10, 410);
...
static void ScreenCreate_MainScreen(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)BackgroundImage, 800, 480);
    ...
    laWidget_SetPosition((laWidget*)RoastLabel, 370, 71);
    laWidget_SetSize((laWidget*)RoastLabel, 139, 49);
    ...
    laWidget_SetBorderType((laWidget*)RoastLabel, LA_WIDGET_BORDER_NONE);
    ...
    laWidget_SetPosition((laWidget*)AppTitleLabel, 331, 20);
    laWidget_SetSize((laWidget*)AppTitleLabel, 209, 51);
    laWidget_SetScheme((laWidget*)AppTitleLabel, &WhiteScheme);
    laWidget_SetBackgroundType((laWidget*)AppTitleLabel, LA_WIDGET_BACKGROUND_FILL);
    ...
    laWidget_AddChild((laWidget*)layer0, (laWidget*)AppTitleLabel);
    ...
    laWidget_SetPosition((laWidget*)DragPanelRight, 660, 0);
    laWidget_SetSize((laWidget*)DragPanelRight, 300, 480);
    ...
    laWidget_SetPosition((laWidget*)SizeSelect, 160, 30);
    laWidget_SetSize((laWidget*)SizeSelect, 120, 360);
    ...
    laListWheelWidget_SetIndicatorArea(SizeSelect, 72);
    laListWheelWidget_SetFlickInitSpeed(SizeSelect, 8);
    ...
    laWidget_SetPosition((laWidget*)PanelWidget4, 140, 390);
    laWidget_SetSize((laWidget*)PanelWidget4, 160, 92);
    ...
    laWidget_SetPosition((laWidget*)BrewButton, 10, 10);
    laWidget_SetSize((laWidget*)BrewButton, 140, 80);
    ...
    laButtonWidget_SetPressedImage(BrewButton, &OvalButtonPressed);
    laButtonWidget_SetReleasedImage(BrewButton, &OvalButton);
    ...
    laWidget_SetPosition((laWidget*)PanelWidget5, 140, 0);
    laWidget_SetSize((laWidget*)PanelWidget5, 20, 420);
    ...
    laWidget_SetPosition((laWidget*)PanelWidget6, 280, 0);
    laWidget_SetSize((laWidget*)PanelWidget6, 20, 420);
    ...
    laWidget_SetPosition((laWidget*)PanelWidget7, 160, 0);
    laWidget_SetSize((laWidget*)PanelWidget7, 120, 30);
    ...
    laWidget_SetSize((laWidget*)RightTrayLid, 140, 480);
    ...
    laButtonWidget_SetImageMargin(RightTrayLid, 0);
    ...
    laWidget_SetPosition((laWidget*)ImageWidget6, 80, 200);
    laWidget_SetSize((laWidget*)ImageWidget6, 60, 72);
    ...
    laWidget_SetPosition((laWidget*)DragPanel, -200, 0);
    laWidget_SetSize((laWidget*)DragPanel, 340, 480);
    ...
    laWidget_SetPosition((laWidget*)PanelWidget2, 1, 0);
    laWidget_SetSize((laWidget*)PanelWidget2, 200, 480);
    ...
    laWidget_SetPosition((laWidget*)ChangeLanguage, 10, 110);
    laWidget_SetSize((laWidget*)ChangeLanguage, 90, 90);
    ...
    laWidget_SetPosition((laWidget*)CoffeeButton, 99, 361);
    laWidget_SetSize((laWidget*)CoffeeButton, 90, 90);
    ...
    laWidget_SetPosition((laWidget*)CoffeeBeanButton, 100, 60);
    laWidget_SetSize((laWidget*)CoffeeBeanButton, 90, 90);
    ...
    laWidget_SetPosition((laWidget*)TeaButton, 100, 260);
    laWidget_SetSize((laWidget*)TeaButton, 90, 90);
    ...
    laWidget_SetPosition((laWidget*)InfoPageButton, 9, 310);
    laWidget_SetSize((laWidget*)InfoPageButton, 90, 90);
    ...
    laWidget_SetPosition((laWidget*)GPUButton, 100, 160);
    laWidget_SetSize((laWidget*)GPUButton, 90, 90);
    ...
    laWidget_SetPosition((laWidget*)GPUButtonLabel, 2, 25);
    laWidget_SetSize((laWidget*)GPUButtonLabel, 88, 40);
    ...
    laWidget_SetPosition((laWidget*)LeftTrayLid, 200, 1);
    laWidget_SetSize((laWidget*)LeftTrayLid, 90, 480);
    ...
    laButtonWidget_SetImageMargin(LeftTrayLid, 0);
    ...
    laWidget_SetPosition((laWidget*)ImageWidget5, 0, 200);
    laWidget_SetSize((laWidget*)ImageWidget5, 60, 72);
...
static void ScreenCreate_InfoScreen(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)InfoTextImage, 729, 509);
    ...
    laImageWidget_SetImage(InfoTextImage, &info_text_en);
    ...
    laWidget_SetPosition((laWidget*)ButtonWidget1, 693, 20);
    laWidget_SetSize((laWidget*)ButtonWidget1, 90, 90);
