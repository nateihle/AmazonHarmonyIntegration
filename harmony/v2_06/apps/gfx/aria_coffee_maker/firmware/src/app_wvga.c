...
bool APP_Preload_Images ( void )
{
    ...
    GFXU_ImageAsset* imageAssets[38];
    uint32_t imageSize;
    int i = 0;
    ...
    imageAssets[0] = &coffee_beans_1;
    imageAssets[1] = &coffee_beans_2;
    imageAssets[2] = &coffee_beans_3;
    imageAssets[3] = &coffee_beans_4;

    imageAssets[4] = &tray_left_pressed;
    imageAssets[5] = &tray_left;
    imageAssets[6] = &tray_right_pressed;
    imageAssets[7] = &tray_right;

    imageAssets[8] = &USA;
    imageAssets[9] = &Italy;
    imageAssets[10] = &France;
    imageAssets[11] = &Germany;

    imageAssets[12] = &tea_mode_icon;
    imageAssets[13] = &tea_mode_icon_hot;
    imageAssets[14] = &tea_mode_icon_warm;
    
    imageAssets[15] = &temp_control_source;
    imageAssets[16] = &temp_control_warm;
    imageAssets[17] = &temp_control_hot;

    imageAssets[18] = &PlainButton;
    imageAssets[19] = &OvalButton;
    imageAssets[20] = &OvalButtonPressed;

    imageAssets[21] = &coffee_bean_button;
    imageAssets[22] = &question_button;
    imageAssets[23] = &left_right_touch_icon_small;
    
    imageAssets[24] = &Coffee_Grande_Hot;
    imageAssets[25] = &Coffee_Grande_Medium;
    imageAssets[26] = &Coffee_Grande_Warm;

    imageAssets[27] = &Coffee_Medium_Hot;
    imageAssets[28] = &Coffee_Medium_Medium;
    imageAssets[29] = &Coffee_Medium_Warm;

    imageAssets[30] = &Coffee_Small_Hot;
    imageAssets[31] = &Coffee_Small_Medium;
    imageAssets[32] = &Coffee_Small_Warm;
    
    imageAssets[33] = &Coffee_Venti_Hot;
    imageAssets[34] = &Coffee_Venti_Medium;
    imageAssets[35] = &Coffee_Venti_Warm;
    
    imageAssets[36] = &Bar;
    
    imageAssets[37] = &info_text_en;
