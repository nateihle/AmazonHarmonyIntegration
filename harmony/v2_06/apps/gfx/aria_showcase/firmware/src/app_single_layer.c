   ...
   switch ( appSplashData.state )
    {
        ...
        {            
                    ...
                    && context->activeScreen->layers[0]->widget.drawState == LA_WIDGET_DRAW_STATE_DONE)
            {
                ...
                laWidget_SetVisible((laWidget*)SplashBarLogo, false);
                laWidget_SetVisible((laWidget*)HarmonyLogoWidget, false);
                tiggerTick = currentTick + DELAY_IN_TICKS;
            }
        ...
        case APP_STATE_SPLASH_3:
        {
            ...
            {
                case 20:
                    laImageWidget_SetImage(Pic32Logo, &CrossFade3);
                    break;
                case 40:
                    laImageWidget_SetImage(Pic32Logo, &CrossFade2);
                    break;
                case 60:
                    laImageWidget_SetImage(Pic32Logo, &CrossFade1);
                    break;
                case 80:
                    laImageWidget_SetImage(Pic32Logo, &CrossFade0);
                    break;
                default:
                    break;
            }
            ...
            if (appSplashData.splashAlpha <= 10)
            {
                ...
                laWidget_SetVisible((laWidget*)Pic32Logo, true);
                laWidget_SetVisible((laWidget*)HarmonyLogoWidget, true);
                laWidget_SetVisible((laWidget*)SplashBarLogo, true);
            }
            break;
        }
