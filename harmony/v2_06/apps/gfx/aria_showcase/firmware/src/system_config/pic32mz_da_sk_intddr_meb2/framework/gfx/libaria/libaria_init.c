...
int32_t libaria_initialize(void)
{
    ...
    GFXU_PreprocessImage(&MicrochipLogo,0xA8EB8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&NewHarmonyLogo,0xA8F38000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&LucyInTheSky,0xA8BB8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&USA,0xA8CB8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&ice_color,0xA8DB8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_Settings_60x60,0xA9008000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_Keyboard_80_drop,0xA8FB8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_SlideShow_80_drop,0xA8FC8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_Touch_80_drop,0xA8FD8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_alpha_80x80_drop,0xA8FE8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_Slide_80_drop,0xA8FF8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
