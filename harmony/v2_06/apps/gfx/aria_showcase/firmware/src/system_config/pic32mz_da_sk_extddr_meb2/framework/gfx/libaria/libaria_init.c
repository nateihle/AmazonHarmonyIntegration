...
int32_t libaria_initialize(void)
{
    ...
    GFXU_PreprocessImage(&GFX_Settings_60x60,0xA8FF8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_SlideShow_80_drop,0xA8FB8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_Touch_80_drop,0xA8FC8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_alpha_80x80_drop,0xA8FD8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
    GFXU_PreprocessImage(&GFX_Slide_80_drop,0xA8FE8000,GFX_COLOR_MODE_RGBA_8888,GFX_TRUE);
