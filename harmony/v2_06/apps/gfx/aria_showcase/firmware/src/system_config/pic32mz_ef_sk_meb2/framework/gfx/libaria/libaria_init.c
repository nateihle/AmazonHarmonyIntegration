...
static void ScreenCreate_FourthScreen(laScreen* screen)
{
    ...
    laWidget_SetBackgroundType((laWidget*)PanelWidget1, LA_WIDGET_BACKGROUND_CACHE);
    ...
    laWidget_SetBackgroundType((laWidget*)SliderWidget1, LA_WIDGET_BACKGROUND_CACHE);
    ...
    laWidget_SetBackgroundType((laWidget*)SliderDownButtonWidget, LA_WIDGET_BACKGROUND_CACHE);
