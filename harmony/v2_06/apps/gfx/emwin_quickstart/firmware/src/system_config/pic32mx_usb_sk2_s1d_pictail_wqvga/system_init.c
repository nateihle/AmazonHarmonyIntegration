...
// *****************************************************************************
// *****************************************************************************
// <editor-fold defaultstate="collapsed" desc="DRV_TOUCH_ADC Initialization Data">
/*** DRV_TOUCH_ADC Driver Initialization Data ***/

const DRV_TOUCH_ADC_INIT drvTouchAdcInitData =
{
    .moduleInit           = {0},
    .touchId              = 0,
    .drvInitialize        = NULL,
...
void SYS_Initialize ( void* data )
{
    ...
    sysObj.drvTouchAdc = DRV_TOUCH_ADC_Initialize(0, (SYS_MODULE_INIT *)&drvTouchAdcInitData);
