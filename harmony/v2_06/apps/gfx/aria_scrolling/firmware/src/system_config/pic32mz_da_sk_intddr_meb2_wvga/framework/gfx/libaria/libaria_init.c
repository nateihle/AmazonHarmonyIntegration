...
static void ScreenCreate_default(laScreen* screen)
{
    ...
    laWidget_SetSize((laWidget*)DragArea, 800, 480);
    ...
    laWidget_SetPosition((laWidget*)ScrollArea, 1, 120);
    laWidget_SetSize((laWidget*)ScrollArea, 1388, 220);
    ...
    laWidget_SetPosition((laWidget*)ButtonUS, 20, 0);
    laWidget_SetSize((laWidget*)ButtonUS, 220, 220);
    ...
    laWidget_SetPosition((laWidget*)ButtonCA, 300, 0);
    laWidget_SetSize((laWidget*)ButtonCA, 220, 220);
    ...
    laWidget_SetPosition((laWidget*)ButtonFR, 580, 0);
    laWidget_SetSize((laWidget*)ButtonFR, 220, 220);
    ...
    laWidget_SetPosition((laWidget*)ButtonUK, 860, 0);
    laWidget_SetSize((laWidget*)ButtonUK, 220, 220);
    ...
    laWidget_SetPosition((laWidget*)ButtonCH, 1150, 0);
    laWidget_SetSize((laWidget*)ButtonCH, 220, 220);
    ...
    laWidget_SetPosition((laWidget*)Title, 308, 6);
    ...
    laWidget_SetPosition((laWidget*)Instructions, 269, 440);
