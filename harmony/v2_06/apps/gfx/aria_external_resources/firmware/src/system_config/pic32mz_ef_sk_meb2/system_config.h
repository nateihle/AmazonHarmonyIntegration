...
#define SYS_PORT_B_ANSEL        0x87C1
#define SYS_PORT_B_TRIS         0xB7C9
...
#define BSP_BT_PIN_PORT PORT_CHANNEL_B
#define BSP_BT_PIN_PIN PORTS_BIT_POS_2
#define BSP_BT_PIN_PIN_MASK (0x1 << 2)
