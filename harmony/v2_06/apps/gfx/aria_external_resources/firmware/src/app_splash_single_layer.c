...
{    
    ...
    switch ( appSplashData.state )
    {
        ...
        {            
            ...
            if (context->activeScreen->id == SplashScreen_ID 
                    && context->activeScreen->layers[0]->widget.drawState == LA_WIDGET_DRAW_STATE_DONE)
            {
                appSplashData.state = APP_STATE_SPLASH_2;
                laWidget_SetPosition((laWidget*)SplashImageWidget3, appSplashData.barPosX, SplashImageWidget3->widget.rect.y);
                laWidget_SetVisible((laWidget*)SplashImageWidget4, false);
                laWidget_SetVisible((laWidget*)SplashImageWidget2, false);
        ...
        case APP_STATE_SPLASH_3:
        {
            ...
            {
                case 20:
                    laImageWidget_SetImage(SplashImageWidget1, &CrossFade3);
                    break;
                case 40:
                    laImageWidget_SetImage(SplashImageWidget1, &CrossFade2);
                    break;
                case 60:
                    laImageWidget_SetImage(SplashImageWidget1, &CrossFade1);
                    break;
                case 80:
                    laImageWidget_SetImage(SplashImageWidget1, &CrossFade0);
                    break;
                default:
                    break;
            }
            ...
            if (appSplashData.splashAlpha <= 10)
            {
                ...
                laWidget_SetVisible((laWidget*)SplashImageWidget1, true);
                laWidget_SetVisible((laWidget*)SplashImageWidget2, true);
                laWidget_SetVisible((laWidget*)SplashImageWidget4, true);
            }
            break;
        }
