...
#include "app.h"
#include "system/debug/sys_debug.h"  // To support SYS_DEBUG_PRINT below.
...
void APP_Initialize ( void )
{
     ...
     * parameters.
     */
  // For configurations with MCP2221 USART to USB Bridge enabled:
...
//        y = 0;
//        z = x/y;
//        SYS_DEBUG_PRINT(SYS_ERROR_ERROR,"x: %d, y: %d, z: %d\r\n",x,y,z);
//    }
