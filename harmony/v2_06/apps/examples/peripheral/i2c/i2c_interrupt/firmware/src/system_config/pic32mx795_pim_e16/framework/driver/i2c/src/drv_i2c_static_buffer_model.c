...
void DRV_I2C0_Initialize(void)
{
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C1, INT_PRIORITY_LEVEL4);
...
void DRV_I2C1_Initialize(void)
{
    ...
    PLIB_I2C_SlaveAddress7BitSet(I2C_ID_3, 0x60>>1);
    PLIB_I2C_SlaveMask7BitSet(I2C_ID_3, 0x00);
    PLIB_I2C_GeneralCallDisable(I2C_ID_3);
    PLIB_I2C_ReservedAddressProtectEnable(I2C_ID_3);
    PLIB_I2C_SlaveClockStretchingEnable(I2C_ID_3);
    ...
    PLIB_INT_SourceFlagClear(INT_ID_0, INT_SOURCE_I2C_3_ERROR);
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_I2C_3_ERROR);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C3, INT_PRIORITY_LEVEL5);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_I2C3, INT_SUBPRIORITY_LEVEL0);
...
void DRV_I2C1_Tasks(void)
{
    ...
    switch (i2c1State)
    {
        case DRV_I2C_TASK_SEND_DEVICE_ADDRESS:
        {
            if (i2c1Obj.i2cMode == DRV_I2C_MODE_MASTER)
            {
                ...
                if (PLIB_I2C_StartWasDetected(I2C_ID_3))
                {
                    if ( (lBufferObj1->i2coperation == DRV_I2C_OP_WRITE) || (lBufferObj1->i2coperation == DRV_I2C_OP_WRITE_READ) )
                    {
                        ...
                        PLIB_I2C_TransmitterByteSend( I2C_ID_3, lBufferObj1->slaveaddresshighbyte );
                    }
                    else
                    {
                        lBufferObj1->bufferstatus    = DRV_I2C_BUFFER_SLAVE_READ_REQUESTED;
                        i2c1State = DRV_I2C_TASK_SET_RCEN_ONLY;
                        PLIB_I2C_TransmitterByteSend(I2C_ID_3, lBufferObj1->slaveaddresshighbyte | DRV_I2C_OP_READ );
                    }
                }
            }
            else if (i2c1Obj.i2cMode == DRV_I2C_MODE_SLAVE)
            {
                ...
                else if ( (PLIB_I2C_SlaveReadIsRequested(I2C_ID_3)) && (PLIB_I2C_SlaveAddressIsDetected(I2C_ID_3)) )
                {
                    ...
                    // transmit first byte
                    PLIB_I2C_TransmitterByteSend(I2C_ID_3, *lBufferObj1->txBuffer++);
                ...
                else if ( (!PLIB_I2C_SlaveReadIsRequested(I2C_ID_3)) && PLIB_I2C_SlaveDataIsDetected(I2C_ID_3))
                {
                    ...
                    {
                        *lBufferObj1->rxBuffer++ = PLIB_I2C_ReceivedByteGet(I2C_ID_3);
                        lBufferObj1->transfersize++;
        ...
        case DRV_I2C_SEND_DEVICE_ADDRESS_BYTE_2:
        {
            ...
            {
                PLIB_I2C_TransmitterByteSend(I2C_ID_3,lBufferObj1->slaveaddresslowbyte>>1) ;
                i2c1State = DRV_I2C_TASK_SET_RCEN_ONLY;
            }
            else
            {
