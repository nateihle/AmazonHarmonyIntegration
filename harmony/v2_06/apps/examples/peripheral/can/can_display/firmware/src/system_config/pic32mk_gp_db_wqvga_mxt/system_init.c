...
void SYS_Initialize ( void* data )
{
    ...
    RESET_BAROn();  // Enable touch controller
    //END OF CUSTOM CODE
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_CHANGE_NOTICE_F, INT_PRIORITY_LEVEL5);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_CHANGE_NOTICE_F, INT_SUBPRIORITY_LEVEL0);
    //END OF CUSTOM CODE
      ...
      //CUSTOM CODE - DO NOT DELETE
    {
        ...
        SYS_CONSOLE_Write(SYS_CONSOLE_INDEX_0, STDOUT_FILENO, initMessage, strlen(initMessage));
    }
