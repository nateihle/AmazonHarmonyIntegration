...
// Generated Event Handler - Origin: TxMessage1, Event: ReleasedEvent
void TxMessage1_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: TxMessage2, Event: ReleasedEvent
void TxMessage2_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: SettingsButton, Event: ReleasedEvent
void SettingsButton_ReleasedEvent(laButtonWidget* btn);

// Generated Event Handler - Origin: MainMenu, Event: ReleasedEvent
