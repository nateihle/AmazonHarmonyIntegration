...
typedef enum
{
	...
	MC_APP_CLASSB_STATE_INIT=0,
	MC_APP_CLASSB_STATE_FLASH_CRC_TEST,
    MC_APP_CLASSB_STATE_CHECKER_BOARD_RAM_TEST,
    MC_APP_CLASSB_STATE_RAM_MARCHB_TEST,
    MC_APP_CLASSB_STATE_RAM_MARCHC_TEST,
    MC_APP_CLASSB_STATE_RAM_MARCHC_STACK_TEST,
    MC_APP_CLASSB_STATE_CLOCK_TEST,
    MC_APP_CLASSB_STATE_CPU_PC_TEST,
    MC_APP_CLASSB_STATE_CPU_REGISTERS_TEST,
    MC_APP_CLASSB_STATE_TEST_PASS,
    MC_APP_CLASSB_STATE_TEST_FAIL,
} MC_APP_CLASSB_STATES;
...
typedef struct
{
	...
	MC_APP_CLASSB_STATES classBState;
