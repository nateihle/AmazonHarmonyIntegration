...
/* MCPWM Channel instance MCPWM_CHANNEL1 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL1, MCPWM_TIME_BASE_SOURCE_PRIMARY , MCPWM_TIME_BASE_SYNCHRONIZED , MCPWM_SYMMETRIC_CENTER_ALIGNED,
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_POSITIVE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
	...
	MCPWM_PRIMARY_TRIGGER_DURING_TIMER_INCREMENTING , MCPWM_SECONDARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_ADC_TRIGGER_SOURCE_PRIMARY,
	MCPWM_TRIGGER_INTERRUPT_SOURCE_PRIMARY, 2998 , 0);
	

	PLIB_MCPWM_ChannelLEBSetup (MCPWM_ID_0 , MCPWM_CHANNEL1 , MCPWM_FAULT_INPUT_LEB_ENABLE, MCPWM_CURRENTLIMIT_INPUT_LEB_DISABLE, 
	240);	
	
	PLIB_MCPWM_ChannelLEBTriggerPWMxHRisingEdgeEnable (MCPWM_ID_0 , MCPWM_CHANNEL1);


	PLIB_MCPWM_ChannelLEBTriggerPWMxLRisingEdgeEnable (MCPWM_ID_0 , MCPWM_CHANNEL1);
	...
	PLIB_MCPWM_ChannelFaultSetup (MCPWM_ID_0 , MCPWM_CHANNEL1, MCPWM_FAULT_SOURCE_IS_COMPARATOR3 , MCPWM_FAULT_INPUT_POLARITY_ACTIVE_LOW,
	MCPWM_FAULT_OVERRIDE_PWMxH_0, MCPWM_FAULT_OVERRIDE_PWMxL_0, MCPWM_FAULT_MODE_LATCHED);
...
/* MCPWM Channel instance MCPWM_CHANNEL2 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL2, MCPWM_TIME_BASE_SOURCE_PRIMARY , MCPWM_TIME_BASE_SYNCHRONIZED , MCPWM_SYMMETRIC_CENTER_ALIGNED,
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_POSITIVE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
	...
	PLIB_MCPWM_ChannelPWMxHDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 120);
	PLIB_MCPWM_ChannelPWMxLDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL2 , 120);
	...
	PLIB_MCPWM_ChannelLEBSetup (MCPWM_ID_0 , MCPWM_CHANNEL2 , MCPWM_FAULT_INPUT_LEB_ENABLE, MCPWM_CURRENTLIMIT_INPUT_LEB_DISABLE, 
	240);	
	
	PLIB_MCPWM_ChannelLEBTriggerPWMxHRisingEdgeEnable (MCPWM_ID_0 , MCPWM_CHANNEL2);


	PLIB_MCPWM_ChannelLEBTriggerPWMxLRisingEdgeEnable (MCPWM_ID_0 , MCPWM_CHANNEL2);
	...
	PLIB_MCPWM_ChannelFaultSetup (MCPWM_ID_0 , MCPWM_CHANNEL2, MCPWM_FAULT_SOURCE_IS_COMPARATOR3 , MCPWM_FAULT_INPUT_POLARITY_ACTIVE_LOW,
	MCPWM_FAULT_OVERRIDE_PWMxH_0, MCPWM_FAULT_OVERRIDE_PWMxL_0, MCPWM_FAULT_MODE_LATCHED);
...
/* MCPWM Channel instance MCPWM_CHANNEL3 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL3, MCPWM_TIME_BASE_SOURCE_PRIMARY , MCPWM_TIME_BASE_SYNCHRONIZED , MCPWM_SYMMETRIC_CENTER_ALIGNED,
	MCPWM_OUTPUT_COMPLIMENTARY_MODE, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_POSITIVE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
	...
	PLIB_MCPWM_ChannelPWMxHDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL3 , 120);
	PLIB_MCPWM_ChannelPWMxLDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL3 , 120);
	...
	PLIB_MCPWM_ChannelLEBSetup (MCPWM_ID_0 , MCPWM_CHANNEL3 , MCPWM_FAULT_INPUT_LEB_ENABLE, MCPWM_CURRENTLIMIT_INPUT_LEB_DISABLE, 
	240);	
	
	PLIB_MCPWM_ChannelLEBTriggerPWMxHRisingEdgeEnable (MCPWM_ID_0 , MCPWM_CHANNEL3);


	PLIB_MCPWM_ChannelLEBTriggerPWMxLRisingEdgeEnable (MCPWM_ID_0 , MCPWM_CHANNEL3);
	...
	PLIB_MCPWM_ChannelFaultSetup (MCPWM_ID_0 , MCPWM_CHANNEL3, MCPWM_FAULT_SOURCE_IS_COMPARATOR3 , MCPWM_FAULT_INPUT_POLARITY_ACTIVE_LOW,
	MCPWM_FAULT_OVERRIDE_PWMxH_0, MCPWM_FAULT_OVERRIDE_PWMxL_0, MCPWM_FAULT_MODE_LATCHED);
	...
	PLIB_MCPWM_ChannelPWMxLEnable (MCPWM_ID_0 ,MCPWM_CHANNEL3);
