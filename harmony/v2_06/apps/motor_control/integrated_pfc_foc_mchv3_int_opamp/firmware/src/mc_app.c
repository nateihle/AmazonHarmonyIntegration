...
// *****************************************************************************
// *****************************************************************************
inline void MC_APP_MC_Estim(void)
{
	float tempqVelEstim;
...
// *****************************************************************************
// *****************************************************************************
inline void MC_APP_MC_InitEstimParm(void)  
{
...
inline void MC_APP_MC_CalcRefVec(void) // rotates the motor in clockwise direction
{
...
inline void MC_APP_MC_InitControlParameters(void)
{
	// PI D Term     
...
inline void MC_APP_MC_InitPI( tPIParm *pParm)
{
    pParm->qdSum = 0;
    pParm->qOut = 0;
}

inline void MC_APP_MC_CalcPI( tPIParm *pParm)
{
    float Err;
    float U;
    float Exc;
...
inline void MC_APP_MC_SinCos(void)
{
    // IMPORTANT:
