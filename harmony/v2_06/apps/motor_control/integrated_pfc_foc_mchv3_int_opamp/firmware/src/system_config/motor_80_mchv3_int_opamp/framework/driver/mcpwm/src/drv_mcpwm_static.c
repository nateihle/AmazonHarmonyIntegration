...
PLIB_MCPWM_PrimaryTimerSetup (MCPWM_ID_0 , MCPWM_CLOCK_DIVIDE_BY_1 , 3000);

/* Configure Secondary MCPWM Master Timer */
PLIB_MCPWM_SecondaryTimerSetup (MCPWM_ID_0 , MCPWM_CLOCK_DIVIDE_BY_1 , 1500);
...
/* MCPWM Channel instance MCPWM_CHANNEL1 */
	...
	MCPWM_TRIGGER_INTERRUPT_SOURCE_PRIMARY, 2999 , 0);
...
// *****************************************************************************
/* MCPWM Channel instance MCPWM_CHANNEL5 */
	PLIB_MCPWM_ChannelSetup (MCPWM_ID_0 , MCPWM_CHANNEL5, MCPWM_TIME_BASE_SOURCE_SECONDARY , MCPWM_TIME_BASE_SYNCHRONIZED , MCPWM_EDGE_ALIGNED,
	MCPWM_OUTPUT_LOW_LATCHED_TO_ZERO, MCPWM_PWMxH_ACTIVEHIGH ,MCPWM_PWMxL_ACTIVEHIGH , MCPWM_DEADTIME_DISABLE, MCPWM_DEADTIME_COMPENSATION_POLARITY_ACTIVE_HIGH );
	
	PLIB_MCPWM_ChannelPrimaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL5 , 0);
	PLIB_MCPWM_ChannelSecondaryDutyCycleSet (MCPWM_ID_0 , MCPWM_CHANNEL5 , 0);
	PLIB_MCPWM_ChannelPWMxHDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL5 , 0);
	PLIB_MCPWM_ChannelPWMxLDeadtimeSet (MCPWM_ID_0 , MCPWM_CHANNEL5 , 0);
	PLIB_MCPWM_ChannelDeadtimeCompSet (MCPWM_ID_0 , MCPWM_CHANNEL5 , 0);
	PLIB_MCPWM_ChannelPhaseSet (MCPWM_ID_0 , MCPWM_CHANNEL5 , 375);
	
	
	PLIB_MCPWM_ChannelTriggerSetup (MCPWM_ID_0 , MCPWM_CHANNEL5 , MCPWM_TRIGGER_DIVIDE_BY_2, 
	MCPWM_PRIMARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_SECONDARY_TRIGGER_DURING_TIMER_INCREMENTING_DECREMENTING , MCPWM_ADC_TRIGGER_SOURCE_PRIMARY,
	MCPWM_TRIGGER_INTERRUPT_SOURCE_PRIMARY, 0 , 0);
	

	PLIB_MCPWM_ChannelLEBSetup (MCPWM_ID_0 , MCPWM_CHANNEL5 , MCPWM_FAULT_INPUT_LEB_ENABLE, MCPWM_CURRENTLIMIT_INPUT_LEB_DISABLE, 
	100);	
	
	PLIB_MCPWM_ChannelLEBTriggerPWMxHRisingEdgeEnable (MCPWM_ID_0 , MCPWM_CHANNEL5);



	
	PLIB_MCPWM_ChannelChopSetup (MCPWM_ID_0 , MCPWM_CHANNEL5 , MCPWM_CHOP_CLOCK_SOURCE_IS_CHOP_CLOCK_GENERATOR, MCPWM_PWMxH_CHOP_DISABLED, MCPWM_PWMxL_CHOP_DISABLED);
	
	
	PLIB_MCPWM_ChannelFaultSetup (MCPWM_ID_0 , MCPWM_CHANNEL5, MCPWM_FAULT_SOURCE_IS_COMPARATOR3 , MCPWM_FAULT_INPUT_POLARITY_ACTIVE_LOW,
	MCPWM_FAULT_OVERRIDE_PWMxH_0, MCPWM_FAULT_OVERRIDE_PWMxL_0, MCPWM_FAULT_MODE_DISABLED);
	
	
	PLIB_MCPWM_ChannelCurrentLimitSetup (MCPWM_ID_0 , MCPWM_CHANNEL5, MCPWM_CURRENTLIMIT_SOURCE_IS_FLT15 , MCPWM_CURRENTLIMIT_INPUT_POLARITY_ACTIVE_HIGH,
	MCPWM_CURRENTLIMIT_OVERRIDE_PWMxH_0,MCPWM_CURRENTLIMIT_OVERRIDE_PWMxL_0, MCPWM_CURRENTLIMIT_DISABLE );
	
	
	PLIB_MCPWM_ChannelOverrideOutputSet (MCPWM_ID_0 , MCPWM_CHANNEL5, MCPWM_OVERRIDE_PWMxH_0, MCPWM_OVERRIDE_PWMxL_0);
	
	
	
	PLIB_MCPWM_ChannelPWMxHEnable (MCPWM_ID_0 ,MCPWM_CHANNEL5);

	PLIB_MCPWM_ChannelPWMxLEnable (MCPWM_ID_0 ,MCPWM_CHANNEL5);
