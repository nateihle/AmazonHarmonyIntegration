...
void SYS_CLK_Initialize( const SYS_CLK_INIT const * clkInit )
{
    ...
    //UPLLCON = 0x01170305;
    /* 24 MHz Input*/
    UPLLCONbits.PLLIDIV = 1; //Divide by 1  
    UPLLCONbits.PLLMULT = 31; // Multiply by 32 to get 384Mhz. 
    UPLLCONbits.PLLODIV= 3;// Divide by 8  384/8 = 48Mhz
    UPLLCONbits.PLLRANGE = 2;
    UPLLCONbits.UPOSCEN = 0;
    OSCCONbits.UFRCEN = 0; 
