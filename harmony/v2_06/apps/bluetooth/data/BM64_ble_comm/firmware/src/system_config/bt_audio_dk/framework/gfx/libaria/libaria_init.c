...
laWidget* GFX_MSGPANEL;
laLabelWidget* GFX_MSGS;
laLabelWidget* GFX_MSG1_VALUE;
laLabelWidget* GFX_MSG2_VALUE;
laLabelWidget* GFX_MSG3_VALUE;
...
static void ScreenCreate_default(laScreen* screen)
{
    ...
    laWidget_SetPosition((laWidget*)GFX_TITLE, 1, 33);
    ...
    GFX_MSGPANEL = laWidget_New();
    laWidget_SetPosition((laWidget*)GFX_MSGPANEL, 0, 66);
    laWidget_SetSize((laWidget*)GFX_MSGPANEL, 219, 105);
    laWidget_SetScheme((laWidget*)GFX_MSGPANEL, &blueblackBackground);
    laWidget_SetBackgroundType((laWidget*)GFX_MSGPANEL, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)GFX_MSGPANEL, LA_WIDGET_BORDER_NONE);
    laWidget_AddChild((laWidget*)layer0, GFX_MSGPANEL);

    GFX_MSGS = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)GFX_MSGS, 8, 0);
    laWidget_SetSize((laWidget*)GFX_MSGS, 78, 22);
    laWidget_SetScheme((laWidget*)GFX_MSGS, &blueblackBackground);
    laWidget_SetBackgroundType((laWidget*)GFX_MSGS, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)GFX_MSGS, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetHAlignment(GFX_MSGS, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)GFX_MSGPANEL, (laWidget*)GFX_MSGS);

    GFX_MSG1_VALUE = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)GFX_MSG1_VALUE, 50, 25);
    laWidget_SetSize((laWidget*)GFX_MSG1_VALUE, 125, 22);
    laWidget_SetScheme((laWidget*)GFX_MSG1_VALUE, &blueblackBackground);
    laWidget_SetBackgroundType((laWidget*)GFX_MSG1_VALUE, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)GFX_MSG1_VALUE, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetHAlignment(GFX_MSG1_VALUE, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)GFX_MSGPANEL, (laWidget*)GFX_MSG1_VALUE);

    GFX_MSG2_VALUE = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)GFX_MSG2_VALUE, 50, 50);
    laWidget_SetSize((laWidget*)GFX_MSG2_VALUE, 125, 22);
    laWidget_SetScheme((laWidget*)GFX_MSG2_VALUE, &blueblackBackground);
    laWidget_SetBackgroundType((laWidget*)GFX_MSG2_VALUE, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)GFX_MSG2_VALUE, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetHAlignment(GFX_MSG2_VALUE, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)GFX_MSGPANEL, (laWidget*)GFX_MSG2_VALUE);

    GFX_MSG3_VALUE = laLabelWidget_New();
    laWidget_SetPosition((laWidget*)GFX_MSG3_VALUE, 50, 75);
    laWidget_SetSize((laWidget*)GFX_MSG3_VALUE, 125, 25);
    laWidget_SetScheme((laWidget*)GFX_MSG3_VALUE, &blueblackBackground);
    laWidget_SetBackgroundType((laWidget*)GFX_MSG3_VALUE, LA_WIDGET_BACKGROUND_FILL);
    laWidget_SetBorderType((laWidget*)GFX_MSG3_VALUE, LA_WIDGET_BORDER_NONE);
    laLabelWidget_SetHAlignment(GFX_MSG3_VALUE, LA_HALIGN_LEFT);
    laWidget_AddChild((laWidget*)GFX_MSGPANEL, (laWidget*)GFX_MSG3_VALUE);
