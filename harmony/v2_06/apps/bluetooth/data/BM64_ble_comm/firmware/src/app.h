...
typedef enum
{
    ...
    BUTTON_STATE_SWITCH_1_PRESSED,           
    BUTTON_STATE_SWITCH_2_PRESSED,
    BUTTON_STATE_SWITCH_3_PRESSED,
    BUTTON_STATE_SWITCH_4_PRESSED,
    BUTTON_STATE_SWITCH_5_PRESSED,             
