...
public class SpeechService extends Service {
    ...
    public interface Listener {
         ...
         */
        void onSpeechRecognized(String text, float likehood, boolean isFinal);
    }
        ...
        public void onNext(StreamingRecognizeResponse response) {
            ...
            if (response.getResultsCount() > 0) {
                ...
                if (result.getAlternativesCount() > 0) {
                    ...
                    likehood = alternative.getConfidence();
                }
            }

            if (text != null) {
                for (Listener listener : mListeners) {
                    listener.onSpeechRecognized(text, likehood, isFinal);
                }
            }
        }
    ...
    private final StreamObserver<RecognizeResponse> mFileResponseObserver
        ...
        public void onNext(RecognizeResponse response) {
            ...
            if (text != null) {
                for (Listener listener : mListeners) {
                    listener.onSpeechRecognized(text, likehood, true);
                }
            }
        }
